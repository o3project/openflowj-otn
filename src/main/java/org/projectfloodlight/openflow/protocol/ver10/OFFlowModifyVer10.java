...
//
    ...
    OFFlowModifyVer10(long xid, Match match, U64 cookie, int idleTimeout, int hardTimeout, int priority, OFBufferId bufferId, OFPort outPort, Set<OFFlowModFlags> flags, List<OFAction> actions) {
        if(match == null) {
            throw new NullPointerException("OFFlowModifyVer10: property match cannot be null");
        }
        if(cookie == null) {
            throw new NullPointerException("OFFlowModifyVer10: property cookie cannot be null");
        }
        if(bufferId == null) {
            throw new NullPointerException("OFFlowModifyVer10: property bufferId cannot be null");
        }
        if(outPort == null) {
            throw new NullPointerException("OFFlowModifyVer10: property outPort cannot be null");
        }
        if(flags == null) {
            throw new NullPointerException("OFFlowModifyVer10: property flags cannot be null");
        }
        if(actions == null) {
