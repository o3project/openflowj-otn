...
//
    ...
    OFHelloFailedErrorMsgVer10(long xid, OFHelloFailedCode code, OFErrorCauseData data) {
        if(code == null) {
            throw new NullPointerException("OFHelloFailedErrorMsgVer10: property code cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFHelloFailedErrorMsgVer10: property data cannot be null");
        }
        this.xid = xid;
        this.code = code;
        this.data = data;
