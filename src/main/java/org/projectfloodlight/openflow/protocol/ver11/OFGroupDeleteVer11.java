...
//
    ...
    OFGroupDeleteVer11(long xid, OFGroupType groupType, OFGroup group, List<OFBucket> buckets) {
        if(groupType == null) {
            throw new NullPointerException("OFGroupDeleteVer11: property groupType cannot be null");
        }
        if(group == null) {
            throw new NullPointerException("OFGroupDeleteVer11: property group cannot be null");
        }
        if(buckets == null) {
            throw new NullPointerException("OFGroupDeleteVer11: property buckets cannot be null");
        }
        this.xid = xid;
