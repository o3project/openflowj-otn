...
class OFOxmEthTypeMaskedVer14 implements OFOxmEthTypeMasked {
...
//
    ...
    final static OFOxmEthTypeMaskedVer14 DEFAULT = new OFOxmEthTypeMaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmEthTypeMaskedVer14(EthType value, EthType mask) {
        if(value == null) {
    ...
    static class BuilderWithParent implements OFOxmEthTypeMasked.Builder {
        ...
        BuilderWithParent(OFOxmEthTypeMaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmEthTypeMasked> {
        ...
        public OFOxmEthTypeMasked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmEthTypeMaskedVer14 oxmEthTypeMaskedVer14 = new OFOxmEthTypeMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmEthTypeMaskedVer14);
            return oxmEthTypeMaskedVer14;
        }
    }
    ...
    final static OFOxmEthTypeMaskedVer14Funnel FUNNEL = new OFOxmEthTypeMaskedVer14Funnel();
    static class OFOxmEthTypeMaskedVer14Funnel implements Funnel<OFOxmEthTypeMaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmEthTypeMaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80000b04L
    ...
    static class Writer implements OFMessageWriter<OFOxmEthTypeMaskedVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmEthTypeMaskedVer14 message) {
            // fixed value property typeLen = 0x80000b04L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmEthTypeMaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmEthTypeMaskedVer14 other = (OFOxmEthTypeMaskedVer14) obj;
