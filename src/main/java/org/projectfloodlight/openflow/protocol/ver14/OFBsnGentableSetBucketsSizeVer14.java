...
class OFBsnGentableSetBucketsSizeVer14 implements OFBsnGentableSetBucketsSize {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableSetBucketsSizeVer14.class);
    // version: 1.4
...
//
    ...
    OFBsnGentableSetBucketsSizeVer14(long xid, GenTableId tableId, long bucketsSize) {
        if(tableId == null) {
            throw new NullPointerException("OFBsnGentableSetBucketsSizeVer14: property tableId cannot be null");
        }
        this.xid = xid;
    ...
    static class BuilderWithParent implements OFBsnGentableSetBucketsSize.Builder {
        final OFBsnGentableSetBucketsSizeVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableSetBucketsSizeVer14 parentMessage) {
    ...
    public OFBsnGentableSetBucketsSize.Builder setBucketsSize(long bucketsSize) {
        ...
        public OFBsnGentableSetBucketsSize build() {
                ...
                //
                return new OFBsnGentableSetBucketsSizeVer14(
                    xid,
                    tableId,
                    bucketsSize
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableSetBucketsSize> {
        ...
        public OFBsnGentableSetBucketsSize readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnGentableSetBucketsSizeVer14 bsnGentableSetBucketsSizeVer14 = new OFBsnGentableSetBucketsSizeVer14(
                    xid,
                      tableId,
                      bucketsSize
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableSetBucketsSizeVer14);
            return bsnGentableSetBucketsSizeVer14;
        }
    }
    ...
    final static OFBsnGentableSetBucketsSizeVer14Funnel FUNNEL = new OFBsnGentableSetBucketsSizeVer14Funnel();
    static class OFBsnGentableSetBucketsSizeVer14Funnel implements Funnel<OFBsnGentableSetBucketsSizeVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableSetBucketsSizeVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableSetBucketsSizeVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnGentableSetBucketsSizeVer14 message) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableSetBucketsSizeVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableSetBucketsSizeVer14 other = (OFBsnGentableSetBucketsSizeVer14) obj;
