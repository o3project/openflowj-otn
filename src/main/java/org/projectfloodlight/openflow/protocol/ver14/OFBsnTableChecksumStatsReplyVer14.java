...
class OFBsnTableChecksumStatsReplyVer14 implements OFBsnTableChecksumStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnTableChecksumStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnTableChecksumStatsReplyVer14 DEFAULT = new OFBsnTableChecksumStatsReplyVer14(
    ...
    static class BuilderWithParent implements OFBsnTableChecksumStatsReply.Builder {
        final OFBsnTableChecksumStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnTableChecksumStatsReplyVer14 parentMessage) {
    ...
    public OFBsnTableChecksumStatsReply.Builder setEntries(List<OFBsnTableChecksumStatsEntry> entries) {
        ...
        public OFBsnTableChecksumStatsReply build() {
                ...
                //
                return new OFBsnTableChecksumStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTableChecksumStatsReply> {
        ...
        public OFBsnTableChecksumStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            List<OFBsnTableChecksumStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFBsnTableChecksumStatsEntryVer14.READER);

            OFBsnTableChecksumStatsReplyVer14 bsnTableChecksumStatsReplyVer14 = new OFBsnTableChecksumStatsReplyVer14(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTableChecksumStatsReplyVer14);
            return bsnTableChecksumStatsReplyVer14;
        }
    }
    ...
    final static OFBsnTableChecksumStatsReplyVer14Funnel FUNNEL = new OFBsnTableChecksumStatsReplyVer14Funnel();
    static class OFBsnTableChecksumStatsReplyVer14Funnel implements Funnel<OFBsnTableChecksumStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnTableChecksumStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnTableChecksumStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnTableChecksumStatsReplyVer14 other = (OFBsnTableChecksumStatsReplyVer14) obj;
