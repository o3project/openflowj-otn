...
public class OFBadActionCodeSerializerVer14 {
    ...
    public static OFBadActionCode ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBadActionCode in version 1.4: " + val);
        }
    }
    ...
    public static short toWireValue(OFBadActionCode e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBadActionCode in version 1.4: " + e);
        }
    }
