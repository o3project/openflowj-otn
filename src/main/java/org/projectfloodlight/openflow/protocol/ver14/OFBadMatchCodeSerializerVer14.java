...
public class OFBadMatchCodeSerializerVer14 {
    ...
    public static OFBadMatchCode ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBadMatchCode in version 1.4: " + val);
        }
    }
    ...
    public static short toWireValue(OFBadMatchCode e) {
        switch(e) {
            ...
            case EPERM:
                return EPERM_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBadMatchCode in version 1.4: " + e);
        }
    }
