...
class OFMeterStatsReplyVer14 implements OFMeterStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFMeterStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFMeterStatsReplyVer14 DEFAULT = new OFMeterStatsReplyVer14(
    ...
    static class BuilderWithParent implements OFMeterStatsReply.Builder {
        final OFMeterStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFMeterStatsReplyVer14 parentMessage) {
    ...
    public OFMeterStatsReply.Builder setEntries(List<OFMeterStats> entries) {
        ...
        public OFMeterStatsReply build() {
                ...
                //
                return new OFMeterStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFMeterStatsReply> {
        ...
        public OFMeterStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            // pad: 4 bytes
            bb.skipBytes(4);
            List<OFMeterStats> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFMeterStatsVer14.READER);

            OFMeterStatsReplyVer14 meterStatsReplyVer14 = new OFMeterStatsReplyVer14(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", meterStatsReplyVer14);
    ...
    final static OFMeterStatsReplyVer14Funnel FUNNEL = new OFMeterStatsReplyVer14Funnel();
    static class OFMeterStatsReplyVer14Funnel implements Funnel<OFMeterStatsReplyVer14> {
    ...
    static class Writer implements OFMessageWriter<OFMeterStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFMeterStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFMeterStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFMeterStatsReplyVer14 other = (OFMeterStatsReplyVer14) obj;
