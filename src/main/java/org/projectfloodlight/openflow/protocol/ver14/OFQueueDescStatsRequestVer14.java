...
class OFQueueDescStatsRequestVer14 implements OFQueueDescStatsRequest {
...
//
    ...
    static class BuilderWithParent implements OFQueueDescStatsRequest.Builder {
        final OFQueueDescStatsRequestVer14 parentMessage;
    ...
    static class Builder implements OFQueueDescStatsRequest.Builder {
        // OF message fields
        private boolean xidSet;
        private long xid;
        private boolean flagsSet;
...
//
    ...
    static class Reader implements OFMessageReader<OFQueueDescStatsRequest> {
        @Override
        public OFQueueDescStatsRequest readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            return queueDescStatsRequestVer14;
        }
    }
    ...
    final static OFQueueDescStatsRequestVer14Funnel FUNNEL = new OFQueueDescStatsRequestVer14Funnel();
    static class OFQueueDescStatsRequestVer14Funnel implements Funnel<OFQueueDescStatsRequestVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFQueueDescStatsRequestVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFQueueDescStatsRequestVer14> {
        @Override
        public void write(ChannelBuffer bb, OFQueueDescStatsRequestVer14 message) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFQueueDescStatsRequestVer14(");
