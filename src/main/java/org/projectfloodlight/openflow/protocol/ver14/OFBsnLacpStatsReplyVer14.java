...
class OFBsnLacpStatsReplyVer14 implements OFBsnLacpStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnLacpStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnLacpStatsReplyVer14 DEFAULT = new OFBsnLacpStatsReplyVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnLacpStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnLacpStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnLacpStatsReplyVer14: property flags cannot be null");
        }
        if(entries == null) {
    ...
    static class BuilderWithParent implements OFBsnLacpStatsReply.Builder {
        final OFBsnLacpStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnLacpStatsReplyVer14 parentMessage) {
    ...
    public OFBsnLacpStatsReply.Builder setEntries(List<OFBsnLacpStatsEntry> entries) {
        ...
        public OFBsnLacpStatsReply build() {
                ...
                //
                return new OFBsnLacpStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnLacpStatsReply> {
        ...
        public OFBsnLacpStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            List<OFBsnLacpStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFBsnLacpStatsEntryVer14.READER);

            OFBsnLacpStatsReplyVer14 bsnLacpStatsReplyVer14 = new OFBsnLacpStatsReplyVer14(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnLacpStatsReplyVer14);
            return bsnLacpStatsReplyVer14;
        }
    }
    ...
    final static OFBsnLacpStatsReplyVer14Funnel FUNNEL = new OFBsnLacpStatsReplyVer14Funnel();
    static class OFBsnLacpStatsReplyVer14Funnel implements Funnel<OFBsnLacpStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnLacpStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnLacpStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnLacpStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnLacpStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnLacpStatsReplyVer14 other = (OFBsnLacpStatsReplyVer14) obj;
