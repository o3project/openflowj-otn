...
class OFInstructionIdWriteActionsVer14 implements OFInstructionIdWriteActions {
...
//
    ...
    final static OFInstructionIdWriteActionsVer14 DEFAULT = new OFInstructionIdWriteActionsVer14(

    );

    final static OFInstructionIdWriteActionsVer14 INSTANCE = new OFInstructionIdWriteActionsVer14();
    ...
    final static OFInstructionIdWriteActionsVer14Funnel FUNNEL = new OFInstructionIdWriteActionsVer14Funnel();
    static class OFInstructionIdWriteActionsVer14Funnel implements Funnel<OFInstructionIdWriteActionsVer14> {
    ...
    static class Writer implements OFMessageWriter<OFInstructionIdWriteActionsVer14> {
        @Override
        public void write(ChannelBuffer bb, OFInstructionIdWriteActionsVer14 message) {
            // fixed value property type = 3
