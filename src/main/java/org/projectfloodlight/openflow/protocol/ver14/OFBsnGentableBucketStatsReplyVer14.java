...
class OFBsnGentableBucketStatsReplyVer14 implements OFBsnGentableBucketStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableBucketStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnGentableBucketStatsReplyVer14 DEFAULT = new OFBsnGentableBucketStatsReplyVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnGentableBucketStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnGentableBucketStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnGentableBucketStatsReplyVer14: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFBsnGentableBucketStatsReplyVer14: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFBsnGentableBucketStatsReply.Builder {
        final OFBsnGentableBucketStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableBucketStatsReplyVer14 parentMessage) {
    ...
    public OFBsnGentableBucketStatsReply.Builder setEntries(List<OFBsnGentableBucketStatsEntry> entries) {
        ...
        public OFBsnGentableBucketStatsReply build() {
                ...
                //
                return new OFBsnGentableBucketStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableBucketStatsReply> {
        ...
        public OFBsnGentableBucketStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            List<OFBsnGentableBucketStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFBsnGentableBucketStatsEntryVer14.READER);

            OFBsnGentableBucketStatsReplyVer14 bsnGentableBucketStatsReplyVer14 = new OFBsnGentableBucketStatsReplyVer14(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableBucketStatsReplyVer14);
            return bsnGentableBucketStatsReplyVer14;
        }
    }
    ...
    final static OFBsnGentableBucketStatsReplyVer14Funnel FUNNEL = new OFBsnGentableBucketStatsReplyVer14Funnel();
    static class OFBsnGentableBucketStatsReplyVer14Funnel implements Funnel<OFBsnGentableBucketStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableBucketStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableBucketStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnGentableBucketStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableBucketStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableBucketStatsReplyVer14 other = (OFBsnGentableBucketStatsReplyVer14) obj;
