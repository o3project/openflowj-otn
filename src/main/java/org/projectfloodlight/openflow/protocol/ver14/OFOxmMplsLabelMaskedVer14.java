...
class OFOxmMplsLabelMaskedVer14 implements OFOxmMplsLabelMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmMplsLabelMaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmMplsLabelMaskedVer14 DEFAULT = new OFOxmMplsLabelMaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmMplsLabelMaskedVer14(U32 value, U32 mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmMplsLabelMaskedVer14: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmMplsLabelMaskedVer14: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<U32> getCanonical() {
        if (U32.NO_MASK.equals(mask)) {
            return new OFOxmMplsLabelVer14(value);
    ...
    static class BuilderWithParent implements OFOxmMplsLabelMasked.Builder {
        final OFOxmMplsLabelMaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmMplsLabelMaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmMplsLabelMasked> {
        ...
        public OFOxmMplsLabelMasked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmMplsLabelMaskedVer14 oxmMplsLabelMaskedVer14 = new OFOxmMplsLabelMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmMplsLabelMaskedVer14);
            return oxmMplsLabelMaskedVer14;
        }
    }
    ...
    final static OFOxmMplsLabelMaskedVer14Funnel FUNNEL = new OFOxmMplsLabelMaskedVer14Funnel();
    static class OFOxmMplsLabelMaskedVer14Funnel implements Funnel<OFOxmMplsLabelMaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmMplsLabelMaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80004508L
    ...
    static class Writer implements OFMessageWriter<OFOxmMplsLabelMaskedVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmMplsLabelMaskedVer14 message) {
            // fixed value property typeLen = 0x80004508L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmMplsLabelMaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmMplsLabelMaskedVer14 other = (OFOxmMplsLabelMaskedVer14) obj;
