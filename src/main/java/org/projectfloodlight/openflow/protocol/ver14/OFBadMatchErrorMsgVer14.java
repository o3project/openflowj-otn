...
class OFBadMatchErrorMsgVer14 implements OFBadMatchErrorMsg {
    private static final Logger logger = LoggerFactory.getLogger(OFBadMatchErrorMsgVer14.class);
    // version: 1.4
...
//
    ...
    OFBadMatchErrorMsgVer14(long xid, OFBadMatchCode code, OFErrorCauseData data) {
        if(code == null) {
            throw new NullPointerException("OFBadMatchErrorMsgVer14: property code cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFBadMatchErrorMsgVer14: property data cannot be null");
        }
        this.xid = xid;
        this.code = code;
        this.data = data;
    ...
    static class BuilderWithParent implements OFBadMatchErrorMsg.Builder {
        final OFBadMatchErrorMsgVer14 parentMessage;
        ...
        BuilderWithParent(OFBadMatchErrorMsgVer14 parentMessage) {
    ...
    public OFBadMatchErrorMsg.Builder setData(OFErrorCauseData data) {
        ...
        public OFBadMatchErrorMsg build() {
                ...
                //
                return new OFBadMatchErrorMsgVer14(
                    xid,
                    code,
                    data
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBadMatchErrorMsg> {
        ...
        public OFBadMatchErrorMsg readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBadMatchCode code = OFBadMatchCodeSerializerVer14.readFrom(bb);
            OFErrorCauseData data = OFErrorCauseData.read(bb, length - (bb.readerIndex() - start), OFVersion.OF_14);

            OFBadMatchErrorMsgVer14 badMatchErrorMsgVer14 = new OFBadMatchErrorMsgVer14(
                    xid,
                      code,
                      data
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", badMatchErrorMsgVer14);
            return badMatchErrorMsgVer14;
        }
    }
    ...
    final static OFBadMatchErrorMsgVer14Funnel FUNNEL = new OFBadMatchErrorMsgVer14Funnel();
    static class OFBadMatchErrorMsgVer14Funnel implements Funnel<OFBadMatchErrorMsgVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBadMatchErrorMsgVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
            ...
            OFBadMatchCodeSerializerVer14.putTo(message.code, sink);
    ...
    static class Writer implements OFMessageWriter<OFBadMatchErrorMsgVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBadMatchErrorMsgVer14 message) {
            ...
            OFBadMatchCodeSerializerVer14.writeTo(bb, message.code);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBadMatchErrorMsgVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBadMatchErrorMsgVer14 other = (OFBadMatchErrorMsgVer14) obj;
