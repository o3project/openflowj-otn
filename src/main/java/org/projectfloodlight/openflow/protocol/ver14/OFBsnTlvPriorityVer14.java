...
class OFBsnTlvPriorityVer14 implements OFBsnTlvPriority {
...
//
    ...
    final static OFBsnTlvPriorityVer14 DEFAULT = new OFBsnTlvPriorityVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvPriority> {
        ...
        public OFBsnTlvPriority readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnTlvPriorityVer14 bsnTlvPriorityVer14 = new OFBsnTlvPriorityVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvPriorityVer14);
    ...
    final static OFBsnTlvPriorityVer14Funnel FUNNEL = new OFBsnTlvPriorityVer14Funnel();
    static class OFBsnTlvPriorityVer14Funnel implements Funnel<OFBsnTlvPriorityVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvPriorityVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnTlvPriorityVer14 message) {
            // fixed value property type = 0x39
