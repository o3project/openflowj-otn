...
public class OFGroupTypeSerializerVer14 {
    ...
    public static OFGroupType ofWireValue(byte val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFGroupType in version 1.4: " + val);
        }
    }
    ...
    public static byte toWireValue(OFGroupType e) {
        switch(e) {
            ...
            case FF:
                return FF_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFGroupType in version 1.4: " + e);
        }
    }
