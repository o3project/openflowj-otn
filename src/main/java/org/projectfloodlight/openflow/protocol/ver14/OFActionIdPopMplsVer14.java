...
class OFActionIdPopMplsVer14 implements OFActionIdPopMpls {
...
//
    ...
    final static OFActionIdPopMplsVer14 DEFAULT = new OFActionIdPopMplsVer14(

    );

    final static OFActionIdPopMplsVer14 INSTANCE = new OFActionIdPopMplsVer14();
    ...
    final static OFActionIdPopMplsVer14Funnel FUNNEL = new OFActionIdPopMplsVer14Funnel();
    static class OFActionIdPopMplsVer14Funnel implements Funnel<OFActionIdPopMplsVer14> {
    ...
    static class Writer implements OFMessageWriter<OFActionIdPopMplsVer14> {
        @Override
