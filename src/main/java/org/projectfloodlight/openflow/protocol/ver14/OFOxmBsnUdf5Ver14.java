...
class OFOxmBsnUdf5Ver14 implements OFOxmBsnUdf5 {
...
//
    ...
    final static OFOxmBsnUdf5Ver14 DEFAULT = new OFOxmBsnUdf5Ver14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnUdf5> {
        ...
        public OFOxmBsnUdf5 readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmBsnUdf5Ver14 oxmBsnUdf5Ver14 = new OFOxmBsnUdf5Ver14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnUdf5Ver14);
    ...
    final static OFOxmBsnUdf5Ver14Funnel FUNNEL = new OFOxmBsnUdf5Ver14Funnel();
    static class OFOxmBsnUdf5Ver14Funnel implements Funnel<OFOxmBsnUdf5Ver14> {
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnUdf5Ver14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmBsnUdf5Ver14 message) {
            // fixed value property typeLen = 0x31a04L
            bb.writeInt(0x31a04);
