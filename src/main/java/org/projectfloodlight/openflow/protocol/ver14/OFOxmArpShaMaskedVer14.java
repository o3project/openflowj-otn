...
class OFOxmArpShaMaskedVer14 implements OFOxmArpShaMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmArpShaMaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmArpShaMaskedVer14 DEFAULT = new OFOxmArpShaMaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmArpShaMaskedVer14(MacAddress value, MacAddress mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmArpShaMaskedVer14: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmArpShaMaskedVer14: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<MacAddress> getCanonical() {
        if (MacAddress.NO_MASK.equals(mask)) {
            return new OFOxmArpShaVer14(value);
    ...
    static class BuilderWithParent implements OFOxmArpShaMasked.Builder {
        final OFOxmArpShaMaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmArpShaMaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmArpShaMasked> {
        ...
        public OFOxmArpShaMasked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmArpShaMaskedVer14 oxmArpShaMaskedVer14 = new OFOxmArpShaMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmArpShaMaskedVer14);
            return oxmArpShaMaskedVer14;
        }
    }
    ...
    final static OFOxmArpShaMaskedVer14Funnel FUNNEL = new OFOxmArpShaMaskedVer14Funnel();
    static class OFOxmArpShaMaskedVer14Funnel implements Funnel<OFOxmArpShaMaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmArpShaMaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x8000310cL
    ...
    static class Writer implements OFMessageWriter<OFOxmArpShaMaskedVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmArpShaMaskedVer14 message) {
            // fixed value property typeLen = 0x8000310cL
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmArpShaMaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmArpShaMaskedVer14 other = (OFOxmArpShaMaskedVer14) obj;
