...
public class OFBsnVportStatusSerializerVer14 {
    ...
    public static OFBsnVportStatus ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnVportStatus in version 1.4: " + val);
        }
    }
    ...
    public static short toWireValue(OFBsnVportStatus e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnVportStatus in version 1.4: " + e);
        }
    }
