...
class OFOxmMplsLabelVer14 implements OFOxmMplsLabel {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmMplsLabelVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmMplsLabelVer14 DEFAULT = new OFOxmMplsLabelVer14(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmMplsLabelVer14(U32 value) {
        if(value == null) {
            throw new NullPointerException("OFOxmMplsLabelVer14: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmMplsLabel.Builder {
        final OFOxmMplsLabelVer14 parentMessage;

        // OF message fields
        private boolean valueSet;
        private U32 value;

        BuilderWithParent(OFOxmMplsLabelVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmMplsLabel> {
        ...
        public OFOxmMplsLabel readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmMplsLabelVer14 oxmMplsLabelVer14 = new OFOxmMplsLabelVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmMplsLabelVer14);
            return oxmMplsLabelVer14;
        }
    }
    ...
    final static OFOxmMplsLabelVer14Funnel FUNNEL = new OFOxmMplsLabelVer14Funnel();
    static class OFOxmMplsLabelVer14Funnel implements Funnel<OFOxmMplsLabelVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmMplsLabelVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80004404L
    ...
    static class Writer implements OFMessageWriter<OFOxmMplsLabelVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmMplsLabelVer14 message) {
            // fixed value property typeLen = 0x80004404L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmMplsLabelVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmMplsLabelVer14 other = (OFOxmMplsLabelVer14) obj;
