...
class OFBsnDebugCounterDescStatsReplyVer14 implements OFBsnDebugCounterDescStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnDebugCounterDescStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnDebugCounterDescStatsReplyVer14 DEFAULT = new OFBsnDebugCounterDescStatsReplyVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnDebugCounterDescStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnDebugCounterDescStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnDebugCounterDescStatsReplyVer14: property flags cannot be null");
        }
        if(entries == null) {
    ...
    static class BuilderWithParent implements OFBsnDebugCounterDescStatsReply.Builder {
        final OFBsnDebugCounterDescStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnDebugCounterDescStatsReplyVer14 parentMessage) {
    ...
    public OFBsnDebugCounterDescStatsReply.Builder setEntries(List<OFBsnDebugCounterDescStatsEntry> entries) {
        ...
        public OFBsnDebugCounterDescStatsReply build() {
                ...
                //
                return new OFBsnDebugCounterDescStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnDebugCounterDescStatsReply> {
        ...
        public OFBsnDebugCounterDescStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            List<OFBsnDebugCounterDescStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFBsnDebugCounterDescStatsEntryVer14.READER);

            OFBsnDebugCounterDescStatsReplyVer14 bsnDebugCounterDescStatsReplyVer14 = new OFBsnDebugCounterDescStatsReplyVer14(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnDebugCounterDescStatsReplyVer14);
            return bsnDebugCounterDescStatsReplyVer14;
        }
    }
    ...
    final static OFBsnDebugCounterDescStatsReplyVer14Funnel FUNNEL = new OFBsnDebugCounterDescStatsReplyVer14Funnel();
    static class OFBsnDebugCounterDescStatsReplyVer14Funnel implements Funnel<OFBsnDebugCounterDescStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnDebugCounterDescStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnDebugCounterDescStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnDebugCounterDescStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnDebugCounterDescStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnDebugCounterDescStatsReplyVer14 other = (OFBsnDebugCounterDescStatsReplyVer14) obj;
