...
class OFFlowStatsRequestVer14 implements OFFlowStatsRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFFlowStatsRequestVer14.class);
    // version: 1.4
...
//
    ...
    final static OFFlowStatsRequestVer14 DEFAULT = new OFFlowStatsRequestVer14(
    ...
    OFFlowStatsRequestVer14(long xid, Set<OFStatsRequestFlags> flags, TableId tableId, OFPort outPort, OFGroup outGroup, U64 cookie, U64 cookieMask, Match match) {
        if(flags == null) {
            throw new NullPointerException("OFFlowStatsRequestVer14: property flags cannot be null");
        }
        if(tableId == null) {
            throw new NullPointerException("OFFlowStatsRequestVer14: property tableId cannot be null");
        }
        if(outPort == null) {
            throw new NullPointerException("OFFlowStatsRequestVer14: property outPort cannot be null");
        }
        if(outGroup == null) {
            throw new NullPointerException("OFFlowStatsRequestVer14: property outGroup cannot be null");
        }
        if(cookie == null) {
            throw new NullPointerException("OFFlowStatsRequestVer14: property cookie cannot be null");
        }
        if(cookieMask == null) {
            throw new NullPointerException("OFFlowStatsRequestVer14: property cookieMask cannot be null");
        }
        if(match == null) {
    ...
    static class BuilderWithParent implements OFFlowStatsRequest.Builder {
        final OFFlowStatsRequestVer14 parentMessage;
        ...
        BuilderWithParent(OFFlowStatsRequestVer14 parentMessage) {
    ...
    public OFFlowStatsRequest.Builder setMatch(Match match) {
        ...
        public OFFlowStatsRequest build() {
                ...
                //
                return new OFFlowStatsRequestVer14(
                    xid,
                    flags,
                    tableId,
                    outPort,
...
//
    ...
    static class Reader implements OFMessageReader<OFFlowStatsRequest> {
        ...
        public OFFlowStatsRequest readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFFlowStatsRequestVer14 flowStatsRequestVer14 = new OFFlowStatsRequestVer14(
                    xid,
                      flags,
                      tableId,
                      outPort,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", flowStatsRequestVer14);
            return flowStatsRequestVer14;
        }
    }
    ...
    final static OFFlowStatsRequestVer14Funnel FUNNEL = new OFFlowStatsRequestVer14Funnel();
    static class OFFlowStatsRequestVer14Funnel implements Funnel<OFFlowStatsRequestVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFFlowStatsRequestVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFFlowStatsRequestVer14> {
        @Override
        public void write(ChannelBuffer bb, OFFlowStatsRequestVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFFlowStatsRequestVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFFlowStatsRequestVer14 other = (OFFlowStatsRequestVer14) obj;
