...
class OFBsnFlowIdleEnableSetReplyVer14 implements OFBsnFlowIdleEnableSetReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnFlowIdleEnableSetReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnFlowIdleEnableSetReplyVer14 DEFAULT = new OFBsnFlowIdleEnableSetReplyVer14(
        DEFAULT_XID, DEFAULT_ENABLE, DEFAULT_STATUS
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnFlowIdleEnableSetReplyVer14(long xid, long enable, long status) {
        this.xid = xid;
        this.enable = enable;
        this.status = status;
    }
    ...
    static class BuilderWithParent implements OFBsnFlowIdleEnableSetReply.Builder {
        final OFBsnFlowIdleEnableSetReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnFlowIdleEnableSetReplyVer14 parentMessage) {
    ...
    public OFBsnFlowIdleEnableSetReply.Builder setStatus(long status) {
        ...
        public OFBsnFlowIdleEnableSetReply build() {
                ...
                //
                return new OFBsnFlowIdleEnableSetReplyVer14(
                    xid,
                    enable,
                    status
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnFlowIdleEnableSetReply> {
        ...
        public OFBsnFlowIdleEnableSetReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnFlowIdleEnableSetReplyVer14 bsnFlowIdleEnableSetReplyVer14 = new OFBsnFlowIdleEnableSetReplyVer14(
                    xid,
                      enable,
                      status
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnFlowIdleEnableSetReplyVer14);
            return bsnFlowIdleEnableSetReplyVer14;
        }
    }
    ...
    final static OFBsnFlowIdleEnableSetReplyVer14Funnel FUNNEL = new OFBsnFlowIdleEnableSetReplyVer14Funnel();
    static class OFBsnFlowIdleEnableSetReplyVer14Funnel implements Funnel<OFBsnFlowIdleEnableSetReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnFlowIdleEnableSetReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnFlowIdleEnableSetReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnFlowIdleEnableSetReplyVer14 message) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnFlowIdleEnableSetReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnFlowIdleEnableSetReplyVer14 other = (OFBsnFlowIdleEnableSetReplyVer14) obj;
