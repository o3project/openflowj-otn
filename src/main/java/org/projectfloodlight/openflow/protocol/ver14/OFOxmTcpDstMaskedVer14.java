...
class OFOxmTcpDstMaskedVer14 implements OFOxmTcpDstMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmTcpDstMaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmTcpDstMaskedVer14 DEFAULT = new OFOxmTcpDstMaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmTcpDstMaskedVer14(TransportPort value, TransportPort mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmTcpDstMaskedVer14: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmTcpDstMaskedVer14: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<TransportPort> getCanonical() {
        if (TransportPort.NO_MASK.equals(mask)) {
            return new OFOxmTcpDstVer14(value);
    ...
    static class BuilderWithParent implements OFOxmTcpDstMasked.Builder {
        final OFOxmTcpDstMaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmTcpDstMaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmTcpDstMasked> {
        ...
        public OFOxmTcpDstMasked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmTcpDstMaskedVer14 oxmTcpDstMaskedVer14 = new OFOxmTcpDstMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmTcpDstMaskedVer14);
            return oxmTcpDstMaskedVer14;
        }
    }
    ...
    final static OFOxmTcpDstMaskedVer14Funnel FUNNEL = new OFOxmTcpDstMaskedVer14Funnel();
    static class OFOxmTcpDstMaskedVer14Funnel implements Funnel<OFOxmTcpDstMaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmTcpDstMaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80001d04L
    ...
    static class Writer implements OFMessageWriter<OFOxmTcpDstMaskedVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmTcpDstMaskedVer14 message) {
            // fixed value property typeLen = 0x80001d04L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmTcpDstMaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmTcpDstMaskedVer14 other = (OFOxmTcpDstMaskedVer14) obj;
