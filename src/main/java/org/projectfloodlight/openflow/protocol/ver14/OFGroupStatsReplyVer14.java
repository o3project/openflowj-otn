...
class OFGroupStatsReplyVer14 implements OFGroupStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFGroupStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFGroupStatsReplyVer14 DEFAULT = new OFGroupStatsReplyVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFGroupStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, List<OFGroupStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFGroupStatsReplyVer14: property flags cannot be null");
        }
        if(entries == null) {
    ...
    static class BuilderWithParent implements OFGroupStatsReply.Builder {
        final OFGroupStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFGroupStatsReplyVer14 parentMessage) {
    ...
    public OFGroupStatsReply.Builder setEntries(List<OFGroupStatsEntry> entries) {
        ...
        public OFGroupStatsReply build() {
                ...
                //
                return new OFGroupStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFGroupStatsReply> {
        ...
        public OFGroupStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            // pad: 4 bytes
            bb.skipBytes(4);
            List<OFGroupStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFGroupStatsEntryVer14.READER);

            OFGroupStatsReplyVer14 groupStatsReplyVer14 = new OFGroupStatsReplyVer14(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", groupStatsReplyVer14);
            return groupStatsReplyVer14;
        }
    }
    ...
    final static OFGroupStatsReplyVer14Funnel FUNNEL = new OFGroupStatsReplyVer14Funnel();
    static class OFGroupStatsReplyVer14Funnel implements Funnel<OFGroupStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFGroupStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFGroupStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFGroupStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFGroupStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFGroupStatsReplyVer14 other = (OFGroupStatsReplyVer14) obj;
