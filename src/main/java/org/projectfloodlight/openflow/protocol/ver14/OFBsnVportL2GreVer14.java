...
class OFBsnVportL2GreVer14 implements OFBsnVportL2Gre {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnVportL2GreVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnVportL2GreVer14 DEFAULT = new OFBsnVportL2GreVer14(
    ...
    OFBsnVportL2GreVer14(Set<OFBsnVportL2GreFlags> flags, OFPort portNo, OFPort loopbackPortNo, MacAddress localMac, MacAddress nhMac, IPv4Address srcIp, IPv4Address dstIp, short dscp, short ttl, long vpn, long rateLimit, String ifName) {
        if(flags == null) {
            throw new NullPointerException("OFBsnVportL2GreVer14: property flags cannot be null");
        }
        if(portNo == null) {
            throw new NullPointerException("OFBsnVportL2GreVer14: property portNo cannot be null");
        }
        if(loopbackPortNo == null) {
            throw new NullPointerException("OFBsnVportL2GreVer14: property loopbackPortNo cannot be null");
        }
        if(localMac == null) {
            throw new NullPointerException("OFBsnVportL2GreVer14: property localMac cannot be null");
        }
        if(nhMac == null) {
            throw new NullPointerException("OFBsnVportL2GreVer14: property nhMac cannot be null");
        }
        if(srcIp == null) {
            throw new NullPointerException("OFBsnVportL2GreVer14: property srcIp cannot be null");
        }
        if(dstIp == null) {
            throw new NullPointerException("OFBsnVportL2GreVer14: property dstIp cannot be null");
        }
        if(ifName == null) {
            throw new NullPointerException("OFBsnVportL2GreVer14: property ifName cannot be null");
        }
        this.flags = flags;
        this.portNo = portNo;
    ...
    static class BuilderWithParent implements OFBsnVportL2Gre.Builder {
        final OFBsnVportL2GreVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnVportL2GreVer14 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFBsnVportL2Gre build() {
                ...
                //
                return new OFBsnVportL2GreVer14(
                    flags,
                    portNo,
                    loopbackPortNo,
                    localMac,
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnVportL2Gre> {
        ...
        public OFBsnVportL2Gre readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            Set<OFBsnVportL2GreFlags> flags = OFBsnVportL2GreFlagsSerializerVer14.readFrom(bb);
            ...
            OFBsnVportL2GreVer14 bsnVportL2GreVer14 = new OFBsnVportL2GreVer14(
                    flags,
                      portNo,
                      loopbackPortNo,
                      localMac,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnVportL2GreVer14);
            return bsnVportL2GreVer14;
        }
    }
    ...
    final static OFBsnVportL2GreVer14Funnel FUNNEL = new OFBsnVportL2GreVer14Funnel();
    static class OFBsnVportL2GreVer14Funnel implements Funnel<OFBsnVportL2GreVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnVportL2GreVer14 message, PrimitiveSink sink) {
            // fixed value property type = 0x1
            sink.putShort((short) 0x1);
            // fixed value property length = 64
            sink.putShort((short) 0x40);
            OFBsnVportL2GreFlagsSerializerVer14.putTo(message.flags, sink);
    ...
    static class Writer implements OFMessageWriter<OFBsnVportL2GreVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnVportL2GreVer14 message) {
            // fixed value property type = 0x1
            bb.writeShort((short) 0x1);
            // fixed value property length = 64
            bb.writeShort((short) 0x40);
            OFBsnVportL2GreFlagsSerializerVer14.writeTo(bb, message.flags);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnVportL2GreVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnVportL2GreVer14 other = (OFBsnVportL2GreVer14) obj;
