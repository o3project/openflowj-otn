...
class OFOxmBsnUdf5MaskedVer14 implements OFOxmBsnUdf5Masked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnUdf5MaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmBsnUdf5MaskedVer14 DEFAULT = new OFOxmBsnUdf5MaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnUdf5MaskedVer14(UDF value, UDF mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnUdf5MaskedVer14: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmBsnUdf5MaskedVer14: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    static class BuilderWithParent implements OFOxmBsnUdf5Masked.Builder {
        final OFOxmBsnUdf5MaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmBsnUdf5MaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnUdf5Masked> {
        ...
        public OFOxmBsnUdf5Masked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmBsnUdf5MaskedVer14 oxmBsnUdf5MaskedVer14 = new OFOxmBsnUdf5MaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnUdf5MaskedVer14);
            return oxmBsnUdf5MaskedVer14;
        }
    }
    ...
    final static OFOxmBsnUdf5MaskedVer14Funnel FUNNEL = new OFOxmBsnUdf5MaskedVer14Funnel();
    static class OFOxmBsnUdf5MaskedVer14Funnel implements Funnel<OFOxmBsnUdf5MaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnUdf5MaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x31b08L
            sink.putInt(0x31b08);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnUdf5MaskedVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmBsnUdf5MaskedVer14 message) {
            // fixed value property typeLen = 0x31b08L
            bb.writeInt(0x31b08);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnUdf5MaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnUdf5MaskedVer14 other = (OFOxmBsnUdf5MaskedVer14) obj;
