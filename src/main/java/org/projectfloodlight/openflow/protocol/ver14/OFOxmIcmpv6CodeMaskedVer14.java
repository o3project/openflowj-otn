...
class OFOxmIcmpv6CodeMaskedVer14 implements OFOxmIcmpv6CodeMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIcmpv6CodeMaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmIcmpv6CodeMaskedVer14 DEFAULT = new OFOxmIcmpv6CodeMaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIcmpv6CodeMaskedVer14(U8 value, U8 mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmIcmpv6CodeMaskedVer14: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmIcmpv6CodeMaskedVer14: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    static class BuilderWithParent implements OFOxmIcmpv6CodeMasked.Builder {
        final OFOxmIcmpv6CodeMaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmIcmpv6CodeMaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIcmpv6CodeMasked> {
        ...
        public OFOxmIcmpv6CodeMasked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmIcmpv6CodeMaskedVer14 oxmIcmpv6CodeMaskedVer14 = new OFOxmIcmpv6CodeMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIcmpv6CodeMaskedVer14);
            return oxmIcmpv6CodeMaskedVer14;
        }
    }
    ...
    final static OFOxmIcmpv6CodeMaskedVer14Funnel FUNNEL = new OFOxmIcmpv6CodeMaskedVer14Funnel();
    static class OFOxmIcmpv6CodeMaskedVer14Funnel implements Funnel<OFOxmIcmpv6CodeMaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIcmpv6CodeMaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80003d02L
    ...
    static class Writer implements OFMessageWriter<OFOxmIcmpv6CodeMaskedVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmIcmpv6CodeMaskedVer14 message) {
            // fixed value property typeLen = 0x80003d02L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIcmpv6CodeMaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIcmpv6CodeMaskedVer14 other = (OFOxmIcmpv6CodeMaskedVer14) obj;
