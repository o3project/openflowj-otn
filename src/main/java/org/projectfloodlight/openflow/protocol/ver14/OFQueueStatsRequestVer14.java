...
class OFQueueStatsRequestVer14 implements OFQueueStatsRequest {
...
//
    ...
    final static OFQueueStatsRequestVer14 DEFAULT = new OFQueueStatsRequestVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_PORT_NO, DEFAULT_QUEUE_ID
    );

    // package private constructor - used by readers, builders, and factory
    OFQueueStatsRequestVer14(long xid, Set<OFStatsRequestFlags> flags, OFPort portNo, long queueId) {
        if(flags == null) {
    ...
    static class BuilderWithParent implements OFQueueStatsRequest.Builder {
        ...
        BuilderWithParent(OFQueueStatsRequestVer14 parentMessage) {
    ...
    public OFQueueStatsRequest.Builder setQueueId(long queueId) {
        ...
        public OFQueueStatsRequest build() {
                ...
                //
                return new OFQueueStatsRequestVer14(
                    xid,
                    flags,
                    portNo,
                    queueId
...
//
    ...
    static class Reader implements OFMessageReader<OFQueueStatsRequest> {
        ...
        public OFQueueStatsRequest readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFQueueStatsRequestVer14 queueStatsRequestVer14 = new OFQueueStatsRequestVer14(
                    xid,
                      flags,
                      portNo,
                      queueId
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", queueStatsRequestVer14);
            return queueStatsRequestVer14;
        }
    }
    ...
    final static OFQueueStatsRequestVer14Funnel FUNNEL = new OFQueueStatsRequestVer14Funnel();
    static class OFQueueStatsRequestVer14Funnel implements Funnel<OFQueueStatsRequestVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFQueueStatsRequestVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFQueueStatsRequestVer14> {
        @Override
        public void write(ChannelBuffer bb, OFQueueStatsRequestVer14 message) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFQueueStatsRequestVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFQueueStatsRequestVer14 other = (OFQueueStatsRequestVer14) obj;
