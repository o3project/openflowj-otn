...
class OFOxmEthTypeVer14 implements OFOxmEthType {
...
//
    ...
    final static OFOxmEthTypeVer14 DEFAULT = new OFOxmEthTypeVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmEthType> {
        ...
        public OFOxmEthType readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmEthTypeVer14 oxmEthTypeVer14 = new OFOxmEthTypeVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmEthTypeVer14);
    ...
    final static OFOxmEthTypeVer14Funnel FUNNEL = new OFOxmEthTypeVer14Funnel();
    static class OFOxmEthTypeVer14Funnel implements Funnel<OFOxmEthTypeVer14> {
    ...
    static class Writer implements OFMessageWriter<OFOxmEthTypeVer14> {
        @Override
