...
class OFBsnGentableEntryStatsReplyVer14 implements OFBsnGentableEntryStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableEntryStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnGentableEntryStatsReplyVer14 DEFAULT = new OFBsnGentableEntryStatsReplyVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnGentableEntryStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnGentableEntryStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnGentableEntryStatsReplyVer14: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFBsnGentableEntryStatsReplyVer14: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFBsnGentableEntryStatsReply.Builder {
        final OFBsnGentableEntryStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableEntryStatsReplyVer14 parentMessage) {
    ...
    public OFBsnGentableEntryStatsReply.Builder setEntries(List<OFBsnGentableEntryStatsEntry> entries) {
        ...
        public OFBsnGentableEntryStatsReply build() {
                ...
                //
                return new OFBsnGentableEntryStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableEntryStatsReply> {
        ...
        public OFBsnGentableEntryStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableEntryStatsReplyVer14);
            return bsnGentableEntryStatsReplyVer14;
        }
    }
    ...
    final static OFBsnGentableEntryStatsReplyVer14Funnel FUNNEL = new OFBsnGentableEntryStatsReplyVer14Funnel();
    static class OFBsnGentableEntryStatsReplyVer14Funnel implements Funnel<OFBsnGentableEntryStatsReplyVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableEntryStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnGentableEntryStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableEntryStatsReplyVer14(");
