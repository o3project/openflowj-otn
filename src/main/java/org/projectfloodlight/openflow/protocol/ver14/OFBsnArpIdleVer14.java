...
class OFBsnArpIdleVer14 implements OFBsnArpIdle {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnArpIdleVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnArpIdleVer14 DEFAULT = new OFBsnArpIdleVer14(
    ...
    static class BuilderWithParent implements OFBsnArpIdle.Builder {
        final OFBsnArpIdleVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnArpIdleVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnArpIdle> {
        ...
        public OFBsnArpIdle readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnArpIdleVer14 bsnArpIdleVer14 = new OFBsnArpIdleVer14(
                    xid,
                      vlanVid,
                      ipv4Addr
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnArpIdleVer14);
            return bsnArpIdleVer14;
        }
    }
    ...
    final static OFBsnArpIdleVer14Funnel FUNNEL = new OFBsnArpIdleVer14Funnel();
    static class OFBsnArpIdleVer14Funnel implements Funnel<OFBsnArpIdleVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnArpIdleVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnArpIdleVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnArpIdleVer14 message) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnArpIdleVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnArpIdleVer14 other = (OFBsnArpIdleVer14) obj;
