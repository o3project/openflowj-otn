...
class OFAggregateStatsReplyVer14 implements OFAggregateStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFAggregateStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFAggregateStatsReplyVer14 DEFAULT = new OFAggregateStatsReplyVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_PACKET_COUNT, DEFAULT_BYTE_COUNT, DEFAULT_FLOW_COUNT
    );

    // package private constructor - used by readers, builders, and factory
    OFAggregateStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, U64 packetCount, U64 byteCount, long flowCount) {
        if(flags == null) {
            throw new NullPointerException("OFAggregateStatsReplyVer14: property flags cannot be null");
        }
        if(packetCount == null) {
            throw new NullPointerException("OFAggregateStatsReplyVer14: property packetCount cannot be null");
        }
        if(byteCount == null) {
            throw new NullPointerException("OFAggregateStatsReplyVer14: property byteCount cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFAggregateStatsReply.Builder {
        final OFAggregateStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFAggregateStatsReplyVer14 parentMessage) {
    ...
    public OFAggregateStatsReply.Builder setFlowCount(long flowCount) {
        ...
        public OFAggregateStatsReply build() {
                ...
                //
                return new OFAggregateStatsReplyVer14(
                    xid,
                    flags,
                    packetCount,
                    byteCount,
...
//
    ...
    static class Reader implements OFMessageReader<OFAggregateStatsReply> {
        ...
        public OFAggregateStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFAggregateStatsReplyVer14 aggregateStatsReplyVer14 = new OFAggregateStatsReplyVer14(
                    xid,
                      flags,
                      packetCount,
                      byteCount,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", aggregateStatsReplyVer14);
            return aggregateStatsReplyVer14;
        }
    }
    ...
    final static OFAggregateStatsReplyVer14Funnel FUNNEL = new OFAggregateStatsReplyVer14Funnel();
    static class OFAggregateStatsReplyVer14Funnel implements Funnel<OFAggregateStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFAggregateStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFAggregateStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFAggregateStatsReplyVer14 other = (OFAggregateStatsReplyVer14) obj;
