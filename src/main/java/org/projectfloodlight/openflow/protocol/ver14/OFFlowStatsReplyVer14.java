...
class OFFlowStatsReplyVer14 implements OFFlowStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFFlowStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFFlowStatsReplyVer14 DEFAULT = new OFFlowStatsReplyVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFFlowStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, List<OFFlowStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFFlowStatsReplyVer14: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFFlowStatsReplyVer14: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFFlowStatsReply.Builder {
        final OFFlowStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFFlowStatsReplyVer14 parentMessage) {
    ...
    public OFFlowStatsReply.Builder setEntries(List<OFFlowStatsEntry> entries) {
        ...
        public OFFlowStatsReply build() {
                ...
                //
                return new OFFlowStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFFlowStatsReply> {
        ...
        public OFFlowStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            // pad: 4 bytes
            bb.skipBytes(4);
            List<OFFlowStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFFlowStatsEntryVer14.READER);

            OFFlowStatsReplyVer14 flowStatsReplyVer14 = new OFFlowStatsReplyVer14(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", flowStatsReplyVer14);
            return flowStatsReplyVer14;
        }
    }
    ...
    final static OFFlowStatsReplyVer14Funnel FUNNEL = new OFFlowStatsReplyVer14Funnel();
    static class OFFlowStatsReplyVer14Funnel implements Funnel<OFFlowStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFFlowStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFFlowStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFFlowStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFFlowStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFFlowStatsReplyVer14 other = (OFFlowStatsReplyVer14) obj;
