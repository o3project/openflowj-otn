...
class OFBsnFlowChecksumBucketStatsReplyVer14 implements OFBsnFlowChecksumBucketStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnFlowChecksumBucketStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnFlowChecksumBucketStatsReplyVer14 DEFAULT = new OFBsnFlowChecksumBucketStatsReplyVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnFlowChecksumBucketStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnFlowChecksumBucketStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnFlowChecksumBucketStatsReplyVer14: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFBsnFlowChecksumBucketStatsReplyVer14: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFBsnFlowChecksumBucketStatsReply.Builder {
        final OFBsnFlowChecksumBucketStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnFlowChecksumBucketStatsReplyVer14 parentMessage) {
    ...
    public OFBsnFlowChecksumBucketStatsReply.Builder setEntries(List<OFBsnFlowChecksumBucketStatsEntry> entries) {
        ...
        public OFBsnFlowChecksumBucketStatsReply build() {
                ...
                //
                return new OFBsnFlowChecksumBucketStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnFlowChecksumBucketStatsReply> {
        ...
        public OFBsnFlowChecksumBucketStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnFlowChecksumBucketStatsReplyVer14);
            return bsnFlowChecksumBucketStatsReplyVer14;
        }
    }
    ...
    final static OFBsnFlowChecksumBucketStatsReplyVer14Funnel FUNNEL = new OFBsnFlowChecksumBucketStatsReplyVer14Funnel();
    static class OFBsnFlowChecksumBucketStatsReplyVer14Funnel implements Funnel<OFBsnFlowChecksumBucketStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnFlowChecksumBucketStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnFlowChecksumBucketStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnFlowChecksumBucketStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnFlowChecksumBucketStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnFlowChecksumBucketStatsReplyVer14 other = (OFBsnFlowChecksumBucketStatsReplyVer14) obj;
