...
class OFFlowDeleteStrictVer14 implements OFFlowDeleteStrict {
    private static final Logger logger = LoggerFactory.getLogger(OFFlowDeleteStrictVer14.class);
    // version: 1.4
...
//
    ...
    final static OFFlowDeleteStrictVer14 DEFAULT = new OFFlowDeleteStrictVer14(
    ...
    OFFlowDeleteStrictVer14(long xid, U64 cookie, U64 cookieMask, TableId tableId, int idleTimeout, int hardTimeout, int priority, OFBufferId bufferId, OFPort outPort, OFGroup outGroup, Set<OFFlowModFlags> flags, int importance, Match match, List<OFInstruction> instructions) {
        if(cookie == null) {
            throw new NullPointerException("OFFlowDeleteStrictVer14: property cookie cannot be null");
        }
        if(cookieMask == null) {
            throw new NullPointerException("OFFlowDeleteStrictVer14: property cookieMask cannot be null");
        }
        if(tableId == null) {
            throw new NullPointerException("OFFlowDeleteStrictVer14: property tableId cannot be null");
        }
        if(bufferId == null) {
            throw new NullPointerException("OFFlowDeleteStrictVer14: property bufferId cannot be null");
        }
        if(outPort == null) {
            throw new NullPointerException("OFFlowDeleteStrictVer14: property outPort cannot be null");
        }
        if(outGroup == null) {
            throw new NullPointerException("OFFlowDeleteStrictVer14: property outGroup cannot be null");
        }
        if(flags == null) {
            throw new NullPointerException("OFFlowDeleteStrictVer14: property flags cannot be null");
        }
        if(match == null) {
            throw new NullPointerException("OFFlowDeleteStrictVer14: property match cannot be null");
        }
        if(instructions == null) {
            throw new NullPointerException("OFFlowDeleteStrictVer14: property instructions cannot be null");
        }
        this.xid = xid;
        this.cookie = cookie;
    ...
    static class BuilderWithParent implements OFFlowDeleteStrict.Builder {
        final OFFlowDeleteStrictVer14 parentMessage;
        ...
        BuilderWithParent(OFFlowDeleteStrictVer14 parentMessage) {
    ...
    public OFFlowDeleteStrict.Builder setImportance(int importance) {
        ...
        public OFFlowDeleteStrict build() {
                ...
                //
                return new OFFlowDeleteStrictVer14(
                    xid,
                    cookie,
                    cookieMask,
                    tableId,
...
//
    ...
    static class Reader implements OFMessageReader<OFFlowDeleteStrict> {
        ...
        public OFFlowDeleteStrict readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", flowDeleteStrictVer14);
            return flowDeleteStrictVer14;
        }
    }
    ...
    final static OFFlowDeleteStrictVer14Funnel FUNNEL = new OFFlowDeleteStrictVer14Funnel();
    static class OFFlowDeleteStrictVer14Funnel implements Funnel<OFFlowDeleteStrictVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFFlowDeleteStrictVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFFlowDeleteStrictVer14> {
        @Override
        public void write(ChannelBuffer bb, OFFlowDeleteStrictVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFFlowDeleteStrictVer14(");
