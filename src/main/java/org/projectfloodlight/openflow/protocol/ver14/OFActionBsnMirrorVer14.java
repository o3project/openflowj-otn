...
class OFActionBsnMirrorVer14 implements OFActionBsnMirror {
...
//
    ...
    final static OFActionBsnMirrorVer14 DEFAULT = new OFActionBsnMirrorVer14(
        DEFAULT_DEST_PORT, DEFAULT_VLAN_TAG, DEFAULT_COPY_STAGE
    );

    // package private constructor - used by readers, builders, and factory
    OFActionBsnMirrorVer14(OFPort destPort, long vlanTag, short copyStage) {
        if(destPort == null) {
    ...
    static class BuilderWithParent implements OFActionBsnMirror.Builder {
        ...
        BuilderWithParent(OFActionBsnMirrorVer14 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFActionBsnMirror build() {
                ...
                //
                return new OFActionBsnMirrorVer14(
                    destPort,
                    vlanTag,
                    copyStage
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFActionBsnMirror> {
        ...
        public OFActionBsnMirror readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFActionBsnMirrorVer14 actionBsnMirrorVer14 = new OFActionBsnMirrorVer14(
                    destPort,
                      vlanTag,
                      copyStage
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionBsnMirrorVer14);
            return actionBsnMirrorVer14;
        }
    }
    ...
    final static OFActionBsnMirrorVer14Funnel FUNNEL = new OFActionBsnMirrorVer14Funnel();
    static class OFActionBsnMirrorVer14Funnel implements Funnel<OFActionBsnMirrorVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFActionBsnMirrorVer14 message, PrimitiveSink sink) {
            // fixed value property type = 65535
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFActionBsnMirrorVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFActionBsnMirrorVer14 other = (OFActionBsnMirrorVer14) obj;
