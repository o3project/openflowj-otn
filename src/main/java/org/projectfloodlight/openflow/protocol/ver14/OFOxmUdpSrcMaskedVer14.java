...
class OFOxmUdpSrcMaskedVer14 implements OFOxmUdpSrcMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmUdpSrcMaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmUdpSrcMaskedVer14 DEFAULT = new OFOxmUdpSrcMaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmUdpSrcMaskedVer14(TransportPort value, TransportPort mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmUdpSrcMaskedVer14: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmUdpSrcMaskedVer14: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<TransportPort> getCanonical() {
        if (TransportPort.NO_MASK.equals(mask)) {
            return new OFOxmUdpSrcVer14(value);
    ...
    static class BuilderWithParent implements OFOxmUdpSrcMasked.Builder {
        final OFOxmUdpSrcMaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmUdpSrcMaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmUdpSrcMasked> {
        ...
        public OFOxmUdpSrcMasked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmUdpSrcMaskedVer14 oxmUdpSrcMaskedVer14 = new OFOxmUdpSrcMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmUdpSrcMaskedVer14);
            return oxmUdpSrcMaskedVer14;
        }
    }
    ...
    final static OFOxmUdpSrcMaskedVer14Funnel FUNNEL = new OFOxmUdpSrcMaskedVer14Funnel();
    static class OFOxmUdpSrcMaskedVer14Funnel implements Funnel<OFOxmUdpSrcMaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmUdpSrcMaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80001f04L
    ...
    static class Writer implements OFMessageWriter<OFOxmUdpSrcMaskedVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmUdpSrcMaskedVer14 message) {
            // fixed value property typeLen = 0x80001f04L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmUdpSrcMaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmUdpSrcMaskedVer14 other = (OFOxmUdpSrcMaskedVer14) obj;
