...
class OFTableFeaturePropApplySetfieldVer14 implements OFTableFeaturePropApplySetfield {
...
//
    ...
    final static OFTableFeaturePropApplySetfieldVer14 DEFAULT = new OFTableFeaturePropApplySetfieldVer14(
        DEFAULT_OXM_IDS
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFTableFeaturePropApplySetfield> {
        ...
        public OFTableFeaturePropApplySetfield readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", tableFeaturePropApplySetfieldVer14);
    ...
    final static OFTableFeaturePropApplySetfieldVer14Funnel FUNNEL = new OFTableFeaturePropApplySetfieldVer14Funnel();
    static class OFTableFeaturePropApplySetfieldVer14Funnel implements Funnel<OFTableFeaturePropApplySetfieldVer14> {
    ...
    static class Writer implements OFMessageWriter<OFTableFeaturePropApplySetfieldVer14> {
        @Override
        public void write(ChannelBuffer bb, OFTableFeaturePropApplySetfieldVer14 message) {
