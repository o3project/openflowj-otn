...
class OFBsnVlanCounterStatsRequestVer14 implements OFBsnVlanCounterStatsRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnVlanCounterStatsRequestVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnVlanCounterStatsRequestVer14 DEFAULT = new OFBsnVlanCounterStatsRequestVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_VLAN_VID
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnVlanCounterStatsRequestVer14(long xid, Set<OFStatsRequestFlags> flags, int vlanVid) {
        if(flags == null) {
            throw new NullPointerException("OFBsnVlanCounterStatsRequestVer14: property flags cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFBsnVlanCounterStatsRequest.Builder {
        final OFBsnVlanCounterStatsRequestVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnVlanCounterStatsRequestVer14 parentMessage) {
    ...
    public OFBsnVlanCounterStatsRequest.Builder setVlanVid(int vlanVid) {
        ...
        public OFBsnVlanCounterStatsRequest build() {
                ...
                //
                return new OFBsnVlanCounterStatsRequestVer14(
                    xid,
                    flags,
                    vlanVid
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnVlanCounterStatsRequest> {
        ...
        public OFBsnVlanCounterStatsRequest readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnVlanCounterStatsRequestVer14 bsnVlanCounterStatsRequestVer14 = new OFBsnVlanCounterStatsRequestVer14(
                    xid,
                      flags,
                      vlanVid
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnVlanCounterStatsRequestVer14);
            return bsnVlanCounterStatsRequestVer14;
        }
    }
    ...
    final static OFBsnVlanCounterStatsRequestVer14Funnel FUNNEL = new OFBsnVlanCounterStatsRequestVer14Funnel();
    static class OFBsnVlanCounterStatsRequestVer14Funnel implements Funnel<OFBsnVlanCounterStatsRequestVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnVlanCounterStatsRequestVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnVlanCounterStatsRequestVer14 message) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnVlanCounterStatsRequestVer14(");
