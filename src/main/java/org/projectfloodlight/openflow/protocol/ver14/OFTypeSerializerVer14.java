...
public class OFTypeSerializerVer14 {
    ...
    public final static byte ROLE_STATUS_VAL = (byte) 0x1e;
    public final static byte TABLE_STATUS_VAL = (byte) 0x1f;
    public final static byte REQUESTFORWARD_VAL = (byte) 0x20;
    public final static byte BUNDLE_CONTROL_VAL = (byte) 0x21;
    public final static byte BUNDLE_ADD_MESSAGE_VAL = (byte) 0x22;
    ...
    public static OFType ofWireValue(byte val) {
        switch(val) {
            ...
            case ROLE_STATUS_VAL:
                return OFType.ROLE_STATUS;
            case TABLE_STATUS_VAL:
                return OFType.TABLE_STATUS;
            case REQUESTFORWARD_VAL:
                return OFType.REQUESTFORWARD;
            case BUNDLE_CONTROL_VAL:
                return OFType.BUNDLE_CONTROL;
            case BUNDLE_ADD_MESSAGE_VAL:
                return OFType.BUNDLE_ADD_MESSAGE;
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFType in version 1.4: " + val);
        }
    }
    ...
    public static byte toWireValue(OFType e) {
        switch(e) {
            ...
            case ROLE_STATUS:
                return ROLE_STATUS_VAL;
            case TABLE_STATUS:
                return TABLE_STATUS_VAL;
            case REQUESTFORWARD:
                return REQUESTFORWARD_VAL;
            case BUNDLE_CONTROL:
                return BUNDLE_CONTROL_VAL;
            case BUNDLE_ADD_MESSAGE:
                return BUNDLE_ADD_MESSAGE_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFType in version 1.4: " + e);
        }
    }
