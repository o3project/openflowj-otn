...
class OFPortDescStatsRequestVer14 implements OFPortDescStatsRequest {
...
//
    ...
    final static OFPortDescStatsRequestVer14 DEFAULT = new OFPortDescStatsRequestVer14(
...
//
    ...
    static class Reader implements OFMessageReader<OFPortDescStatsRequest> {
        ...
        public OFPortDescStatsRequest readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFPortDescStatsRequestVer14 portDescStatsRequestVer14 = new OFPortDescStatsRequestVer14(
                    xid,
                      flags
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", portDescStatsRequestVer14);
    ...
    final static OFPortDescStatsRequestVer14Funnel FUNNEL = new OFPortDescStatsRequestVer14Funnel();
    static class OFPortDescStatsRequestVer14Funnel implements Funnel<OFPortDescStatsRequestVer14> {
    ...
    static class Writer implements OFMessageWriter<OFPortDescStatsRequestVer14> {
        @Override
        public void write(ChannelBuffer bb, OFPortDescStatsRequestVer14 message) {
            // fixed value property version = 5
