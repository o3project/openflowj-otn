...
class OFMeterConfigStatsReplyVer14 implements OFMeterConfigStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFMeterConfigStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    OFMeterConfigStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, List<OFMeterBand> entries) {
        ...
        if(entries == null) {
            throw new NullPointerException("OFMeterConfigStatsReplyVer14: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFMeterConfigStatsReply.Builder {
        final OFMeterConfigStatsReplyVer14 parentMessage;
    ...
    public OFMeterConfigStatsReply.Builder setEntries(List<OFMeterBand> entries) {
        ...
        public OFMeterConfigStatsReply build() {
                ...
                //
                return new OFMeterConfigStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFMeterConfigStatsReply> {
        ...
        public OFMeterConfigStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", meterConfigStatsReplyVer14);
            return meterConfigStatsReplyVer14;
        }
    }
    ...
    final static OFMeterConfigStatsReplyVer14Funnel FUNNEL = new OFMeterConfigStatsReplyVer14Funnel();
    static class OFMeterConfigStatsReplyVer14Funnel implements Funnel<OFMeterConfigStatsReplyVer14> {
    ...
    static class Writer implements OFMessageWriter<OFMeterConfigStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFMeterConfigStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFMeterConfigStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFMeterConfigStatsReplyVer14 other = (OFMeterConfigStatsReplyVer14) obj;
