...
public class OFHelloElemTypeSerializerVer14 {
    ...
    public static OFHelloElemType ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFHelloElemType in version 1.4: " + val);
        }
    }
    ...
    public static short toWireValue(OFHelloElemType e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFHelloElemType in version 1.4: " + e);
        }
    }
