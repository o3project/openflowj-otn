...
class OFOxmArpThaVer14 implements OFOxmArpTha {
...
//
    ...
    final static OFOxmArpThaVer14 DEFAULT = new OFOxmArpThaVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmArpTha> {
        ...
        public OFOxmArpTha readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmArpThaVer14 oxmArpThaVer14 = new OFOxmArpThaVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmArpThaVer14);
    ...
    final static OFOxmArpThaVer14Funnel FUNNEL = new OFOxmArpThaVer14Funnel();
    static class OFOxmArpThaVer14Funnel implements Funnel<OFOxmArpThaVer14> {
    ...
    static class Writer implements OFMessageWriter<OFOxmArpThaVer14> {
        @Override
