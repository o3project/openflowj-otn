...
class OFBsnPduRxReplyVer14 implements OFBsnPduRxReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnPduRxReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnPduRxReplyVer14 DEFAULT = new OFBsnPduRxReplyVer14(
        DEFAULT_XID, DEFAULT_STATUS, DEFAULT_PORT_NO, DEFAULT_SLOT_NUM
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnPduRxReplyVer14(long xid, long status, OFPort portNo, short slotNum) {
        if(portNo == null) {
            throw new NullPointerException("OFBsnPduRxReplyVer14: property portNo cannot be null");
        }
        this.xid = xid;
        this.status = status;
        this.portNo = portNo;
    ...
    static class BuilderWithParent implements OFBsnPduRxReply.Builder {
        final OFBsnPduRxReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnPduRxReplyVer14 parentMessage) {
    ...
    public OFBsnPduRxReply.Builder setSlotNum(short slotNum) {
        ...
        public OFBsnPduRxReply build() {
                ...
                //
                return new OFBsnPduRxReplyVer14(
                    xid,
                    status,
                    portNo,
                    slotNum
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnPduRxReply> {
        ...
        public OFBsnPduRxReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnPduRxReplyVer14 bsnPduRxReplyVer14 = new OFBsnPduRxReplyVer14(
                    xid,
                      status,
                      portNo,
                      slotNum
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnPduRxReplyVer14);
            return bsnPduRxReplyVer14;
        }
    }
    ...
    final static OFBsnPduRxReplyVer14Funnel FUNNEL = new OFBsnPduRxReplyVer14Funnel();
    static class OFBsnPduRxReplyVer14Funnel implements Funnel<OFBsnPduRxReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnPduRxReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnPduRxReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnPduRxReplyVer14 message) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnPduRxReplyVer14(");
