...
public class OFBsnVportQInQUntaggedSerializerVer14 {
    ...
    public static OFBsnVportQInQUntagged ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnVportQInQUntagged in version 1.4: " + val);
        }
    }
    ...
    public static short toWireValue(OFBsnVportQInQUntagged e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnVportQInQUntagged in version 1.4: " + e);
        }
    }
