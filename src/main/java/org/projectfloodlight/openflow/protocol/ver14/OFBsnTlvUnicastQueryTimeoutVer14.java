...
class OFBsnTlvUnicastQueryTimeoutVer14 implements OFBsnTlvUnicastQueryTimeout {
...
//
    ...
    final static OFBsnTlvUnicastQueryTimeoutVer14 DEFAULT = new OFBsnTlvUnicastQueryTimeoutVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvUnicastQueryTimeout> {
        ...
        public OFBsnTlvUnicastQueryTimeout readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnTlvUnicastQueryTimeoutVer14 bsnTlvUnicastQueryTimeoutVer14 = new OFBsnTlvUnicastQueryTimeoutVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvUnicastQueryTimeoutVer14);
    ...
    final static OFBsnTlvUnicastQueryTimeoutVer14Funnel FUNNEL = new OFBsnTlvUnicastQueryTimeoutVer14Funnel();
    static class OFBsnTlvUnicastQueryTimeoutVer14Funnel implements Funnel<OFBsnTlvUnicastQueryTimeoutVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvUnicastQueryTimeoutVer14> {
        @Override
