...
public class OFErrorTypeSerializerVer14 {
    ...
    public final static short BAD_PROPERTY_VAL = (short) 0xe;
    public final static short ASYNC_CONFIG_FAILED_VAL = (short) 0xf;
    public final static short FLOW_MONITOR_FAILED_VAL = (short) 0x10;
    public final static short BUNDLE_FAILED_VAL = (short) 0x11;
    ...
    public static OFErrorType ofWireValue(short val) {
        switch(val) {
            ...
            case BAD_PROPERTY_VAL:
                return OFErrorType.BAD_PROPERTY;
            case ASYNC_CONFIG_FAILED_VAL:
                return OFErrorType.ASYNC_CONFIG_FAILED;
            case FLOW_MONITOR_FAILED_VAL:
                return OFErrorType.FLOW_MONITOR_FAILED;
            case BUNDLE_FAILED_VAL:
                return OFErrorType.BUNDLE_FAILED;
            case EXPERIMENTER_VAL:
                return OFErrorType.EXPERIMENTER;
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFErrorType in version 1.4: " + val);
        }
    }
    ...
    public static short toWireValue(OFErrorType e) {
        switch(e) {
            ...
            case BAD_PROPERTY:
                return BAD_PROPERTY_VAL;
            case ASYNC_CONFIG_FAILED:
                return ASYNC_CONFIG_FAILED_VAL;
            case FLOW_MONITOR_FAILED:
                return FLOW_MONITOR_FAILED_VAL;
            case BUNDLE_FAILED:
                return BUNDLE_FAILED_VAL;
            case EXPERIMENTER:
                return EXPERIMENTER_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFErrorType in version 1.4: " + e);
        }
    }
