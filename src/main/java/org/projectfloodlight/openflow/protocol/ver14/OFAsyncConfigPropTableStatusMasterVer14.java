...
class OFAsyncConfigPropTableStatusMasterVer14 implements OFAsyncConfigPropTableStatusMaster {
...
//
    ...
    final static OFAsyncConfigPropTableStatusMasterVer14 DEFAULT = new OFAsyncConfigPropTableStatusMasterVer14(
        DEFAULT_MASK
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFAsyncConfigPropTableStatusMaster> {
        @Override
        public OFAsyncConfigPropTableStatusMaster readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFAsyncConfigPropTableStatusMasterVer14 asyncConfigPropTableStatusMasterVer14 = new OFAsyncConfigPropTableStatusMasterVer14(
                    mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", asyncConfigPropTableStatusMasterVer14);
    ...
    final static OFAsyncConfigPropTableStatusMasterVer14Funnel FUNNEL = new OFAsyncConfigPropTableStatusMasterVer14Funnel();
    static class OFAsyncConfigPropTableStatusMasterVer14Funnel implements Funnel<OFAsyncConfigPropTableStatusMasterVer14> {
    ...
    static class Writer implements OFMessageWriter<OFAsyncConfigPropTableStatusMasterVer14> {
        @Override
        public void write(ChannelBuffer bb, OFAsyncConfigPropTableStatusMasterVer14 message) {
            // fixed value property type = 0x9
