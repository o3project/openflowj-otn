...
abstract class OFFlowModVer14 {
    ...
    public final static OFFlowModVer14.Reader READER = new Reader();
    ...
    static class Reader implements OFMessageReader<OFFlowMod> {
        ...
        public OFFlowMod readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            switch(command) {
               case (short) 0x0:
                   // discriminator value OFFlowModCommand.ADD=0 for class OFFlowAddVer14
                   return OFFlowAddVer14.READER.readFrom(bb);
               case (short) 0x3:
                   // discriminator value OFFlowModCommand.DELETE=3 for class OFFlowDeleteVer14
                   return OFFlowDeleteVer14.READER.readFrom(bb);
               case (short) 0x4:
                   // discriminator value OFFlowModCommand.DELETE_STRICT=4 for class OFFlowDeleteStrictVer14
                   return OFFlowDeleteStrictVer14.READER.readFrom(bb);
               case (short) 0x1:
                   // discriminator value OFFlowModCommand.MODIFY=1 for class OFFlowModifyVer14
                   return OFFlowModifyVer14.READER.readFrom(bb);
               case (short) 0x2:
                   // discriminator value OFFlowModCommand.MODIFY_STRICT=2 for class OFFlowModifyStrictVer14
