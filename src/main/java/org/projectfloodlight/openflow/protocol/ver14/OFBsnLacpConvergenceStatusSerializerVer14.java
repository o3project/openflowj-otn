...
public class OFBsnLacpConvergenceStatusSerializerVer14 {
    ...
    public static OFBsnLacpConvergenceStatus ofWireValue(byte val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnLacpConvergenceStatus in version 1.4: " + val);
        }
    }
    ...
    public static byte toWireValue(OFBsnLacpConvergenceStatus e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnLacpConvergenceStatus in version 1.4: " + e);
        }
    }
