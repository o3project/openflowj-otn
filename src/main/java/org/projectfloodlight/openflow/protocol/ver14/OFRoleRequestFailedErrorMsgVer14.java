...
class OFRoleRequestFailedErrorMsgVer14 implements OFRoleRequestFailedErrorMsg {
    private static final Logger logger = LoggerFactory.getLogger(OFRoleRequestFailedErrorMsgVer14.class);
    // version: 1.4
...
//
    ...
    OFRoleRequestFailedErrorMsgVer14(long xid, OFRoleRequestFailedCode code, OFErrorCauseData data) {
        if(code == null) {
            throw new NullPointerException("OFRoleRequestFailedErrorMsgVer14: property code cannot be null");
        }
        if(data == null) {
    ...
    static class BuilderWithParent implements OFRoleRequestFailedErrorMsg.Builder {
        final OFRoleRequestFailedErrorMsgVer14 parentMessage;
        ...
        BuilderWithParent(OFRoleRequestFailedErrorMsgVer14 parentMessage) {
    ...
    public OFRoleRequestFailedErrorMsg.Builder setData(OFErrorCauseData data) {
        ...
        public OFRoleRequestFailedErrorMsg build() {
                ...
                //
                return new OFRoleRequestFailedErrorMsgVer14(
                    xid,
                    code,
                    data
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFRoleRequestFailedErrorMsg> {
        ...
        public OFRoleRequestFailedErrorMsg readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFRoleRequestFailedCode code = OFRoleRequestFailedCodeSerializerVer14.readFrom(bb);
            OFErrorCauseData data = OFErrorCauseData.read(bb, length - (bb.readerIndex() - start), OFVersion.OF_14);

            OFRoleRequestFailedErrorMsgVer14 roleRequestFailedErrorMsgVer14 = new OFRoleRequestFailedErrorMsgVer14(
                    xid,
                      code,
                      data
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", roleRequestFailedErrorMsgVer14);
            return roleRequestFailedErrorMsgVer14;
        }
    }
    ...
    final static OFRoleRequestFailedErrorMsgVer14Funnel FUNNEL = new OFRoleRequestFailedErrorMsgVer14Funnel();
    static class OFRoleRequestFailedErrorMsgVer14Funnel implements Funnel<OFRoleRequestFailedErrorMsgVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFRoleRequestFailedErrorMsgVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
            ...
            OFRoleRequestFailedCodeSerializerVer14.putTo(message.code, sink);
    ...
    static class Writer implements OFMessageWriter<OFRoleRequestFailedErrorMsgVer14> {
        @Override
        public void write(ChannelBuffer bb, OFRoleRequestFailedErrorMsgVer14 message) {
            ...
            OFRoleRequestFailedCodeSerializerVer14.writeTo(bb, message.code);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFRoleRequestFailedErrorMsgVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFRoleRequestFailedErrorMsgVer14 other = (OFRoleRequestFailedErrorMsgVer14) obj;
