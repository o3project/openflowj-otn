...
class OFOxmArpOpMaskedVer14 implements OFOxmArpOpMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmArpOpMaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmArpOpMaskedVer14 DEFAULT = new OFOxmArpOpMaskedVer14(
    ...
    static class BuilderWithParent implements OFOxmArpOpMasked.Builder {
        final OFOxmArpOpMaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmArpOpMaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmArpOpMasked> {
        ...
        public OFOxmArpOpMasked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmArpOpMaskedVer14 oxmArpOpMaskedVer14 = new OFOxmArpOpMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmArpOpMaskedVer14);
            return oxmArpOpMaskedVer14;
        }
    }
    ...
    final static OFOxmArpOpMaskedVer14Funnel FUNNEL = new OFOxmArpOpMaskedVer14Funnel();
    static class OFOxmArpOpMaskedVer14Funnel implements Funnel<OFOxmArpOpMaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmArpOpMaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80002b04L
    ...
    static class Writer implements OFMessageWriter<OFOxmArpOpMaskedVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmArpOpMaskedVer14 message) {
            // fixed value property typeLen = 0x80002b04L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmArpOpMaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmArpOpMaskedVer14 other = (OFOxmArpOpMaskedVer14) obj;
