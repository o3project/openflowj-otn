...
class OFEchoReplyVer14 implements OFEchoReply {
    private static final Logger logger = LoggerFactory.getLogger(OFEchoReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFEchoReplyVer14 DEFAULT = new OFEchoReplyVer14(
        DEFAULT_XID, DEFAULT_DATA
    );

    // package private constructor - used by readers, builders, and factory
    OFEchoReplyVer14(long xid, byte[] data) {
        if(data == null) {
    ...
    static class BuilderWithParent implements OFEchoReply.Builder {
        final OFEchoReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFEchoReplyVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFEchoReply> {
        ...
        public OFEchoReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFEchoReplyVer14 echoReplyVer14 = new OFEchoReplyVer14(
                    xid,
                      data
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", echoReplyVer14);
            return echoReplyVer14;
        }
    }
    ...
    final static OFEchoReplyVer14Funnel FUNNEL = new OFEchoReplyVer14Funnel();
    static class OFEchoReplyVer14Funnel implements Funnel<OFEchoReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFEchoReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFEchoReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFEchoReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFEchoReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFEchoReplyVer14 other = (OFEchoReplyVer14) obj;
