...
class OFBsnTlvIdleTimeVer14 implements OFBsnTlvIdleTime {
...
//
    ...
    final static OFBsnTlvIdleTimeVer14 DEFAULT = new OFBsnTlvIdleTimeVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvIdleTime> {
        ...
        public OFBsnTlvIdleTime readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnTlvIdleTimeVer14 bsnTlvIdleTimeVer14 = new OFBsnTlvIdleTimeVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvIdleTimeVer14);
    ...
    final static OFBsnTlvIdleTimeVer14Funnel FUNNEL = new OFBsnTlvIdleTimeVer14Funnel();
    static class OFBsnTlvIdleTimeVer14Funnel implements Funnel<OFBsnTlvIdleTimeVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvIdleTimeVer14> {
        @Override
