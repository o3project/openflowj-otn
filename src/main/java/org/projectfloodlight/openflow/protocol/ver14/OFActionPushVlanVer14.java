...
class OFActionPushVlanVer14 implements OFActionPushVlan {
    private static final Logger logger = LoggerFactory.getLogger(OFActionPushVlanVer14.class);
    // version: 1.4
...
//
    ...
    final static OFActionPushVlanVer14 DEFAULT = new OFActionPushVlanVer14(
        DEFAULT_ETHERTYPE
    );

    // package private constructor - used by readers, builders, and factory
    OFActionPushVlanVer14(EthType ethertype) {
        if(ethertype == null) {
            throw new NullPointerException("OFActionPushVlanVer14: property ethertype cannot be null");
        }
    ...
    static class BuilderWithParent implements OFActionPushVlan.Builder {
        final OFActionPushVlanVer14 parentMessage;

        // OF message fields
        private boolean ethertypeSet;
        private EthType ethertype;

        BuilderWithParent(OFActionPushVlanVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFActionPushVlan> {
        ...
        public OFActionPushVlan readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFActionPushVlanVer14 actionPushVlanVer14 = new OFActionPushVlanVer14(
                    ethertype
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionPushVlanVer14);
            return actionPushVlanVer14;
        }
    }
    ...
    final static OFActionPushVlanVer14Funnel FUNNEL = new OFActionPushVlanVer14Funnel();
    static class OFActionPushVlanVer14Funnel implements Funnel<OFActionPushVlanVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFActionPushVlanVer14 message, PrimitiveSink sink) {
            // fixed value property type = 17
    ...
    static class Writer implements OFMessageWriter<OFActionPushVlanVer14> {
        @Override
        public void write(ChannelBuffer bb, OFActionPushVlanVer14 message) {
            // fixed value property type = 17
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFActionPushVlanVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFActionPushVlanVer14 other = (OFActionPushVlanVer14) obj;
