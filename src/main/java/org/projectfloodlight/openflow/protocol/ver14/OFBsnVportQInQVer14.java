...
class OFBsnVportQInQVer14 implements OFBsnVportQInQ {
...
//
    ...
    final static OFBsnVportQInQVer14 DEFAULT = new OFBsnVportQInQVer14(
    ...
    OFBsnVportQInQVer14(long portNo, int ingressTpid, int ingressVlanId, int egressTpid, int egressVlanId, String ifName) {
        if(ifName == null) {
    ...
    static class BuilderWithParent implements OFBsnVportQInQ.Builder {
        ...
        BuilderWithParent(OFBsnVportQInQVer14 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFBsnVportQInQ build() {
                ...
                //
                return new OFBsnVportQInQVer14(
                    portNo,
                    ingressTpid,
                    ingressVlanId,
                    egressTpid,
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnVportQInQ> {
        ...
        public OFBsnVportQInQ readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnVportQInQVer14 bsnVportQInQVer14 = new OFBsnVportQInQVer14(
                    portNo,
                      ingressTpid,
                      ingressVlanId,
                      egressTpid,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnVportQInQVer14);
            return bsnVportQInQVer14;
        }
    }
    ...
    final static OFBsnVportQInQVer14Funnel FUNNEL = new OFBsnVportQInQVer14Funnel();
    static class OFBsnVportQInQVer14Funnel implements Funnel<OFBsnVportQInQVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnVportQInQVer14 message, PrimitiveSink sink) {
            // fixed value property type = 0x0
    ...
    static class Writer implements OFMessageWriter<OFBsnVportQInQVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnVportQInQVer14 message) {
            // fixed value property type = 0x0
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnVportQInQVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnVportQInQVer14 other = (OFBsnVportQInQVer14) obj;
