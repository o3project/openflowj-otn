...
class OFBarrierReplyVer14 implements OFBarrierReply {
...
//
    ...
    final static OFBarrierReplyVer14 DEFAULT = new OFBarrierReplyVer14(
        DEFAULT_XID
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBarrierReply> {
        ...
        public OFBarrierReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBarrierReplyVer14 barrierReplyVer14 = new OFBarrierReplyVer14(
                    xid
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", barrierReplyVer14);
    ...
    final static OFBarrierReplyVer14Funnel FUNNEL = new OFBarrierReplyVer14Funnel();
    static class OFBarrierReplyVer14Funnel implements Funnel<OFBarrierReplyVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBarrierReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBarrierReplyVer14 message) {
            // fixed value property version = 5
