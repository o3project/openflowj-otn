...
class OFFlowRemovedVer14 implements OFFlowRemoved {
    private static final Logger logger = LoggerFactory.getLogger(OFFlowRemovedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFFlowRemovedVer14 DEFAULT = new OFFlowRemovedVer14(
    ...
    OFFlowRemovedVer14(long xid, U64 cookie, int priority, short reason, TableId tableId, long durationSec, long durationNsec, int idleTimeout, int hardTimeout, U64 packetCount, U64 byteCount, Match match) {
        if(cookie == null) {
            throw new NullPointerException("OFFlowRemovedVer14: property cookie cannot be null");
        }
        if(tableId == null) {
            throw new NullPointerException("OFFlowRemovedVer14: property tableId cannot be null");
        }
        if(packetCount == null) {
            throw new NullPointerException("OFFlowRemovedVer14: property packetCount cannot be null");
        }
        if(byteCount == null) {
            throw new NullPointerException("OFFlowRemovedVer14: property byteCount cannot be null");
        }
        if(match == null) {
            throw new NullPointerException("OFFlowRemovedVer14: property match cannot be null");
        }
        this.xid = xid;
        this.cookie = cookie;
    ...
    static class BuilderWithParent implements OFFlowRemoved.Builder {
        final OFFlowRemovedVer14 parentMessage;
        ...
        BuilderWithParent(OFFlowRemovedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFFlowRemoved> {
        ...
        public OFFlowRemoved readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFFlowRemovedVer14 flowRemovedVer14 = new OFFlowRemovedVer14(
                    xid,
                      cookie,
                      priority,
                      reason,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", flowRemovedVer14);
            return flowRemovedVer14;
        }
    }
    ...
    final static OFFlowRemovedVer14Funnel FUNNEL = new OFFlowRemovedVer14Funnel();
    static class OFFlowRemovedVer14Funnel implements Funnel<OFFlowRemovedVer14> {
    ...
    static class Writer implements OFMessageWriter<OFFlowRemovedVer14> {
        @Override
        public void write(ChannelBuffer bb, OFFlowRemovedVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFFlowRemovedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFFlowRemovedVer14 other = (OFFlowRemovedVer14) obj;
