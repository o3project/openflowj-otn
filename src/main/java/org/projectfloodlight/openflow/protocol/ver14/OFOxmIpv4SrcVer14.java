...
class OFOxmIpv4SrcVer14 implements OFOxmIpv4Src {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpv4SrcVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmIpv4SrcVer14 DEFAULT = new OFOxmIpv4SrcVer14(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpv4SrcVer14(IPv4Address value) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpv4SrcVer14: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmIpv4Src.Builder {
        final OFOxmIpv4SrcVer14 parentMessage;

        // OF message fields
        private boolean valueSet;
        private IPv4Address value;

        BuilderWithParent(OFOxmIpv4SrcVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpv4Src> {
        ...
        public OFOxmIpv4Src readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmIpv4SrcVer14 oxmIpv4SrcVer14 = new OFOxmIpv4SrcVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv4SrcVer14);
            return oxmIpv4SrcVer14;
        }
    }
    ...
    final static OFOxmIpv4SrcVer14Funnel FUNNEL = new OFOxmIpv4SrcVer14Funnel();
    static class OFOxmIpv4SrcVer14Funnel implements Funnel<OFOxmIpv4SrcVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpv4SrcVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80001604L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv4SrcVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmIpv4SrcVer14 message) {
            // fixed value property typeLen = 0x80001604L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpv4SrcVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpv4SrcVer14 other = (OFOxmIpv4SrcVer14) obj;
