...
class OFBsnGentableStatsReplyVer14 implements OFBsnGentableStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnGentableStatsReplyVer14 DEFAULT = new OFBsnGentableStatsReplyVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnGentableStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnGentableStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnGentableStatsReplyVer14: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFBsnGentableStatsReplyVer14: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFBsnGentableStatsReply.Builder {
        final OFBsnGentableStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableStatsReplyVer14 parentMessage) {
    ...
    public OFBsnGentableStatsReply.Builder setEntries(List<OFBsnGentableStatsEntry> entries) {
        ...
        public OFBsnGentableStatsReply build() {
                ...
                //
                return new OFBsnGentableStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableStatsReply> {
        ...
        public OFBsnGentableStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            List<OFBsnGentableStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFBsnGentableStatsEntryVer14.READER);

            OFBsnGentableStatsReplyVer14 bsnGentableStatsReplyVer14 = new OFBsnGentableStatsReplyVer14(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableStatsReplyVer14);
            return bsnGentableStatsReplyVer14;
        }
    }
    ...
    final static OFBsnGentableStatsReplyVer14Funnel FUNNEL = new OFBsnGentableStatsReplyVer14Funnel();
    static class OFBsnGentableStatsReplyVer14Funnel implements Funnel<OFBsnGentableStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnGentableStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableStatsReplyVer14 other = (OFBsnGentableStatsReplyVer14) obj;
