...
class OFBsnTlvSamplingRateVer14 implements OFBsnTlvSamplingRate {
...
//
    ...
    final static OFBsnTlvSamplingRateVer14 DEFAULT = new OFBsnTlvSamplingRateVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvSamplingRate> {
        ...
        public OFBsnTlvSamplingRate readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnTlvSamplingRateVer14 bsnTlvSamplingRateVer14 = new OFBsnTlvSamplingRateVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvSamplingRateVer14);
    ...
    final static OFBsnTlvSamplingRateVer14Funnel FUNNEL = new OFBsnTlvSamplingRateVer14Funnel();
    static class OFBsnTlvSamplingRateVer14Funnel implements Funnel<OFBsnTlvSamplingRateVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvSamplingRateVer14> {
        @Override
