...
class OFFlowModifyStrictVer14 implements OFFlowModifyStrict {
    private static final Logger logger = LoggerFactory.getLogger(OFFlowModifyStrictVer14.class);
    // version: 1.4
...
//
    ...
    final static OFFlowModifyStrictVer14 DEFAULT = new OFFlowModifyStrictVer14(
    ...
    OFFlowModifyStrictVer14(long xid, U64 cookie, U64 cookieMask, TableId tableId, int idleTimeout, int hardTimeout, int priority, OFBufferId bufferId, OFPort outPort, OFGroup outGroup, Set<OFFlowModFlags> flags, int importance, Match match, List<OFInstruction> instructions) {
        if(cookie == null) {
            throw new NullPointerException("OFFlowModifyStrictVer14: property cookie cannot be null");
        }
        if(cookieMask == null) {
            throw new NullPointerException("OFFlowModifyStrictVer14: property cookieMask cannot be null");
        }
        if(tableId == null) {
            throw new NullPointerException("OFFlowModifyStrictVer14: property tableId cannot be null");
        }
        if(bufferId == null) {
            throw new NullPointerException("OFFlowModifyStrictVer14: property bufferId cannot be null");
        }
        if(outPort == null) {
            throw new NullPointerException("OFFlowModifyStrictVer14: property outPort cannot be null");
        }
        if(outGroup == null) {
            throw new NullPointerException("OFFlowModifyStrictVer14: property outGroup cannot be null");
        }
        if(flags == null) {
            throw new NullPointerException("OFFlowModifyStrictVer14: property flags cannot be null");
        }
        if(match == null) {
            throw new NullPointerException("OFFlowModifyStrictVer14: property match cannot be null");
        }
        if(instructions == null) {
            throw new NullPointerException("OFFlowModifyStrictVer14: property instructions cannot be null");
        }
        this.xid = xid;
        this.cookie = cookie;
    ...
    static class BuilderWithParent implements OFFlowModifyStrict.Builder {
        final OFFlowModifyStrictVer14 parentMessage;
        ...
        BuilderWithParent(OFFlowModifyStrictVer14 parentMessage) {
    ...
    public OFFlowModifyStrict.Builder setImportance(int importance) {
        ...
        public OFFlowModifyStrict build() {
                ...
                //
                return new OFFlowModifyStrictVer14(
                    xid,
                    cookie,
                    cookieMask,
                    tableId,
...
//
    ...
    static class Reader implements OFMessageReader<OFFlowModifyStrict> {
        ...
        public OFFlowModifyStrict readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFFlowModifyStrictVer14 flowModifyStrictVer14 = new OFFlowModifyStrictVer14(
                    xid,
                      cookie,
                      cookieMask,
                      tableId,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", flowModifyStrictVer14);
            return flowModifyStrictVer14;
        }
    }
    ...
    final static OFFlowModifyStrictVer14Funnel FUNNEL = new OFFlowModifyStrictVer14Funnel();
    static class OFFlowModifyStrictVer14Funnel implements Funnel<OFFlowModifyStrictVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFFlowModifyStrictVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFFlowModifyStrictVer14> {
        @Override
        public void write(ChannelBuffer bb, OFFlowModifyStrictVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFFlowModifyStrictVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFFlowModifyStrictVer14 other = (OFFlowModifyStrictVer14) obj;
