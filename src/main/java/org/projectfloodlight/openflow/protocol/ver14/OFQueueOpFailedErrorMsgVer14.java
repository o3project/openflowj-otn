...
class OFQueueOpFailedErrorMsgVer14 implements OFQueueOpFailedErrorMsg {
    private static final Logger logger = LoggerFactory.getLogger(OFQueueOpFailedErrorMsgVer14.class);
    // version: 1.4
...
//
    ...
    OFQueueOpFailedErrorMsgVer14(long xid, OFQueueOpFailedCode code, OFErrorCauseData data) {
        if(code == null) {
            throw new NullPointerException("OFQueueOpFailedErrorMsgVer14: property code cannot be null");
        }
        if(data == null) {
    ...
    static class BuilderWithParent implements OFQueueOpFailedErrorMsg.Builder {
        final OFQueueOpFailedErrorMsgVer14 parentMessage;
        ...
        BuilderWithParent(OFQueueOpFailedErrorMsgVer14 parentMessage) {
    ...
    public OFQueueOpFailedErrorMsg.Builder setData(OFErrorCauseData data) {
        ...
        public OFQueueOpFailedErrorMsg build() {
                ...
                //
                return new OFQueueOpFailedErrorMsgVer14(
                    xid,
                    code,
                    data
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFQueueOpFailedErrorMsg> {
        ...
        public OFQueueOpFailedErrorMsg readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", queueOpFailedErrorMsgVer14);
            return queueOpFailedErrorMsgVer14;
        }
    }
    ...
    final static OFQueueOpFailedErrorMsgVer14Funnel FUNNEL = new OFQueueOpFailedErrorMsgVer14Funnel();
    static class OFQueueOpFailedErrorMsgVer14Funnel implements Funnel<OFQueueOpFailedErrorMsgVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFQueueOpFailedErrorMsgVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
            ...
            OFQueueOpFailedCodeSerializerVer14.putTo(message.code, sink);
    ...
    static class Writer implements OFMessageWriter<OFQueueOpFailedErrorMsgVer14> {
        @Override
        public void write(ChannelBuffer bb, OFQueueOpFailedErrorMsgVer14 message) {
            ...
            OFQueueOpFailedCodeSerializerVer14.writeTo(bb, message.code);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFQueueOpFailedErrorMsgVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFQueueOpFailedErrorMsgVer14 other = (OFQueueOpFailedErrorMsgVer14) obj;
