...
class OFActionSetQueueVer14 implements OFActionSetQueue {
...
//
    ...
    final static OFActionSetQueueVer14 DEFAULT = new OFActionSetQueueVer14(
        DEFAULT_QUEUE_ID
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFActionSetQueue> {
        ...
        public OFActionSetQueue readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFActionSetQueueVer14 actionSetQueueVer14 = new OFActionSetQueueVer14(
                    queueId
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionSetQueueVer14);
    ...
    final static OFActionSetQueueVer14Funnel FUNNEL = new OFActionSetQueueVer14Funnel();
    static class OFActionSetQueueVer14Funnel implements Funnel<OFActionSetQueueVer14> {
    ...
    static class Writer implements OFMessageWriter<OFActionSetQueueVer14> {
        @Override
        public void write(ChannelBuffer bb, OFActionSetQueueVer14 message) {
            // fixed value property type = 21
