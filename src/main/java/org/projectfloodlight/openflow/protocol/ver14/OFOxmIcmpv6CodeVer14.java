...
class OFOxmIcmpv6CodeVer14 implements OFOxmIcmpv6Code {
...
//
    ...
    final static OFOxmIcmpv6CodeVer14 DEFAULT = new OFOxmIcmpv6CodeVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIcmpv6Code> {
        ...
        public OFOxmIcmpv6Code readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmIcmpv6CodeVer14 oxmIcmpv6CodeVer14 = new OFOxmIcmpv6CodeVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIcmpv6CodeVer14);
    ...
    final static OFOxmIcmpv6CodeVer14Funnel FUNNEL = new OFOxmIcmpv6CodeVer14Funnel();
    static class OFOxmIcmpv6CodeVer14Funnel implements Funnel<OFOxmIcmpv6CodeVer14> {
    ...
    static class Writer implements OFMessageWriter<OFOxmIcmpv6CodeVer14> {
        @Override
