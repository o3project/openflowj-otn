...
class OFTableStatsEntryVer14 implements OFTableStatsEntry {
    private static final Logger logger = LoggerFactory.getLogger(OFTableStatsEntryVer14.class);
    // version: 1.4
...
//
    ...
    final static OFTableStatsEntryVer14 DEFAULT = new OFTableStatsEntryVer14(
    ...
    static class BuilderWithParent implements OFTableStatsEntry.Builder {
        final OFTableStatsEntryVer14 parentMessage;
        ...
        BuilderWithParent(OFTableStatsEntryVer14 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFTableStatsEntry build() {
                ...
                //
                return new OFTableStatsEntryVer14(
                    tableId,
                    activeCount,
                    lookupCount,
                    matchedCount
...
//
    ...
    static class Reader implements OFMessageReader<OFTableStatsEntry> {
        ...
        public OFTableStatsEntry readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFTableStatsEntryVer14 tableStatsEntryVer14 = new OFTableStatsEntryVer14(
                    tableId,
                      activeCount,
                      lookupCount,
                      matchedCount
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", tableStatsEntryVer14);
            return tableStatsEntryVer14;
        }
    }
    ...
    final static OFTableStatsEntryVer14Funnel FUNNEL = new OFTableStatsEntryVer14Funnel();
    static class OFTableStatsEntryVer14Funnel implements Funnel<OFTableStatsEntryVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFTableStatsEntryVer14 message, PrimitiveSink sink) {
    ...
    static class Writer implements OFMessageWriter<OFTableStatsEntryVer14> {
        @Override
        public void write(ChannelBuffer bb, OFTableStatsEntryVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFTableStatsEntryVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFTableStatsEntryVer14 other = (OFTableStatsEntryVer14) obj;
