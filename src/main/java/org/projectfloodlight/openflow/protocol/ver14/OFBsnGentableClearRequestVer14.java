...
class OFBsnGentableClearRequestVer14 implements OFBsnGentableClearRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableClearRequestVer14.class);
    // version: 1.4
...
//
    ...
    static class BuilderWithParent implements OFBsnGentableClearRequest.Builder {
        final OFBsnGentableClearRequestVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableClearRequestVer14 parentMessage) {
    ...
    public OFBsnGentableClearRequest.Builder setChecksumMask(U128 checksumMask) {
        ...
        public OFBsnGentableClearRequest build() {
                ...
                //
                return new OFBsnGentableClearRequestVer14(
                    xid,
                    tableId,
                    checksum,
                    checksumMask
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableClearRequest> {
        ...
        public OFBsnGentableClearRequest readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnGentableClearRequestVer14 bsnGentableClearRequestVer14 = new OFBsnGentableClearRequestVer14(
                    xid,
                      tableId,
                      checksum,
                      checksumMask
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableClearRequestVer14);
            return bsnGentableClearRequestVer14;
        }
    }
    ...
    final static OFBsnGentableClearRequestVer14Funnel FUNNEL = new OFBsnGentableClearRequestVer14Funnel();
    static class OFBsnGentableClearRequestVer14Funnel implements Funnel<OFBsnGentableClearRequestVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableClearRequestVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableClearRequestVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnGentableClearRequestVer14 message) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableClearRequestVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableClearRequestVer14 other = (OFBsnGentableClearRequestVer14) obj;
