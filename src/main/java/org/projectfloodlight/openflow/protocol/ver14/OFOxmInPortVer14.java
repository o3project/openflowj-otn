...
class OFOxmInPortVer14 implements OFOxmInPort {
...
//
    ...
    final static OFOxmInPortVer14 DEFAULT = new OFOxmInPortVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmInPort> {
        ...
        public OFOxmInPort readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmInPortVer14 oxmInPortVer14 = new OFOxmInPortVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmInPortVer14);
    ...
    final static OFOxmInPortVer14Funnel FUNNEL = new OFOxmInPortVer14Funnel();
    static class OFOxmInPortVer14Funnel implements Funnel<OFOxmInPortVer14> {
    ...
    static class Writer implements OFMessageWriter<OFOxmInPortVer14> {
        @Override
