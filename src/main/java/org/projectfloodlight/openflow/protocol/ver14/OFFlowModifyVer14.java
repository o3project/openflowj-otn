...
class OFFlowModifyVer14 implements OFFlowModify {
    private static final Logger logger = LoggerFactory.getLogger(OFFlowModifyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFFlowModifyVer14 DEFAULT = new OFFlowModifyVer14(
    ...
    OFFlowModifyVer14(long xid, U64 cookie, U64 cookieMask, TableId tableId, int idleTimeout, int hardTimeout, int priority, OFBufferId bufferId, OFPort outPort, OFGroup outGroup, Set<OFFlowModFlags> flags, int importance, Match match, List<OFInstruction> instructions) {
        if(cookie == null) {
            throw new NullPointerException("OFFlowModifyVer14: property cookie cannot be null");
        }
        if(cookieMask == null) {
            throw new NullPointerException("OFFlowModifyVer14: property cookieMask cannot be null");
        }
        if(tableId == null) {
            throw new NullPointerException("OFFlowModifyVer14: property tableId cannot be null");
        }
        if(bufferId == null) {
            throw new NullPointerException("OFFlowModifyVer14: property bufferId cannot be null");
        }
        if(outPort == null) {
            throw new NullPointerException("OFFlowModifyVer14: property outPort cannot be null");
        }
        if(outGroup == null) {
            throw new NullPointerException("OFFlowModifyVer14: property outGroup cannot be null");
        }
        if(flags == null) {
            throw new NullPointerException("OFFlowModifyVer14: property flags cannot be null");
        }
        if(match == null) {
            throw new NullPointerException("OFFlowModifyVer14: property match cannot be null");
        }
        if(instructions == null) {
            throw new NullPointerException("OFFlowModifyVer14: property instructions cannot be null");
        }
        this.xid = xid;
        this.cookie = cookie;
    ...
    static class BuilderWithParent implements OFFlowModify.Builder {
        final OFFlowModifyVer14 parentMessage;
        ...
        BuilderWithParent(OFFlowModifyVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFFlowModify> {
        ...
        public OFFlowModify readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFFlowModifyVer14 flowModifyVer14 = new OFFlowModifyVer14(
                    xid,
                      cookie,
                      cookieMask,
                      tableId,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", flowModifyVer14);
            return flowModifyVer14;
        }
    }
    ...
    final static OFFlowModifyVer14Funnel FUNNEL = new OFFlowModifyVer14Funnel();
    static class OFFlowModifyVer14Funnel implements Funnel<OFFlowModifyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFFlowModifyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFFlowModifyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFFlowModifyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFFlowModifyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFFlowModifyVer14 other = (OFFlowModifyVer14) obj;
