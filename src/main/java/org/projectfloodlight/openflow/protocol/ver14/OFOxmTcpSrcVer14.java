...
class OFOxmTcpSrcVer14 implements OFOxmTcpSrc {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmTcpSrcVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmTcpSrcVer14 DEFAULT = new OFOxmTcpSrcVer14(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmTcpSrcVer14(TransportPort value) {
        if(value == null) {
            throw new NullPointerException("OFOxmTcpSrcVer14: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmTcpSrc.Builder {
        final OFOxmTcpSrcVer14 parentMessage;

        // OF message fields
        private boolean valueSet;
        private TransportPort value;

        BuilderWithParent(OFOxmTcpSrcVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmTcpSrc> {
        ...
        public OFOxmTcpSrc readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmTcpSrcVer14 oxmTcpSrcVer14 = new OFOxmTcpSrcVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmTcpSrcVer14);
            return oxmTcpSrcVer14;
        }
    }
    ...
    final static OFOxmTcpSrcVer14Funnel FUNNEL = new OFOxmTcpSrcVer14Funnel();
    static class OFOxmTcpSrcVer14Funnel implements Funnel<OFOxmTcpSrcVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmTcpSrcVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80001a02L
    ...
    static class Writer implements OFMessageWriter<OFOxmTcpSrcVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmTcpSrcVer14 message) {
            // fixed value property typeLen = 0x80001a02L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmTcpSrcVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmTcpSrcVer14 other = (OFOxmTcpSrcVer14) obj;
