...
class OFActionGroupVer14 implements OFActionGroup {
    private static final Logger logger = LoggerFactory.getLogger(OFActionGroupVer14.class);
    // version: 1.4
...
//
    ...
    final static OFActionGroupVer14 DEFAULT = new OFActionGroupVer14(
        DEFAULT_GROUP_ID
    );
    ...
    static class BuilderWithParent implements OFActionGroup.Builder {
        final OFActionGroupVer14 parentMessage;

        // OF message fields
        private boolean groupSet;
        private OFGroup group;

        BuilderWithParent(OFActionGroupVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFActionGroup> {
        ...
        public OFActionGroup readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFActionGroupVer14 actionGroupVer14 = new OFActionGroupVer14(
                    group
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionGroupVer14);
            return actionGroupVer14;
        }
    }
    ...
    final static OFActionGroupVer14Funnel FUNNEL = new OFActionGroupVer14Funnel();
    static class OFActionGroupVer14Funnel implements Funnel<OFActionGroupVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFActionGroupVer14 message, PrimitiveSink sink) {
            // fixed value property type = 22
    ...
    static class Writer implements OFMessageWriter<OFActionGroupVer14> {
        @Override
        public void write(ChannelBuffer bb, OFActionGroupVer14 message) {
            // fixed value property type = 22
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFActionGroupVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFActionGroupVer14 other = (OFActionGroupVer14) obj;
