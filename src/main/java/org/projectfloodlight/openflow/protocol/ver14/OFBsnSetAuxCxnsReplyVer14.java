...
class OFBsnSetAuxCxnsReplyVer14 implements OFBsnSetAuxCxnsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnSetAuxCxnsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnSetAuxCxnsReplyVer14 DEFAULT = new OFBsnSetAuxCxnsReplyVer14(
    ...
    static class BuilderWithParent implements OFBsnSetAuxCxnsReply.Builder {
        final OFBsnSetAuxCxnsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnSetAuxCxnsReplyVer14 parentMessage) {
    ...
    public OFBsnSetAuxCxnsReply.Builder setStatus(long status) {
        ...
        public OFBsnSetAuxCxnsReply build() {
                ...
                //
                return new OFBsnSetAuxCxnsReplyVer14(
                    xid,
                    numAux,
                    status
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnSetAuxCxnsReply> {
        ...
        public OFBsnSetAuxCxnsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnSetAuxCxnsReplyVer14 bsnSetAuxCxnsReplyVer14 = new OFBsnSetAuxCxnsReplyVer14(
                    xid,
                      numAux,
                      status
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnSetAuxCxnsReplyVer14);
            return bsnSetAuxCxnsReplyVer14;
        }
    }
    ...
    final static OFBsnSetAuxCxnsReplyVer14Funnel FUNNEL = new OFBsnSetAuxCxnsReplyVer14Funnel();
    static class OFBsnSetAuxCxnsReplyVer14Funnel implements Funnel<OFBsnSetAuxCxnsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnSetAuxCxnsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnSetAuxCxnsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnSetAuxCxnsReplyVer14 message) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnSetAuxCxnsReplyVer14(");
