...
class OFSwitchConfigFailedErrorMsgVer14 implements OFSwitchConfigFailedErrorMsg {
    private static final Logger logger = LoggerFactory.getLogger(OFSwitchConfigFailedErrorMsgVer14.class);
    // version: 1.4
...
//
    ...
    OFSwitchConfigFailedErrorMsgVer14(long xid, OFSwitchConfigFailedCode code, OFErrorCauseData data) {
        if(code == null) {
            throw new NullPointerException("OFSwitchConfigFailedErrorMsgVer14: property code cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFSwitchConfigFailedErrorMsgVer14: property data cannot be null");
        }
        this.xid = xid;
        this.code = code;
        this.data = data;
    ...
    static class BuilderWithParent implements OFSwitchConfigFailedErrorMsg.Builder {
        final OFSwitchConfigFailedErrorMsgVer14 parentMessage;
        ...
        BuilderWithParent(OFSwitchConfigFailedErrorMsgVer14 parentMessage) {
    ...
    public OFSwitchConfigFailedErrorMsg.Builder setData(OFErrorCauseData data) {
        ...
        public OFSwitchConfigFailedErrorMsg build() {
                ...
                //
                return new OFSwitchConfigFailedErrorMsgVer14(
                    xid,
                    code,
                    data
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFSwitchConfigFailedErrorMsg> {
        ...
        public OFSwitchConfigFailedErrorMsg readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFSwitchConfigFailedCode code = OFSwitchConfigFailedCodeSerializerVer14.readFrom(bb);
            OFErrorCauseData data = OFErrorCauseData.read(bb, length - (bb.readerIndex() - start), OFVersion.OF_14);

            OFSwitchConfigFailedErrorMsgVer14 switchConfigFailedErrorMsgVer14 = new OFSwitchConfigFailedErrorMsgVer14(
                    xid,
                      code,
                      data
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", switchConfigFailedErrorMsgVer14);
            return switchConfigFailedErrorMsgVer14;
        }
    }
    ...
    final static OFSwitchConfigFailedErrorMsgVer14Funnel FUNNEL = new OFSwitchConfigFailedErrorMsgVer14Funnel();
    static class OFSwitchConfigFailedErrorMsgVer14Funnel implements Funnel<OFSwitchConfigFailedErrorMsgVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFSwitchConfigFailedErrorMsgVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
            ...
            OFSwitchConfigFailedCodeSerializerVer14.putTo(message.code, sink);
    ...
    static class Writer implements OFMessageWriter<OFSwitchConfigFailedErrorMsgVer14> {
        @Override
        public void write(ChannelBuffer bb, OFSwitchConfigFailedErrorMsgVer14 message) {
            ...
            OFSwitchConfigFailedCodeSerializerVer14.writeTo(bb, message.code);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFSwitchConfigFailedErrorMsgVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFSwitchConfigFailedErrorMsgVer14 other = (OFSwitchConfigFailedErrorMsgVer14) obj;
