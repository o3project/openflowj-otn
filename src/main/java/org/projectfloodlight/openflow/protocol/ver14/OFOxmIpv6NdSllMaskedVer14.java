...
class OFOxmIpv6NdSllMaskedVer14 implements OFOxmIpv6NdSllMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpv6NdSllMaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmIpv6NdSllMaskedVer14 DEFAULT = new OFOxmIpv6NdSllMaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpv6NdSllMaskedVer14(MacAddress value, MacAddress mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpv6NdSllMaskedVer14: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmIpv6NdSllMaskedVer14: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    static class BuilderWithParent implements OFOxmIpv6NdSllMasked.Builder {
        final OFOxmIpv6NdSllMaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmIpv6NdSllMaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpv6NdSllMasked> {
        ...
        public OFOxmIpv6NdSllMasked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmIpv6NdSllMaskedVer14 oxmIpv6NdSllMaskedVer14 = new OFOxmIpv6NdSllMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv6NdSllMaskedVer14);
            return oxmIpv6NdSllMaskedVer14;
        }
    }
    ...
    final static OFOxmIpv6NdSllMaskedVer14Funnel FUNNEL = new OFOxmIpv6NdSllMaskedVer14Funnel();
    static class OFOxmIpv6NdSllMaskedVer14Funnel implements Funnel<OFOxmIpv6NdSllMaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpv6NdSllMaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x8000410cL
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv6NdSllMaskedVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmIpv6NdSllMaskedVer14 message) {
            // fixed value property typeLen = 0x8000410cL
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpv6NdSllMaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpv6NdSllMaskedVer14 other = (OFOxmIpv6NdSllMaskedVer14) obj;
