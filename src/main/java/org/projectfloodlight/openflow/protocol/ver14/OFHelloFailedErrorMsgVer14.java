...
class OFHelloFailedErrorMsgVer14 implements OFHelloFailedErrorMsg {
    private static final Logger logger = LoggerFactory.getLogger(OFHelloFailedErrorMsgVer14.class);
    // version: 1.4
...
//
    ...
    OFHelloFailedErrorMsgVer14(long xid, OFHelloFailedCode code, OFErrorCauseData data) {
        if(code == null) {
            throw new NullPointerException("OFHelloFailedErrorMsgVer14: property code cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFHelloFailedErrorMsgVer14: property data cannot be null");
        }
        this.xid = xid;
        this.code = code;
        this.data = data;
    ...
    static class BuilderWithParent implements OFHelloFailedErrorMsg.Builder {
        final OFHelloFailedErrorMsgVer14 parentMessage;
        ...
        BuilderWithParent(OFHelloFailedErrorMsgVer14 parentMessage) {
    ...
    public OFHelloFailedErrorMsg.Builder setData(OFErrorCauseData data) {
        ...
        public OFHelloFailedErrorMsg build() {
                ...
                //
                return new OFHelloFailedErrorMsgVer14(
                    xid,
                    code,
                    data
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFHelloFailedErrorMsg> {
        ...
        public OFHelloFailedErrorMsg readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFHelloFailedCode code = OFHelloFailedCodeSerializerVer14.readFrom(bb);
            OFErrorCauseData data = OFErrorCauseData.read(bb, length - (bb.readerIndex() - start), OFVersion.OF_14);

            OFHelloFailedErrorMsgVer14 helloFailedErrorMsgVer14 = new OFHelloFailedErrorMsgVer14(
                    xid,
                      code,
                      data
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", helloFailedErrorMsgVer14);
            return helloFailedErrorMsgVer14;
        }
    }
    ...
    final static OFHelloFailedErrorMsgVer14Funnel FUNNEL = new OFHelloFailedErrorMsgVer14Funnel();
    static class OFHelloFailedErrorMsgVer14Funnel implements Funnel<OFHelloFailedErrorMsgVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFHelloFailedErrorMsgVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
            ...
            OFHelloFailedCodeSerializerVer14.putTo(message.code, sink);
    ...
    static class Writer implements OFMessageWriter<OFHelloFailedErrorMsgVer14> {
        @Override
        public void write(ChannelBuffer bb, OFHelloFailedErrorMsgVer14 message) {
            ...
            OFHelloFailedCodeSerializerVer14.writeTo(bb, message.code);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFHelloFailedErrorMsgVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFHelloFailedErrorMsgVer14 other = (OFHelloFailedErrorMsgVer14) obj;
