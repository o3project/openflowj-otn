...
class OFBsnGentableEntryDeleteVer14 implements OFBsnGentableEntryDelete {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableEntryDeleteVer14.class);
    // version: 1.4
...
//
    ...
    OFBsnGentableEntryDeleteVer14(long xid, GenTableId tableId, List<OFBsnTlv> key) {
        if(tableId == null) {
            throw new NullPointerException("OFBsnGentableEntryDeleteVer14: property tableId cannot be null");
        }
        if(key == null) {
            throw new NullPointerException("OFBsnGentableEntryDeleteVer14: property key cannot be null");
        }
        this.xid = xid;
    ...
    static class BuilderWithParent implements OFBsnGentableEntryDelete.Builder {
        final OFBsnGentableEntryDeleteVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableEntryDeleteVer14 parentMessage) {
    ...
    public OFBsnGentableEntryDelete.Builder setKey(List<OFBsnTlv> key) {
        ...
        public OFBsnGentableEntryDelete build() {
                ...
                //
                return new OFBsnGentableEntryDeleteVer14(
                    xid,
                    tableId,
                    key
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableEntryDelete> {
        ...
        public OFBsnGentableEntryDelete readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnGentableEntryDeleteVer14 bsnGentableEntryDeleteVer14 = new OFBsnGentableEntryDeleteVer14(
                    xid,
                      tableId,
                      key
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableEntryDeleteVer14);
            return bsnGentableEntryDeleteVer14;
        }
    }
    ...
    final static OFBsnGentableEntryDeleteVer14Funnel FUNNEL = new OFBsnGentableEntryDeleteVer14Funnel();
    static class OFBsnGentableEntryDeleteVer14Funnel implements Funnel<OFBsnGentableEntryDeleteVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableEntryDeleteVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableEntryDeleteVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnGentableEntryDeleteVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableEntryDeleteVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableEntryDeleteVer14 other = (OFBsnGentableEntryDeleteVer14) obj;
