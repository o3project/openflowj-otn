...
class OFOxmBsnTcpFlagsMaskedVer14 implements OFOxmBsnTcpFlagsMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnTcpFlagsMaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmBsnTcpFlagsMaskedVer14 DEFAULT = new OFOxmBsnTcpFlagsMaskedVer14(
    ...
    public OFOxm<U16> getCanonical() {
        if (U16.NO_MASK.equals(mask)) {
            return new OFOxmBsnTcpFlagsVer14(value);
    ...
    static class BuilderWithParent implements OFOxmBsnTcpFlagsMasked.Builder {
        final OFOxmBsnTcpFlagsMaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmBsnTcpFlagsMaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnTcpFlagsMasked> {
        ...
        public OFOxmBsnTcpFlagsMasked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmBsnTcpFlagsMaskedVer14 oxmBsnTcpFlagsMaskedVer14 = new OFOxmBsnTcpFlagsMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnTcpFlagsMaskedVer14);
            return oxmBsnTcpFlagsMaskedVer14;
        }
    }
    ...
    final static OFOxmBsnTcpFlagsMaskedVer14Funnel FUNNEL = new OFOxmBsnTcpFlagsMaskedVer14Funnel();
    static class OFOxmBsnTcpFlagsMaskedVer14Funnel implements Funnel<OFOxmBsnTcpFlagsMaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnTcpFlagsMaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x32104L
            sink.putInt(0x32104);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnTcpFlagsMaskedVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmBsnTcpFlagsMaskedVer14 message) {
            // fixed value property typeLen = 0x32104L
            bb.writeInt(0x32104);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnTcpFlagsMaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnTcpFlagsMaskedVer14 other = (OFOxmBsnTcpFlagsMaskedVer14) obj;
