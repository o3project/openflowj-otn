...
class OFPacketInVer14 implements OFPacketIn {
    private static final Logger logger = LoggerFactory.getLogger(OFPacketInVer14.class);
    // version: 1.4
...
//
    ...
    OFPacketInVer14(long xid, OFBufferId bufferId, int totalLen, OFPacketInReason reason, TableId tableId, U64 cookie, Match match, byte[] data) {
        if(bufferId == null) {
            throw new NullPointerException("OFPacketInVer14: property bufferId cannot be null");
        }
        if(reason == null) {
            throw new NullPointerException("OFPacketInVer14: property reason cannot be null");
        }
        if(tableId == null) {
            throw new NullPointerException("OFPacketInVer14: property tableId cannot be null");
        }
        if(cookie == null) {
            throw new NullPointerException("OFPacketInVer14: property cookie cannot be null");
        }
        if(match == null) {
            throw new NullPointerException("OFPacketInVer14: property match cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFPacketInVer14: property data cannot be null");
        }
        this.xid = xid;
    ...
    static class BuilderWithParent implements OFPacketIn.Builder {
        final OFPacketInVer14 parentMessage;
        ...
        BuilderWithParent(OFPacketInVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFPacketIn> {
        ...
        public OFPacketIn readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFPacketInReason reason = OFPacketInReasonSerializerVer14.readFrom(bb);
            ...
            OFPacketInVer14 packetInVer14 = new OFPacketInVer14(
                    xid,
                      bufferId,
                      totalLen,
                      reason,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", packetInVer14);
            return packetInVer14;
        }
    }
    ...
    final static OFPacketInVer14Funnel FUNNEL = new OFPacketInVer14Funnel();
    static class OFPacketInVer14Funnel implements Funnel<OFPacketInVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFPacketInVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
            ...
            OFPacketInReasonSerializerVer14.putTo(message.reason, sink);
    ...
    static class Writer implements OFMessageWriter<OFPacketInVer14> {
        @Override
        public void write(ChannelBuffer bb, OFPacketInVer14 message) {
            ...
            OFPacketInReasonSerializerVer14.writeTo(bb, message.reason);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFPacketInVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFPacketInVer14 other = (OFPacketInVer14) obj;
