...
abstract class OFQueuePropExperimenterVer14 {
    // version: 1.4
    final static byte WIRE_VERSION = 5;
    final static int MINIMUM_LENGTH = 16;


    public final static OFQueuePropExperimenterVer14.Reader READER = new Reader();
    ...
    static class Reader implements OFMessageReader<OFQueuePropExperimenter> {
        ...
        public OFQueuePropExperimenter readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            switch(experimenter) {
               default:
                   throw new OFParseError("Unknown value for discriminator experimenter of class OFQueuePropExperimenterVer14: " + experimenter);
            }
        }
    }
}
