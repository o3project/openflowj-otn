...
class OFOxmIcmpv4CodeMaskedVer14 implements OFOxmIcmpv4CodeMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIcmpv4CodeMaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmIcmpv4CodeMaskedVer14 DEFAULT = new OFOxmIcmpv4CodeMaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIcmpv4CodeMaskedVer14(ICMPv4Code value, ICMPv4Code mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmIcmpv4CodeMaskedVer14: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmIcmpv4CodeMaskedVer14: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<ICMPv4Code> getCanonical() {
        if (ICMPv4Code.NO_MASK.equals(mask)) {
            return new OFOxmIcmpv4CodeVer14(value);
    ...
    static class BuilderWithParent implements OFOxmIcmpv4CodeMasked.Builder {
        final OFOxmIcmpv4CodeMaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmIcmpv4CodeMaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIcmpv4CodeMasked> {
        ...
        public OFOxmIcmpv4CodeMasked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmIcmpv4CodeMaskedVer14 oxmIcmpv4CodeMaskedVer14 = new OFOxmIcmpv4CodeMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIcmpv4CodeMaskedVer14);
            return oxmIcmpv4CodeMaskedVer14;
        }
    }
    ...
    final static OFOxmIcmpv4CodeMaskedVer14Funnel FUNNEL = new OFOxmIcmpv4CodeMaskedVer14Funnel();
    static class OFOxmIcmpv4CodeMaskedVer14Funnel implements Funnel<OFOxmIcmpv4CodeMaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIcmpv4CodeMaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80002902L
    ...
    static class Writer implements OFMessageWriter<OFOxmIcmpv4CodeMaskedVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmIcmpv4CodeMaskedVer14 message) {
            // fixed value property typeLen = 0x80002902L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIcmpv4CodeMaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIcmpv4CodeMaskedVer14 other = (OFOxmIcmpv4CodeMaskedVer14) obj;
