...
class OFOxmIpv6SrcVer14 implements OFOxmIpv6Src {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpv6SrcVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmIpv6SrcVer14 DEFAULT = new OFOxmIpv6SrcVer14(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpv6SrcVer14(IPv6Address value) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpv6SrcVer14: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmIpv6Src.Builder {
        final OFOxmIpv6SrcVer14 parentMessage;

        // OF message fields
        private boolean valueSet;
        private IPv6Address value;

        BuilderWithParent(OFOxmIpv6SrcVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpv6Src> {
        ...
        public OFOxmIpv6Src readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmIpv6SrcVer14 oxmIpv6SrcVer14 = new OFOxmIpv6SrcVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv6SrcVer14);
            return oxmIpv6SrcVer14;
        }
    }
    ...
    final static OFOxmIpv6SrcVer14Funnel FUNNEL = new OFOxmIpv6SrcVer14Funnel();
    static class OFOxmIpv6SrcVer14Funnel implements Funnel<OFOxmIpv6SrcVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpv6SrcVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80003410L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv6SrcVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmIpv6SrcVer14 message) {
            // fixed value property typeLen = 0x80003410L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpv6SrcVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpv6SrcVer14 other = (OFOxmIpv6SrcVer14) obj;
