...
class OFTableDescStatsReplyVer14 implements OFTableDescStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFTableDescStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFTableDescStatsReplyVer14 DEFAULT = new OFTableDescStatsReplyVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFTableDescStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, List<OFTableDesc> entries) {
        if(flags == null) {
            throw new NullPointerException("OFTableDescStatsReplyVer14: property flags cannot be null");
        }
        if(entries == null) {
    ...
    static class BuilderWithParent implements OFTableDescStatsReply.Builder {
        final OFTableDescStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFTableDescStatsReplyVer14 parentMessage) {
    ...
    public OFTableDescStatsReply.Builder setEntries(List<OFTableDesc> entries) {
        ...
        public OFTableDescStatsReply build() {
                ...
                //
                return new OFTableDescStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFTableDescStatsReply> {
        @Override
        public OFTableDescStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            // pad: 4 bytes
            bb.skipBytes(4);
            List<OFTableDesc> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFTableDescVer14.READER);

            OFTableDescStatsReplyVer14 tableDescStatsReplyVer14 = new OFTableDescStatsReplyVer14(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", tableDescStatsReplyVer14);
            return tableDescStatsReplyVer14;
        }
    }
    ...
    final static OFTableDescStatsReplyVer14Funnel FUNNEL = new OFTableDescStatsReplyVer14Funnel();
    static class OFTableDescStatsReplyVer14Funnel implements Funnel<OFTableDescStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFTableDescStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFTableDescStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFTableDescStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFTableDescStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFTableDescStatsReplyVer14 other = (OFTableDescStatsReplyVer14) obj;
