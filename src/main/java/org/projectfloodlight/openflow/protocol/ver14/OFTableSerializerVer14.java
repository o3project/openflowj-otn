    ...
    public static OFTable ofWireValue(byte val) {
        switch(val) {
            ...
            case ALL_VAL:
                return OFTable.ALL;
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFTable in version 1.4: " + val);
        }
    }
    ...
    public static byte toWireValue(OFTable e) {
        switch(e) {
            ...
            case ALL:
                return ALL_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFTable in version 1.4: " + e);
        }
    }
