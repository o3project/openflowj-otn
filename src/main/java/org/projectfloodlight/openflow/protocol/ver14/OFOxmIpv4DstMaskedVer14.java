...
class OFOxmIpv4DstMaskedVer14 implements OFOxmIpv4DstMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpv4DstMaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmIpv4DstMaskedVer14 DEFAULT = new OFOxmIpv4DstMaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpv4DstMaskedVer14(IPv4Address value, IPv4Address mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpv4DstMaskedVer14: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmIpv4DstMaskedVer14: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<IPv4Address> getCanonical() {
        if (IPv4Address.NO_MASK.equals(mask)) {
            return new OFOxmIpv4DstVer14(value);
    ...
    static class BuilderWithParent implements OFOxmIpv4DstMasked.Builder {
        final OFOxmIpv4DstMaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmIpv4DstMaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpv4DstMasked> {
        ...
        public OFOxmIpv4DstMasked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmIpv4DstMaskedVer14 oxmIpv4DstMaskedVer14 = new OFOxmIpv4DstMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv4DstMaskedVer14);
            return oxmIpv4DstMaskedVer14;
        }
    }
    ...
    final static OFOxmIpv4DstMaskedVer14Funnel FUNNEL = new OFOxmIpv4DstMaskedVer14Funnel();
    static class OFOxmIpv4DstMaskedVer14Funnel implements Funnel<OFOxmIpv4DstMaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpv4DstMaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80001908L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv4DstMaskedVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmIpv4DstMaskedVer14 message) {
            // fixed value property typeLen = 0x80001908L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpv4DstMaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpv4DstMaskedVer14 other = (OFOxmIpv4DstMaskedVer14) obj;
