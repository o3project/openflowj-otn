...
class OFBsnGentableStatsRequestVer14 implements OFBsnGentableStatsRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableStatsRequestVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnGentableStatsRequestVer14 DEFAULT = new OFBsnGentableStatsRequestVer14(
        DEFAULT_XID, DEFAULT_FLAGS
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnGentableStatsRequestVer14(long xid, Set<OFStatsRequestFlags> flags) {
        if(flags == null) {
    ...
    static class BuilderWithParent implements OFBsnGentableStatsRequest.Builder {
        final OFBsnGentableStatsRequestVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableStatsRequestVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableStatsRequest> {
        ...
        public OFBsnGentableStatsRequest readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnGentableStatsRequestVer14 bsnGentableStatsRequestVer14 = new OFBsnGentableStatsRequestVer14(
                    xid,
                      flags
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableStatsRequestVer14);
            return bsnGentableStatsRequestVer14;
        }
    }
    ...
    final static OFBsnGentableStatsRequestVer14Funnel FUNNEL = new OFBsnGentableStatsRequestVer14Funnel();
    static class OFBsnGentableStatsRequestVer14Funnel implements Funnel<OFBsnGentableStatsRequestVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableStatsRequestVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableStatsRequestVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnGentableStatsRequestVer14 message) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableStatsRequestVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableStatsRequestVer14 other = (OFBsnGentableStatsRequestVer14) obj;
