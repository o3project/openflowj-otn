...
class OFBsnSwitchPipelineStatsReplyVer14 implements OFBsnSwitchPipelineStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnSwitchPipelineStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnSwitchPipelineStatsReplyVer14 DEFAULT = new OFBsnSwitchPipelineStatsReplyVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnSwitchPipelineStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnSwitchPipelineStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnSwitchPipelineStatsReplyVer14: property flags cannot be null");
        }
        if(entries == null) {
    ...
    static class BuilderWithParent implements OFBsnSwitchPipelineStatsReply.Builder {
        final OFBsnSwitchPipelineStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnSwitchPipelineStatsReplyVer14 parentMessage) {
    ...
    public OFBsnSwitchPipelineStatsReply.Builder setEntries(List<OFBsnSwitchPipelineStatsEntry> entries) {
        ...
        public OFBsnSwitchPipelineStatsReply build() {
                ...
                //
                return new OFBsnSwitchPipelineStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnSwitchPipelineStatsReply> {
        ...
        public OFBsnSwitchPipelineStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnSwitchPipelineStatsReplyVer14);
            return bsnSwitchPipelineStatsReplyVer14;
        }
    }
    ...
    final static OFBsnSwitchPipelineStatsReplyVer14Funnel FUNNEL = new OFBsnSwitchPipelineStatsReplyVer14Funnel();
    static class OFBsnSwitchPipelineStatsReplyVer14Funnel implements Funnel<OFBsnSwitchPipelineStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnSwitchPipelineStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnSwitchPipelineStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnSwitchPipelineStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnSwitchPipelineStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnSwitchPipelineStatsReplyVer14 other = (OFBsnSwitchPipelineStatsReplyVer14) obj;
