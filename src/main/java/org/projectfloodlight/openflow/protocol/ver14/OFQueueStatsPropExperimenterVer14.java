...
abstract class OFQueueStatsPropExperimenterVer14 {
    ...
    static class Reader implements OFMessageReader<OFQueueStatsPropExperimenter> {
        @Override
        public OFQueueStatsPropExperimenter readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            switch(experimenter) {
               default:
                   throw new OFParseError("Unknown value for discriminator experimenter of class OFQueueStatsPropExperimenterVer14: " + experimenter);
            }
        }
    }
}
