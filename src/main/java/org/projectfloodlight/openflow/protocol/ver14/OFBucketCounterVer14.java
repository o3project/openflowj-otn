...
class OFBucketCounterVer14 implements OFBucketCounter {
    private static final Logger logger = LoggerFactory.getLogger(OFBucketCounterVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBucketCounterVer14 DEFAULT = new OFBucketCounterVer14(
    ...
    static class BuilderWithParent implements OFBucketCounter.Builder {
        final OFBucketCounterVer14 parentMessage;
        ...
        BuilderWithParent(OFBucketCounterVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFBucketCounter> {
        ...
        public OFBucketCounter readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBucketCounterVer14 bucketCounterVer14 = new OFBucketCounterVer14(
                    packetCount,
                      byteCount
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bucketCounterVer14);
            return bucketCounterVer14;
        }
    }
    ...
    final static OFBucketCounterVer14Funnel FUNNEL = new OFBucketCounterVer14Funnel();
    static class OFBucketCounterVer14Funnel implements Funnel<OFBucketCounterVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBucketCounterVer14 message, PrimitiveSink sink) {
    ...
    static class Writer implements OFMessageWriter<OFBucketCounterVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBucketCounterVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBucketCounterVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBucketCounterVer14 other = (OFBucketCounterVer14) obj;
