...
class OFGroupModFailedErrorMsgVer14 implements OFGroupModFailedErrorMsg {
    private static final Logger logger = LoggerFactory.getLogger(OFGroupModFailedErrorMsgVer14.class);
    // version: 1.4
...
//
    ...
    static class BuilderWithParent implements OFGroupModFailedErrorMsg.Builder {
        final OFGroupModFailedErrorMsgVer14 parentMessage;
        ...
        BuilderWithParent(OFGroupModFailedErrorMsgVer14 parentMessage) {
    ...
    public OFGroupModFailedErrorMsg.Builder setData(OFErrorCauseData data) {
        ...
        public OFGroupModFailedErrorMsg build() {
                ...
                //
                return new OFGroupModFailedErrorMsgVer14(
                    xid,
                    code,
                    data
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFGroupModFailedErrorMsg> {
        ...
        public OFGroupModFailedErrorMsg readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFGroupModFailedCode code = OFGroupModFailedCodeSerializerVer14.readFrom(bb);
            OFErrorCauseData data = OFErrorCauseData.read(bb, length - (bb.readerIndex() - start), OFVersion.OF_14);

            OFGroupModFailedErrorMsgVer14 groupModFailedErrorMsgVer14 = new OFGroupModFailedErrorMsgVer14(
                    xid,
                      code,
                      data
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", groupModFailedErrorMsgVer14);
            return groupModFailedErrorMsgVer14;
        }
    }
    ...
    final static OFGroupModFailedErrorMsgVer14Funnel FUNNEL = new OFGroupModFailedErrorMsgVer14Funnel();
    static class OFGroupModFailedErrorMsgVer14Funnel implements Funnel<OFGroupModFailedErrorMsgVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFGroupModFailedErrorMsgVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
            ...
            OFGroupModFailedCodeSerializerVer14.putTo(message.code, sink);
    ...
    static class Writer implements OFMessageWriter<OFGroupModFailedErrorMsgVer14> {
        @Override
        public void write(ChannelBuffer bb, OFGroupModFailedErrorMsgVer14 message) {
            ...
            OFGroupModFailedCodeSerializerVer14.writeTo(bb, message.code);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFGroupModFailedErrorMsgVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFGroupModFailedErrorMsgVer14 other = (OFGroupModFailedErrorMsgVer14) obj;
