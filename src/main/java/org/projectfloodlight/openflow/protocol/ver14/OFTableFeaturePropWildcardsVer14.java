...
class OFTableFeaturePropWildcardsVer14 implements OFTableFeaturePropWildcards {
...
//
    ...
    final static OFTableFeaturePropWildcardsVer14 DEFAULT = new OFTableFeaturePropWildcardsVer14(
        DEFAULT_OXM_IDS
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFTableFeaturePropWildcards> {
        ...
        public OFTableFeaturePropWildcards readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFTableFeaturePropWildcardsVer14 tableFeaturePropWildcardsVer14 = new OFTableFeaturePropWildcardsVer14(
                    oxmIds
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", tableFeaturePropWildcardsVer14);
    ...
    final static OFTableFeaturePropWildcardsVer14Funnel FUNNEL = new OFTableFeaturePropWildcardsVer14Funnel();
    static class OFTableFeaturePropWildcardsVer14Funnel implements Funnel<OFTableFeaturePropWildcardsVer14> {
    ...
    static class Writer implements OFMessageWriter<OFTableFeaturePropWildcardsVer14> {
        @Override
        public void write(ChannelBuffer bb, OFTableFeaturePropWildcardsVer14 message) {
