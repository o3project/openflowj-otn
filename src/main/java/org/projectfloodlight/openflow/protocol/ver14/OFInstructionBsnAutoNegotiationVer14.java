...
class OFInstructionBsnAutoNegotiationVer14 implements OFInstructionBsnAutoNegotiation {
...
//
    ...
    final static OFInstructionBsnAutoNegotiationVer14 DEFAULT = new OFInstructionBsnAutoNegotiationVer14(

    );

    final static OFInstructionBsnAutoNegotiationVer14 INSTANCE = new OFInstructionBsnAutoNegotiationVer14();
    ...
    final static OFInstructionBsnAutoNegotiationVer14Funnel FUNNEL = new OFInstructionBsnAutoNegotiationVer14Funnel();
    static class OFInstructionBsnAutoNegotiationVer14Funnel implements Funnel<OFInstructionBsnAutoNegotiationVer14> {
    ...
    static class Writer implements OFMessageWriter<OFInstructionBsnAutoNegotiationVer14> {
        @Override
