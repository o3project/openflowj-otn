...
class OFDescStatsReplyVer14 implements OFDescStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFDescStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFDescStatsReplyVer14 DEFAULT = new OFDescStatsReplyVer14(
    ...
    OFDescStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, String mfrDesc, String hwDesc, String swDesc, String serialNum, String dpDesc) {
        if(flags == null) {
            throw new NullPointerException("OFDescStatsReplyVer14: property flags cannot be null");
        }
        if(mfrDesc == null) {
            throw new NullPointerException("OFDescStatsReplyVer14: property mfrDesc cannot be null");
        }
        if(hwDesc == null) {
            throw new NullPointerException("OFDescStatsReplyVer14: property hwDesc cannot be null");
        }
        if(swDesc == null) {
            throw new NullPointerException("OFDescStatsReplyVer14: property swDesc cannot be null");
        }
        if(serialNum == null) {
            throw new NullPointerException("OFDescStatsReplyVer14: property serialNum cannot be null");
        }
        if(dpDesc == null) {
    ...
    static class BuilderWithParent implements OFDescStatsReply.Builder {
        final OFDescStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFDescStatsReplyVer14 parentMessage) {
    ...
    public OFDescStatsReply.Builder setDpDesc(String dpDesc) {
        ...
        public OFDescStatsReply build() {
                ...
                //
                return new OFDescStatsReplyVer14(
                    xid,
                    flags,
                    mfrDesc,
                    hwDesc,
...
//
    ...
    static class Reader implements OFMessageReader<OFDescStatsReply> {
        ...
        public OFDescStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFDescStatsReplyVer14 descStatsReplyVer14 = new OFDescStatsReplyVer14(
                    xid,
                      flags,
                      mfrDesc,
                      hwDesc,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", descStatsReplyVer14);
            return descStatsReplyVer14;
        }
    }
    ...
    final static OFDescStatsReplyVer14Funnel FUNNEL = new OFDescStatsReplyVer14Funnel();
    static class OFDescStatsReplyVer14Funnel implements Funnel<OFDescStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFDescStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFDescStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFDescStatsReplyVer14 message) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFDescStatsReplyVer14(");
