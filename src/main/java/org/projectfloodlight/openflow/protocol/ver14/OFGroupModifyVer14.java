...
class OFGroupModifyVer14 implements OFGroupModify {
...
//
    ...
    OFGroupModifyVer14(long xid, OFGroupType groupType, OFGroup group, List<OFBucket> buckets) {
        if(groupType == null) {
    ...
    static class BuilderWithParent implements OFGroupModify.Builder {
        ...
        BuilderWithParent(OFGroupModifyVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFGroupModify> {
        ...
        public OFGroupModify readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFGroupModifyVer14 groupModifyVer14 = new OFGroupModifyVer14(
                    xid,
                      groupType,
                      group,
                      buckets
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", groupModifyVer14);
            return groupModifyVer14;
        }
    }
    ...
    final static OFGroupModifyVer14Funnel FUNNEL = new OFGroupModifyVer14Funnel();
    static class OFGroupModifyVer14Funnel implements Funnel<OFGroupModifyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFGroupModifyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFGroupModifyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFGroupModifyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFGroupModifyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFGroupModifyVer14 other = (OFGroupModifyVer14) obj;
