...
class OFActionIdDecNwTtlVer14 implements OFActionIdDecNwTtl {
...
//
    ...
    final static OFActionIdDecNwTtlVer14 DEFAULT = new OFActionIdDecNwTtlVer14(

    );

    final static OFActionIdDecNwTtlVer14 INSTANCE = new OFActionIdDecNwTtlVer14();
    ...
    final static OFActionIdDecNwTtlVer14Funnel FUNNEL = new OFActionIdDecNwTtlVer14Funnel();
    static class OFActionIdDecNwTtlVer14Funnel implements Funnel<OFActionIdDecNwTtlVer14> {
    ...
    static class Writer implements OFMessageWriter<OFActionIdDecNwTtlVer14> {
        @Override
        public void write(ChannelBuffer bb, OFActionIdDecNwTtlVer14 message) {
            // fixed value property type = 24
