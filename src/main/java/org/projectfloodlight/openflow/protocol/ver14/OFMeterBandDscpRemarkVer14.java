...
class OFMeterBandDscpRemarkVer14 implements OFMeterBandDscpRemark {
    private static final Logger logger = LoggerFactory.getLogger(OFMeterBandDscpRemarkVer14.class);
    // version: 1.4
...
//
    ...
    final static OFMeterBandDscpRemarkVer14 DEFAULT = new OFMeterBandDscpRemarkVer14(
    ...
    static class BuilderWithParent implements OFMeterBandDscpRemark.Builder {
        final OFMeterBandDscpRemarkVer14 parentMessage;
        ...
        BuilderWithParent(OFMeterBandDscpRemarkVer14 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFMeterBandDscpRemark build() {
                ...
                //
                return new OFMeterBandDscpRemarkVer14(
                    rate,
                    burstSize,
                    precLevel
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFMeterBandDscpRemark> {
        ...
        public OFMeterBandDscpRemark readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFMeterBandDscpRemarkVer14 meterBandDscpRemarkVer14 = new OFMeterBandDscpRemarkVer14(
                    rate,
                      burstSize,
                      precLevel
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", meterBandDscpRemarkVer14);
            return meterBandDscpRemarkVer14;
        }
    }
    ...
    final static OFMeterBandDscpRemarkVer14Funnel FUNNEL = new OFMeterBandDscpRemarkVer14Funnel();
    static class OFMeterBandDscpRemarkVer14Funnel implements Funnel<OFMeterBandDscpRemarkVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFMeterBandDscpRemarkVer14 message, PrimitiveSink sink) {
            // fixed value property type = 0x2
    ...
    static class Writer implements OFMessageWriter<OFMeterBandDscpRemarkVer14> {
        @Override
        public void write(ChannelBuffer bb, OFMeterBandDscpRemarkVer14 message) {
            // fixed value property type = 0x2
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFMeterBandDscpRemarkVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFMeterBandDscpRemarkVer14 other = (OFMeterBandDscpRemarkVer14) obj;
