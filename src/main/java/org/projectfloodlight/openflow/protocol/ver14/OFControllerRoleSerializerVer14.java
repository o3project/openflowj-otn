...
public class OFControllerRoleSerializerVer14 {
    ...
    public static OFControllerRole ofWireValue(int val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFControllerRole in version 1.4: " + val);
        }
    }
    ...
    public static int toWireValue(OFControllerRole e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFControllerRole in version 1.4: " + e);
        }
    }
