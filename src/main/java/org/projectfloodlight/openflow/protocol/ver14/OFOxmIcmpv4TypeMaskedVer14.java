...
class OFOxmIcmpv4TypeMaskedVer14 implements OFOxmIcmpv4TypeMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIcmpv4TypeMaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmIcmpv4TypeMaskedVer14 DEFAULT = new OFOxmIcmpv4TypeMaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIcmpv4TypeMaskedVer14(ICMPv4Type value, ICMPv4Type mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmIcmpv4TypeMaskedVer14: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmIcmpv4TypeMaskedVer14: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<ICMPv4Type> getCanonical() {
        if (ICMPv4Type.NO_MASK.equals(mask)) {
            return new OFOxmIcmpv4TypeVer14(value);
    ...
    static class BuilderWithParent implements OFOxmIcmpv4TypeMasked.Builder {
        final OFOxmIcmpv4TypeMaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmIcmpv4TypeMaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIcmpv4TypeMasked> {
        ...
        public OFOxmIcmpv4TypeMasked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmIcmpv4TypeMaskedVer14 oxmIcmpv4TypeMaskedVer14 = new OFOxmIcmpv4TypeMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIcmpv4TypeMaskedVer14);
            return oxmIcmpv4TypeMaskedVer14;
        }
    }
    ...
    final static OFOxmIcmpv4TypeMaskedVer14Funnel FUNNEL = new OFOxmIcmpv4TypeMaskedVer14Funnel();
    static class OFOxmIcmpv4TypeMaskedVer14Funnel implements Funnel<OFOxmIcmpv4TypeMaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIcmpv4TypeMaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80002702L
    ...
    static class Writer implements OFMessageWriter<OFOxmIcmpv4TypeMaskedVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmIcmpv4TypeMaskedVer14 message) {
            // fixed value property typeLen = 0x80002702L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIcmpv4TypeMaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIcmpv4TypeMaskedVer14 other = (OFOxmIcmpv4TypeMaskedVer14) obj;
