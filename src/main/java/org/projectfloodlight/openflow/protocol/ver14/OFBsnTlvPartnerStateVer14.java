...
class OFBsnTlvPartnerStateVer14 implements OFBsnTlvPartnerState {
...
//
    ...
    final static OFBsnTlvPartnerStateVer14 DEFAULT = new OFBsnTlvPartnerStateVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvPartnerState> {
        ...
        public OFBsnTlvPartnerState readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnTlvPartnerStateVer14 bsnTlvPartnerStateVer14 = new OFBsnTlvPartnerStateVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvPartnerStateVer14);
    ...
    final static OFBsnTlvPartnerStateVer14Funnel FUNNEL = new OFBsnTlvPartnerStateVer14Funnel();
    static class OFBsnTlvPartnerStateVer14Funnel implements Funnel<OFBsnTlvPartnerStateVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvPartnerStateVer14> {
        @Override
