...
class OFBsnTlvCrcEnabledVer14 implements OFBsnTlvCrcEnabled {
...
//
    ...
    final static OFBsnTlvCrcEnabledVer14 DEFAULT = new OFBsnTlvCrcEnabledVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvCrcEnabled> {
        ...
        public OFBsnTlvCrcEnabled readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnTlvCrcEnabledVer14 bsnTlvCrcEnabledVer14 = new OFBsnTlvCrcEnabledVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvCrcEnabledVer14);
    ...
    final static OFBsnTlvCrcEnabledVer14Funnel FUNNEL = new OFBsnTlvCrcEnabledVer14Funnel();
    static class OFBsnTlvCrcEnabledVer14Funnel implements Funnel<OFBsnTlvCrcEnabledVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvCrcEnabledVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnTlvCrcEnabledVer14 message) {
            // fixed value property type = 0x16
