...
class OFActionPopVlanVer14 implements OFActionPopVlan {
...
//
    ...
    final static OFActionPopVlanVer14 DEFAULT = new OFActionPopVlanVer14(

    );

    final static OFActionPopVlanVer14 INSTANCE = new OFActionPopVlanVer14();
    ...
    final static OFActionPopVlanVer14Funnel FUNNEL = new OFActionPopVlanVer14Funnel();
    static class OFActionPopVlanVer14Funnel implements Funnel<OFActionPopVlanVer14> {
    ...
    static class Writer implements OFMessageWriter<OFActionPopVlanVer14> {
        @Override
        public void write(ChannelBuffer bb, OFActionPopVlanVer14 message) {
            // fixed value property type = 18
