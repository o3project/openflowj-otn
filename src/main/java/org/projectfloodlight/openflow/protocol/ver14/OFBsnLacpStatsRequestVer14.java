...
class OFBsnLacpStatsRequestVer14 implements OFBsnLacpStatsRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnLacpStatsRequestVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnLacpStatsRequestVer14 DEFAULT = new OFBsnLacpStatsRequestVer14(
        DEFAULT_XID, DEFAULT_FLAGS
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnLacpStatsRequestVer14(long xid, Set<OFStatsRequestFlags> flags) {
        if(flags == null) {
    ...
    static class BuilderWithParent implements OFBsnLacpStatsRequest.Builder {
        final OFBsnLacpStatsRequestVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnLacpStatsRequestVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnLacpStatsRequest> {
        ...
        public OFBsnLacpStatsRequest readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnLacpStatsRequestVer14 bsnLacpStatsRequestVer14 = new OFBsnLacpStatsRequestVer14(
                    xid,
                      flags
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnLacpStatsRequestVer14);
            return bsnLacpStatsRequestVer14;
        }
    }
    ...
    final static OFBsnLacpStatsRequestVer14Funnel FUNNEL = new OFBsnLacpStatsRequestVer14Funnel();
    static class OFBsnLacpStatsRequestVer14Funnel implements Funnel<OFBsnLacpStatsRequestVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnLacpStatsRequestVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnLacpStatsRequestVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnLacpStatsRequestVer14 message) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnLacpStatsRequestVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnLacpStatsRequestVer14 other = (OFBsnLacpStatsRequestVer14) obj;
