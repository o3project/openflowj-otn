...
public class OFHelloFailedCodeSerializerVer14 {
    ...
    public static OFHelloFailedCode ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFHelloFailedCode in version 1.4: " + val);
        }
    }
    ...
    public static short toWireValue(OFHelloFailedCode e) {
        switch(e) {
            ...
            case EPERM:
                return EPERM_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFHelloFailedCode in version 1.4: " + e);
        }
    }
