...
class OFGetConfigReplyVer14 implements OFGetConfigReply {
    private static final Logger logger = LoggerFactory.getLogger(OFGetConfigReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFGetConfigReplyVer14 DEFAULT = new OFGetConfigReplyVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_MISS_SEND_LEN
    );

    // package private constructor - used by readers, builders, and factory
    OFGetConfigReplyVer14(long xid, Set<OFConfigFlags> flags, int missSendLen) {
        if(flags == null) {
            throw new NullPointerException("OFGetConfigReplyVer14: property flags cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFGetConfigReply.Builder {
        final OFGetConfigReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFGetConfigReplyVer14 parentMessage) {
    ...
    public OFGetConfigReply.Builder setMissSendLen(int missSendLen) {
        ...
        public OFGetConfigReply build() {
                ...
                //
                return new OFGetConfigReplyVer14(
                    xid,
                    flags,
                    missSendLen
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFGetConfigReply> {
        ...
        public OFGetConfigReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFGetConfigReplyVer14 getConfigReplyVer14 = new OFGetConfigReplyVer14(
                    xid,
                      flags,
                      missSendLen
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", getConfigReplyVer14);
            return getConfigReplyVer14;
        }
    }
    ...
    final static OFGetConfigReplyVer14Funnel FUNNEL = new OFGetConfigReplyVer14Funnel();
    static class OFGetConfigReplyVer14Funnel implements Funnel<OFGetConfigReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFGetConfigReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFGetConfigReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFGetConfigReplyVer14 message) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFGetConfigReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFGetConfigReplyVer14 other = (OFGetConfigReplyVer14) obj;
