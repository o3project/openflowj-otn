...
//
    ...
    OFPacketOutVer14(long xid, OFBufferId bufferId, OFPort inPort, List<OFAction> actions, byte[] data) {
        if(bufferId == null) {
            throw new NullPointerException("OFPacketOutVer14: property bufferId cannot be null");
        }
        if(inPort == null) {
            throw new NullPointerException("OFPacketOutVer14: property inPort cannot be null");
        }
        if(actions == null) {
            throw new NullPointerException("OFPacketOutVer14: property actions cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFPacketOutVer14: property data cannot be null");
        }
        this.xid = xid;
