...
class OFBsnVirtualPortRemoveRequestVer14 implements OFBsnVirtualPortRemoveRequest {
...
//
    ...
    final static OFBsnVirtualPortRemoveRequestVer14 DEFAULT = new OFBsnVirtualPortRemoveRequestVer14(
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnVirtualPortRemoveRequest> {
        ...
        public OFBsnVirtualPortRemoveRequest readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnVirtualPortRemoveRequestVer14 bsnVirtualPortRemoveRequestVer14 = new OFBsnVirtualPortRemoveRequestVer14(
                    xid,
                      vportNo
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnVirtualPortRemoveRequestVer14);
    ...
    final static OFBsnVirtualPortRemoveRequestVer14Funnel FUNNEL = new OFBsnVirtualPortRemoveRequestVer14Funnel();
    static class OFBsnVirtualPortRemoveRequestVer14Funnel implements Funnel<OFBsnVirtualPortRemoveRequestVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnVirtualPortRemoveRequestVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnVirtualPortRemoveRequestVer14 message) {
            // fixed value property version = 5
