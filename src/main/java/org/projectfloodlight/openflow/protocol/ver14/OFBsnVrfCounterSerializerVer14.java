...
public class OFBsnVrfCounterSerializerVer14 {
    ...
    public static OFBsnVrfCounter ofWireValue(byte val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnVrfCounter in version 1.4: " + val);
        }
    }
    ...
    public static byte toWireValue(OFBsnVrfCounter e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnVrfCounter in version 1.4: " + e);
        }
    }
