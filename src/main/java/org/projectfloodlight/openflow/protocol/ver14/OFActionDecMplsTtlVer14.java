...
class OFActionDecMplsTtlVer14 implements OFActionDecMplsTtl {
...
//
    ...
    final static OFActionDecMplsTtlVer14 DEFAULT = new OFActionDecMplsTtlVer14(

    );

    final static OFActionDecMplsTtlVer14 INSTANCE = new OFActionDecMplsTtlVer14();
    ...
    final static OFActionDecMplsTtlVer14Funnel FUNNEL = new OFActionDecMplsTtlVer14Funnel();
    static class OFActionDecMplsTtlVer14Funnel implements Funnel<OFActionDecMplsTtlVer14> {
    ...
    static class Writer implements OFMessageWriter<OFActionDecMplsTtlVer14> {
        @Override
        public void write(ChannelBuffer bb, OFActionDecMplsTtlVer14 message) {
            // fixed value property type = 16
