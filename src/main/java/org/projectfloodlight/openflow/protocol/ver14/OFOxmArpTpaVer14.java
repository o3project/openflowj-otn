...
class OFOxmArpTpaVer14 implements OFOxmArpTpa {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmArpTpaVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmArpTpaVer14 DEFAULT = new OFOxmArpTpaVer14(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmArpTpaVer14(IPv4Address value) {
        if(value == null) {
            throw new NullPointerException("OFOxmArpTpaVer14: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmArpTpa.Builder {
        final OFOxmArpTpaVer14 parentMessage;

        // OF message fields
        private boolean valueSet;
        private IPv4Address value;

        BuilderWithParent(OFOxmArpTpaVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmArpTpa> {
        ...
        public OFOxmArpTpa readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmArpTpaVer14 oxmArpTpaVer14 = new OFOxmArpTpaVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmArpTpaVer14);
            return oxmArpTpaVer14;
        }
    }
    ...
    final static OFOxmArpTpaVer14Funnel FUNNEL = new OFOxmArpTpaVer14Funnel();
    static class OFOxmArpTpaVer14Funnel implements Funnel<OFOxmArpTpaVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmArpTpaVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80002e04L
    ...
    static class Writer implements OFMessageWriter<OFOxmArpTpaVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmArpTpaVer14 message) {
            // fixed value property typeLen = 0x80002e04L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmArpTpaVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmArpTpaVer14 other = (OFOxmArpTpaVer14) obj;
