...
public class OFQueueOpFailedCodeSerializerVer14 {
    ...
    public static OFQueueOpFailedCode ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFQueueOpFailedCode in version 1.4: " + val);
        }
    }
    ...
    public static short toWireValue(OFQueueOpFailedCode e) {
        switch(e) {
            ...
            case EPERM:
                return EPERM_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFQueueOpFailedCode in version 1.4: " + e);
        }
    }
