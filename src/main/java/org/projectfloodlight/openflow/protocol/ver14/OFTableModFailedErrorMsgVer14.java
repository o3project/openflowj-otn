...
class OFTableModFailedErrorMsgVer14 implements OFTableModFailedErrorMsg {
    private static final Logger logger = LoggerFactory.getLogger(OFTableModFailedErrorMsgVer14.class);
    // version: 1.4
...
//
    ...
    OFTableModFailedErrorMsgVer14(long xid, OFTableModFailedCode code, OFErrorCauseData data) {
        if(code == null) {
            throw new NullPointerException("OFTableModFailedErrorMsgVer14: property code cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFTableModFailedErrorMsgVer14: property data cannot be null");
        }
        this.xid = xid;
        this.code = code;
        this.data = data;
    ...
    static class BuilderWithParent implements OFTableModFailedErrorMsg.Builder {
        final OFTableModFailedErrorMsgVer14 parentMessage;
        ...
        BuilderWithParent(OFTableModFailedErrorMsgVer14 parentMessage) {
    ...
    public OFTableModFailedErrorMsg.Builder setData(OFErrorCauseData data) {
        ...
        public OFTableModFailedErrorMsg build() {
                ...
                //
                return new OFTableModFailedErrorMsgVer14(
                    xid,
                    code,
                    data
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFTableModFailedErrorMsg> {
        ...
        public OFTableModFailedErrorMsg readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", tableModFailedErrorMsgVer14);
            return tableModFailedErrorMsgVer14;
        }
    }
    ...
    final static OFTableModFailedErrorMsgVer14Funnel FUNNEL = new OFTableModFailedErrorMsgVer14Funnel();
    static class OFTableModFailedErrorMsgVer14Funnel implements Funnel<OFTableModFailedErrorMsgVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFTableModFailedErrorMsgVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
            ...
            OFTableModFailedCodeSerializerVer14.putTo(message.code, sink);
    ...
    static class Writer implements OFMessageWriter<OFTableModFailedErrorMsgVer14> {
        @Override
        public void write(ChannelBuffer bb, OFTableModFailedErrorMsgVer14 message) {
            ...
            OFTableModFailedCodeSerializerVer14.writeTo(bb, message.code);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFTableModFailedErrorMsgVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFTableModFailedErrorMsgVer14 other = (OFTableModFailedErrorMsgVer14) obj;
