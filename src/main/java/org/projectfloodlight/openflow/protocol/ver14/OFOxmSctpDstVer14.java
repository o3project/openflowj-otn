...
class OFOxmSctpDstVer14 implements OFOxmSctpDst {
...
//
    ...
    final static OFOxmSctpDstVer14 DEFAULT = new OFOxmSctpDstVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmSctpDst> {
        ...
        public OFOxmSctpDst readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmSctpDstVer14 oxmSctpDstVer14 = new OFOxmSctpDstVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmSctpDstVer14);
    ...
    final static OFOxmSctpDstVer14Funnel FUNNEL = new OFOxmSctpDstVer14Funnel();
    static class OFOxmSctpDstVer14Funnel implements Funnel<OFOxmSctpDstVer14> {
    ...
    static class Writer implements OFMessageWriter<OFOxmSctpDstVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmSctpDstVer14 message) {
            // fixed value property typeLen = 0x80002402L
