...
public class OFBadInstructionCodeSerializerVer14 {
    ...
    public final static short DUP_INST_VAL = (short) 0x9;
    ...
    public static OFBadInstructionCode ofWireValue(short val) {
        switch(val) {
            ...
            case DUP_INST_VAL:
                return OFBadInstructionCode.DUP_INST;
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBadInstructionCode in version 1.4: " + val);
        }
    }
    ...
    public static short toWireValue(OFBadInstructionCode e) {
        switch(e) {
            ...
            case DUP_INST:
                return DUP_INST_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBadInstructionCode in version 1.4: " + e);
        }
    }
