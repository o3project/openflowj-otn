...
class OFBsnDebugCounterStatsReplyVer14 implements OFBsnDebugCounterStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnDebugCounterStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnDebugCounterStatsReplyVer14 DEFAULT = new OFBsnDebugCounterStatsReplyVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnDebugCounterStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnDebugCounterStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnDebugCounterStatsReplyVer14: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFBsnDebugCounterStatsReplyVer14: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFBsnDebugCounterStatsReply.Builder {
        final OFBsnDebugCounterStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnDebugCounterStatsReplyVer14 parentMessage) {
    ...
    public OFBsnDebugCounterStatsReply.Builder setEntries(List<OFBsnDebugCounterStatsEntry> entries) {
        ...
        public OFBsnDebugCounterStatsReply build() {
                ...
                //
                return new OFBsnDebugCounterStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnDebugCounterStatsReply> {
        ...
        public OFBsnDebugCounterStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            List<OFBsnDebugCounterStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFBsnDebugCounterStatsEntryVer14.READER);

            OFBsnDebugCounterStatsReplyVer14 bsnDebugCounterStatsReplyVer14 = new OFBsnDebugCounterStatsReplyVer14(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnDebugCounterStatsReplyVer14);
            return bsnDebugCounterStatsReplyVer14;
        }
    }
    ...
    final static OFBsnDebugCounterStatsReplyVer14Funnel FUNNEL = new OFBsnDebugCounterStatsReplyVer14Funnel();
    static class OFBsnDebugCounterStatsReplyVer14Funnel implements Funnel<OFBsnDebugCounterStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnDebugCounterStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnDebugCounterStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnDebugCounterStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnDebugCounterStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnDebugCounterStatsReplyVer14 other = (OFBsnDebugCounterStatsReplyVer14) obj;
