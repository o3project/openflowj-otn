...
class OFBsnSetSwitchPipelineRequestVer14 implements OFBsnSetSwitchPipelineRequest {
...
//
    ...
    final static OFBsnSetSwitchPipelineRequestVer14 DEFAULT = new OFBsnSetSwitchPipelineRequestVer14(
        DEFAULT_XID, DEFAULT_PIPELINE
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnSetSwitchPipelineRequestVer14(long xid, String pipeline) {
        if(pipeline == null) {
    ...
    static class BuilderWithParent implements OFBsnSetSwitchPipelineRequest.Builder {
        ...
        BuilderWithParent(OFBsnSetSwitchPipelineRequestVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnSetSwitchPipelineRequest> {
        ...
        public OFBsnSetSwitchPipelineRequest readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnSetSwitchPipelineRequestVer14 bsnSetSwitchPipelineRequestVer14 = new OFBsnSetSwitchPipelineRequestVer14(
                    xid,
                      pipeline
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnSetSwitchPipelineRequestVer14);
            return bsnSetSwitchPipelineRequestVer14;
        }
    }
    ...
    final static OFBsnSetSwitchPipelineRequestVer14Funnel FUNNEL = new OFBsnSetSwitchPipelineRequestVer14Funnel();
    static class OFBsnSetSwitchPipelineRequestVer14Funnel implements Funnel<OFBsnSetSwitchPipelineRequestVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnSetSwitchPipelineRequestVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnSetSwitchPipelineRequestVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnSetSwitchPipelineRequestVer14 message) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnSetSwitchPipelineRequestVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnSetSwitchPipelineRequestVer14 other = (OFBsnSetSwitchPipelineRequestVer14) obj;
