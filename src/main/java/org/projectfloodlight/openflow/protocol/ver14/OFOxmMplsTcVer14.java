...
class OFOxmMplsTcVer14 implements OFOxmMplsTc {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmMplsTcVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmMplsTcVer14 DEFAULT = new OFOxmMplsTcVer14(
        DEFAULT_VALUE
    );
    ...
    static class BuilderWithParent implements OFOxmMplsTc.Builder {
        final OFOxmMplsTcVer14 parentMessage;

        // OF message fields
        private boolean valueSet;
        private U8 value;

        BuilderWithParent(OFOxmMplsTcVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmMplsTc> {
        ...
        public OFOxmMplsTc readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmMplsTcVer14 oxmMplsTcVer14 = new OFOxmMplsTcVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmMplsTcVer14);
            return oxmMplsTcVer14;
        }
    }
    ...
    final static OFOxmMplsTcVer14Funnel FUNNEL = new OFOxmMplsTcVer14Funnel();
    static class OFOxmMplsTcVer14Funnel implements Funnel<OFOxmMplsTcVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmMplsTcVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80004601L
    ...
    static class Writer implements OFMessageWriter<OFOxmMplsTcVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmMplsTcVer14 message) {
            // fixed value property typeLen = 0x80004601L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmMplsTcVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmMplsTcVer14 other = (OFOxmMplsTcVer14) obj;
