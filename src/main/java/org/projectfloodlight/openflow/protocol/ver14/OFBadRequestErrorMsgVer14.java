...
class OFBadRequestErrorMsgVer14 implements OFBadRequestErrorMsg {
    private static final Logger logger = LoggerFactory.getLogger(OFBadRequestErrorMsgVer14.class);
    // version: 1.4
...
//
    ...
    OFBadRequestErrorMsgVer14(long xid, OFBadRequestCode code, OFErrorCauseData data) {
        if(code == null) {
            throw new NullPointerException("OFBadRequestErrorMsgVer14: property code cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFBadRequestErrorMsgVer14: property data cannot be null");
        }
        this.xid = xid;
        this.code = code;
        this.data = data;
    ...
    static class BuilderWithParent implements OFBadRequestErrorMsg.Builder {
        final OFBadRequestErrorMsgVer14 parentMessage;
        ...
        BuilderWithParent(OFBadRequestErrorMsgVer14 parentMessage) {
    ...
    public OFBadRequestErrorMsg.Builder setData(OFErrorCauseData data) {
        ...
        public OFBadRequestErrorMsg build() {
                ...
                //
                return new OFBadRequestErrorMsgVer14(
                    xid,
                    code,
                    data
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBadRequestErrorMsg> {
        ...
        public OFBadRequestErrorMsg readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBadRequestCode code = OFBadRequestCodeSerializerVer14.readFrom(bb);
            OFErrorCauseData data = OFErrorCauseData.read(bb, length - (bb.readerIndex() - start), OFVersion.OF_14);

            OFBadRequestErrorMsgVer14 badRequestErrorMsgVer14 = new OFBadRequestErrorMsgVer14(
                    xid,
                      code,
                      data
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", badRequestErrorMsgVer14);
            return badRequestErrorMsgVer14;
        }
    }
    ...
    final static OFBadRequestErrorMsgVer14Funnel FUNNEL = new OFBadRequestErrorMsgVer14Funnel();
    static class OFBadRequestErrorMsgVer14Funnel implements Funnel<OFBadRequestErrorMsgVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBadRequestErrorMsgVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
            ...
            OFBadRequestCodeSerializerVer14.putTo(message.code, sink);
    ...
    static class Writer implements OFMessageWriter<OFBadRequestErrorMsgVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBadRequestErrorMsgVer14 message) {
            ...
            OFBadRequestCodeSerializerVer14.writeTo(bb, message.code);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBadRequestErrorMsgVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBadRequestErrorMsgVer14 other = (OFBadRequestErrorMsgVer14) obj;
