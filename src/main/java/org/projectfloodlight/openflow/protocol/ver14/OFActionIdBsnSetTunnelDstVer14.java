...
class OFActionIdBsnSetTunnelDstVer14 implements OFActionIdBsnSetTunnelDst {
...
//
    ...
    final static OFActionIdBsnSetTunnelDstVer14 DEFAULT = new OFActionIdBsnSetTunnelDstVer14(

    );

    final static OFActionIdBsnSetTunnelDstVer14 INSTANCE = new OFActionIdBsnSetTunnelDstVer14();
    ...
    final static OFActionIdBsnSetTunnelDstVer14Funnel FUNNEL = new OFActionIdBsnSetTunnelDstVer14Funnel();
    static class OFActionIdBsnSetTunnelDstVer14Funnel implements Funnel<OFActionIdBsnSetTunnelDstVer14> {
    ...
    static class Writer implements OFMessageWriter<OFActionIdBsnSetTunnelDstVer14> {
        @Override
        public void write(ChannelBuffer bb, OFActionIdBsnSetTunnelDstVer14 message) {
            // fixed value property type = 65535
