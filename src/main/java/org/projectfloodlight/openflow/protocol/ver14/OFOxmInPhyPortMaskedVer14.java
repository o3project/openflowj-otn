...
class OFOxmInPhyPortMaskedVer14 implements OFOxmInPhyPortMasked {
...
//
    ...
    final static OFOxmInPhyPortMaskedVer14 DEFAULT = new OFOxmInPhyPortMaskedVer14(
    ...
    public OFOxm<OFPort> getCanonical() {
        if (OFPort.NO_MASK.equals(mask)) {
            return new OFOxmInPhyPortVer14(value);
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmInPhyPortMasked> {
        ...
        public OFOxmInPhyPortMasked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmInPhyPortMaskedVer14 oxmInPhyPortMaskedVer14 = new OFOxmInPhyPortMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmInPhyPortMaskedVer14);
    ...
    final static OFOxmInPhyPortMaskedVer14Funnel FUNNEL = new OFOxmInPhyPortMaskedVer14Funnel();
    static class OFOxmInPhyPortMaskedVer14Funnel implements Funnel<OFOxmInPhyPortMaskedVer14> {
    ...
    static class Writer implements OFMessageWriter<OFOxmInPhyPortMaskedVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmInPhyPortMaskedVer14 message) {
            // fixed value property typeLen = 0x80000308L
