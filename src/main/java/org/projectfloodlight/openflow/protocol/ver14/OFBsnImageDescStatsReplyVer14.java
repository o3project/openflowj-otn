...
class OFBsnImageDescStatsReplyVer14 implements OFBsnImageDescStatsReply {
...
//
    ...
    final static OFBsnImageDescStatsReplyVer14 DEFAULT = new OFBsnImageDescStatsReplyVer14(
    ...
    public OFBsnImageDescStatsReply.Builder setStartupConfigChecksum(String startupConfigChecksum) {
        ...
        public OFBsnImageDescStatsReply build() {
                ...
                //
                return new OFBsnImageDescStatsReplyVer14(
                    xid,
                    flags,
                    imageChecksum,
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnImageDescStatsReply> {
        ...
        public OFBsnImageDescStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnImageDescStatsReplyVer14 bsnImageDescStatsReplyVer14 = new OFBsnImageDescStatsReplyVer14(
                    xid,
                      flags,
                      imageChecksum,
                      startupConfigChecksum
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnImageDescStatsReplyVer14);
    ...
    final static OFBsnImageDescStatsReplyVer14Funnel FUNNEL = new OFBsnImageDescStatsReplyVer14Funnel();
    static class OFBsnImageDescStatsReplyVer14Funnel implements Funnel<OFBsnImageDescStatsReplyVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnImageDescStatsReplyVer14> {
        @Override
