...
class OFBsnTimeReplyVer14 implements OFBsnTimeReply {
...
//
    ...
    final static OFBsnTimeReplyVer14 DEFAULT = new OFBsnTimeReplyVer14(
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTimeReply> {
        ...
        public OFBsnTimeReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnTimeReplyVer14 bsnTimeReplyVer14 = new OFBsnTimeReplyVer14(
                    xid,
                      timeMs
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTimeReplyVer14);
    ...
    final static OFBsnTimeReplyVer14Funnel FUNNEL = new OFBsnTimeReplyVer14Funnel();
    static class OFBsnTimeReplyVer14Funnel implements Funnel<OFBsnTimeReplyVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTimeReplyVer14> {
        @Override
