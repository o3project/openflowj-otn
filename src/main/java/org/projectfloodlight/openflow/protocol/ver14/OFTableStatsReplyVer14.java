...
class OFTableStatsReplyVer14 implements OFTableStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFTableStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFTableStatsReplyVer14 DEFAULT = new OFTableStatsReplyVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFTableStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, List<OFTableStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFTableStatsReplyVer14: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFTableStatsReplyVer14: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFTableStatsReply.Builder {
        final OFTableStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFTableStatsReplyVer14 parentMessage) {
    ...
    public OFTableStatsReply.Builder setEntries(List<OFTableStatsEntry> entries) {
        ...
        public OFTableStatsReply build() {
                ...
                //
                return new OFTableStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFTableStatsReply> {
        ...
        public OFTableStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            // pad: 4 bytes
            bb.skipBytes(4);
            List<OFTableStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFTableStatsEntryVer14.READER);

            OFTableStatsReplyVer14 tableStatsReplyVer14 = new OFTableStatsReplyVer14(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", tableStatsReplyVer14);
            return tableStatsReplyVer14;
        }
    }
    ...
    final static OFTableStatsReplyVer14Funnel FUNNEL = new OFTableStatsReplyVer14Funnel();
    static class OFTableStatsReplyVer14Funnel implements Funnel<OFTableStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFTableStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFTableStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFTableStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFTableStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFTableStatsReplyVer14 other = (OFTableStatsReplyVer14) obj;
