...
class OFBsnGentableEntryStatsRequestVer14 implements OFBsnGentableEntryStatsRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableEntryStatsRequestVer14.class);
    // version: 1.4
...
//
    ...
    OFBsnGentableEntryStatsRequestVer14(long xid, Set<OFStatsRequestFlags> flags, GenTableId tableId, U128 checksum, U128 checksumMask) {
        if(flags == null) {
            throw new NullPointerException("OFBsnGentableEntryStatsRequestVer14: property flags cannot be null");
        }
        if(tableId == null) {
            throw new NullPointerException("OFBsnGentableEntryStatsRequestVer14: property tableId cannot be null");
        }
        if(checksum == null) {
            throw new NullPointerException("OFBsnGentableEntryStatsRequestVer14: property checksum cannot be null");
        }
        if(checksumMask == null) {
            throw new NullPointerException("OFBsnGentableEntryStatsRequestVer14: property checksumMask cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFBsnGentableEntryStatsRequest.Builder {
        final OFBsnGentableEntryStatsRequestVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableEntryStatsRequestVer14 parentMessage) {
    ...
    public OFBsnGentableEntryStatsRequest.Builder setChecksumMask(U128 checksumMask) {
        ...
        public OFBsnGentableEntryStatsRequest build() {
                ...
                //
                return new OFBsnGentableEntryStatsRequestVer14(
                    xid,
                    flags,
                    tableId,
                    checksum,
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableEntryStatsRequest> {
        ...
        public OFBsnGentableEntryStatsRequest readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnGentableEntryStatsRequestVer14 bsnGentableEntryStatsRequestVer14 = new OFBsnGentableEntryStatsRequestVer14(
                    xid,
                      flags,
                      tableId,
                      checksum,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableEntryStatsRequestVer14);
            return bsnGentableEntryStatsRequestVer14;
        }
    }
    ...
    final static OFBsnGentableEntryStatsRequestVer14Funnel FUNNEL = new OFBsnGentableEntryStatsRequestVer14Funnel();
    static class OFBsnGentableEntryStatsRequestVer14Funnel implements Funnel<OFBsnGentableEntryStatsRequestVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableEntryStatsRequestVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableEntryStatsRequestVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableEntryStatsRequestVer14 other = (OFBsnGentableEntryStatsRequestVer14) obj;
