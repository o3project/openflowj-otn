...
public class OFBadRequestCodeSerializerVer14 {
    ...
    public static OFBadRequestCode ofWireValue(short val) {
        switch(val) {
            ...
            case MULTIPART_REQUEST_TIMEOUT_VAL:
                return OFBadRequestCode.MULTIPART_REQUEST_TIMEOUT;
            case MULTIPART_REPLY_TIMEOUT_VAL:
                return OFBadRequestCode.MULTIPART_REPLY_TIMEOUT;
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBadRequestCode in version 1.4: " + val);
        }
    }
    ...
    public static short toWireValue(OFBadRequestCode e) {
        switch(e) {
            ...
            case MULTIPART_REQUEST_TIMEOUT:
                return MULTIPART_REQUEST_TIMEOUT_VAL;
            case MULTIPART_REPLY_TIMEOUT:
                return MULTIPART_REPLY_TIMEOUT_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBadRequestCode in version 1.4: " + e);
        }
    }
