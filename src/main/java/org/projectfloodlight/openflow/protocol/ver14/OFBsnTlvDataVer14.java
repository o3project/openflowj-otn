...
class OFBsnTlvDataVer14 implements OFBsnTlvData {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnTlvDataVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnTlvDataVer14 DEFAULT = new OFBsnTlvDataVer14(
        DEFAULT_VALUE
    );
    ...
    static class BuilderWithParent implements OFBsnTlvData.Builder {
        final OFBsnTlvDataVer14 parentMessage;

        // OF message fields
        private boolean valueSet;
        private byte[] value;

        BuilderWithParent(OFBsnTlvDataVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvData> {
        ...
        public OFBsnTlvData readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnTlvDataVer14 bsnTlvDataVer14 = new OFBsnTlvDataVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvDataVer14);
            return bsnTlvDataVer14;
        }
    }
    ...
    final static OFBsnTlvDataVer14Funnel FUNNEL = new OFBsnTlvDataVer14Funnel();
    static class OFBsnTlvDataVer14Funnel implements Funnel<OFBsnTlvDataVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnTlvDataVer14 message, PrimitiveSink sink) {
            // fixed value property type = 0x37
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvDataVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnTlvDataVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnTlvDataVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnTlvDataVer14 other = (OFBsnTlvDataVer14) obj;
