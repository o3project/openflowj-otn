...
class OFOxmIpv4SrcMaskedVer14 implements OFOxmIpv4SrcMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpv4SrcMaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmIpv4SrcMaskedVer14 DEFAULT = new OFOxmIpv4SrcMaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpv4SrcMaskedVer14(IPv4Address value, IPv4Address mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpv4SrcMaskedVer14: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmIpv4SrcMaskedVer14: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<IPv4Address> getCanonical() {
        if (IPv4Address.NO_MASK.equals(mask)) {
            return new OFOxmIpv4SrcVer14(value);
    ...
    static class BuilderWithParent implements OFOxmIpv4SrcMasked.Builder {
        final OFOxmIpv4SrcMaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmIpv4SrcMaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpv4SrcMasked> {
        ...
        public OFOxmIpv4SrcMasked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmIpv4SrcMaskedVer14 oxmIpv4SrcMaskedVer14 = new OFOxmIpv4SrcMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv4SrcMaskedVer14);
            return oxmIpv4SrcMaskedVer14;
        }
    }
    ...
    final static OFOxmIpv4SrcMaskedVer14Funnel FUNNEL = new OFOxmIpv4SrcMaskedVer14Funnel();
    static class OFOxmIpv4SrcMaskedVer14Funnel implements Funnel<OFOxmIpv4SrcMaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpv4SrcMaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80001708L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv4SrcMaskedVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmIpv4SrcMaskedVer14 message) {
            // fixed value property typeLen = 0x80001708L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpv4SrcMaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpv4SrcMaskedVer14 other = (OFOxmIpv4SrcMaskedVer14) obj;
