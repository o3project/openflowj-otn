...
class OFGroupAddVer14 implements OFGroupAdd {
    private static final Logger logger = LoggerFactory.getLogger(OFGroupAddVer14.class);
    // version: 1.4
...
//
    ...
    OFGroupAddVer14(long xid, OFGroupType groupType, OFGroup group, List<OFBucket> buckets) {
        if(groupType == null) {
            throw new NullPointerException("OFGroupAddVer14: property groupType cannot be null");
        }
        if(group == null) {
            throw new NullPointerException("OFGroupAddVer14: property group cannot be null");
        }
        if(buckets == null) {
            throw new NullPointerException("OFGroupAddVer14: property buckets cannot be null");
        }
        this.xid = xid;
    ...
    static class BuilderWithParent implements OFGroupAdd.Builder {
        final OFGroupAddVer14 parentMessage;
        ...
        BuilderWithParent(OFGroupAddVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFGroupAdd> {
        ...
        public OFGroupAdd readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", groupAddVer14);
            return groupAddVer14;
        }
    }
    ...
    final static OFGroupAddVer14Funnel FUNNEL = new OFGroupAddVer14Funnel();
    static class OFGroupAddVer14Funnel implements Funnel<OFGroupAddVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFGroupAddVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFGroupAddVer14> {
        @Override
        public void write(ChannelBuffer bb, OFGroupAddVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFGroupAddVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFGroupAddVer14 other = (OFGroupAddVer14) obj;
