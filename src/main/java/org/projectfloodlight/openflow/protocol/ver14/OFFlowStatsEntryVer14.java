...
class OFFlowStatsEntryVer14 implements OFFlowStatsEntry {
    private static final Logger logger = LoggerFactory.getLogger(OFFlowStatsEntryVer14.class);
    // version: 1.4
...
//
    ...
    final static OFFlowStatsEntryVer14 DEFAULT = new OFFlowStatsEntryVer14(
        DEFAULT_TABLE_ID, DEFAULT_DURATION_SEC, DEFAULT_DURATION_NSEC, DEFAULT_PRIORITY, DEFAULT_IDLE_TIMEOUT, DEFAULT_HARD_TIMEOUT, DEFAULT_FLAGS, DEFAULT_IMPORTANCE, DEFAULT_COOKIE, DEFAULT_PACKET_COUNT, DEFAULT_BYTE_COUNT, DEFAULT_MATCH, DEFAULT_INSTRUCTIONS
    );
    ...
    static class BuilderWithParent implements OFFlowStatsEntry.Builder {
        final OFFlowStatsEntryVer14 parentMessage;
        ...
        BuilderWithParent(OFFlowStatsEntryVer14 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFFlowStatsEntry build() {
                ...
                //
                return new OFFlowStatsEntryVer14(
                    tableId,
                    durationSec,
                    durationNsec,
                    priority,
...
//
    ...
    static class Reader implements OFMessageReader<OFFlowStatsEntry> {
        ...
        public OFFlowStatsEntry readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", flowStatsEntryVer14);
    ...
    final static OFFlowStatsEntryVer14Funnel FUNNEL = new OFFlowStatsEntryVer14Funnel();
    static class OFFlowStatsEntryVer14Funnel implements Funnel<OFFlowStatsEntryVer14> {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFFlowStatsEntryVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFFlowStatsEntryVer14 other = (OFFlowStatsEntryVer14) obj;
