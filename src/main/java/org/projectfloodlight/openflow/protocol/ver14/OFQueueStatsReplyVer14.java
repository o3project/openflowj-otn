...
class OFQueueStatsReplyVer14 implements OFQueueStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFQueueStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFQueueStatsReplyVer14 DEFAULT = new OFQueueStatsReplyVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFQueueStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, List<OFQueueStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFQueueStatsReplyVer14: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFQueueStatsReplyVer14: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFQueueStatsReply.Builder {
        final OFQueueStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFQueueStatsReplyVer14 parentMessage) {
    ...
    public OFQueueStatsReply.Builder setEntries(List<OFQueueStatsEntry> entries) {
        ...
        public OFQueueStatsReply build() {
                ...
                //
                return new OFQueueStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFQueueStatsReply> {
        ...
        public OFQueueStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            // pad: 4 bytes
            bb.skipBytes(4);
            List<OFQueueStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFQueueStatsEntryVer14.READER);

            OFQueueStatsReplyVer14 queueStatsReplyVer14 = new OFQueueStatsReplyVer14(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", queueStatsReplyVer14);
            return queueStatsReplyVer14;
        }
    }
    ...
    final static OFQueueStatsReplyVer14Funnel FUNNEL = new OFQueueStatsReplyVer14Funnel();
    static class OFQueueStatsReplyVer14Funnel implements Funnel<OFQueueStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFQueueStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFQueueStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFQueueStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFQueueStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFQueueStatsReplyVer14 other = (OFQueueStatsReplyVer14) obj;
