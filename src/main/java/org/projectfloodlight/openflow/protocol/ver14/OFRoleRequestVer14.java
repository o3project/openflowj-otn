...
class OFRoleRequestVer14 implements OFRoleRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFRoleRequestVer14.class);
    // version: 1.4
...
//
    ...
    OFRoleRequestVer14(long xid, OFControllerRole role, U64 generationId) {
        if(role == null) {
            throw new NullPointerException("OFRoleRequestVer14: property role cannot be null");
        }
        if(generationId == null) {
            throw new NullPointerException("OFRoleRequestVer14: property generationId cannot be null");
        }
        this.xid = xid;
        this.role = role;
    ...
    static class BuilderWithParent implements OFRoleRequest.Builder {
        final OFRoleRequestVer14 parentMessage;
        ...
        BuilderWithParent(OFRoleRequestVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFRoleRequest> {
        ...
        public OFRoleRequest readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFRoleRequestVer14 roleRequestVer14 = new OFRoleRequestVer14(
                    xid,
                      role,
                      generationId
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", roleRequestVer14);
            return roleRequestVer14;
        }
    }
    ...
    final static OFRoleRequestVer14Funnel FUNNEL = new OFRoleRequestVer14Funnel();
    static class OFRoleRequestVer14Funnel implements Funnel<OFRoleRequestVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFRoleRequestVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFRoleRequestVer14> {
        @Override
        public void write(ChannelBuffer bb, OFRoleRequestVer14 message) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFRoleRequestVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFRoleRequestVer14 other = (OFRoleRequestVer14) obj;
