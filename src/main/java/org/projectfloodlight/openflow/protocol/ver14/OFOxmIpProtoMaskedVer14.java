...
class OFOxmIpProtoMaskedVer14 implements OFOxmIpProtoMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpProtoMaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmIpProtoMaskedVer14 DEFAULT = new OFOxmIpProtoMaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpProtoMaskedVer14(IpProtocol value, IpProtocol mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpProtoMaskedVer14: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmIpProtoMaskedVer14: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<IpProtocol> getCanonical() {
        if (IpProtocol.NO_MASK.equals(mask)) {
            return new OFOxmIpProtoVer14(value);
    ...
    static class BuilderWithParent implements OFOxmIpProtoMasked.Builder {
        final OFOxmIpProtoMaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmIpProtoMaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpProtoMasked> {
        ...
        public OFOxmIpProtoMasked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmIpProtoMaskedVer14 oxmIpProtoMaskedVer14 = new OFOxmIpProtoMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpProtoMaskedVer14);
            return oxmIpProtoMaskedVer14;
        }
    }
    ...
    final static OFOxmIpProtoMaskedVer14Funnel FUNNEL = new OFOxmIpProtoMaskedVer14Funnel();
    static class OFOxmIpProtoMaskedVer14Funnel implements Funnel<OFOxmIpProtoMaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpProtoMaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80001502L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpProtoMaskedVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmIpProtoMaskedVer14 message) {
            // fixed value property typeLen = 0x80001502L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpProtoMaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpProtoMaskedVer14 other = (OFOxmIpProtoMaskedVer14) obj;
