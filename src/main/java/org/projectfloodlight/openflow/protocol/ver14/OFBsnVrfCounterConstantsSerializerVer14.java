...
public class OFBsnVrfCounterConstantsSerializerVer14 {
    ...
    public static OFBsnVrfCounterConstants ofWireValue(int val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnVrfCounterConstants in version 1.4: " + val);
        }
    }
    ...
    public static int toWireValue(OFBsnVrfCounterConstants e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnVrfCounterConstants in version 1.4: " + e);
        }
    }
