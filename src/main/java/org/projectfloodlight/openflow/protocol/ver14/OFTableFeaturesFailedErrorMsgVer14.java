...
class OFTableFeaturesFailedErrorMsgVer14 implements OFTableFeaturesFailedErrorMsg {
    private static final Logger logger = LoggerFactory.getLogger(OFTableFeaturesFailedErrorMsgVer14.class);
    // version: 1.4
...
//
    ...
    OFTableFeaturesFailedErrorMsgVer14(long xid, OFTableFeaturesFailedCode code, OFErrorCauseData data) {
        if(code == null) {
            throw new NullPointerException("OFTableFeaturesFailedErrorMsgVer14: property code cannot be null");
        }
        if(data == null) {
    ...
    static class BuilderWithParent implements OFTableFeaturesFailedErrorMsg.Builder {
        final OFTableFeaturesFailedErrorMsgVer14 parentMessage;
        ...
        BuilderWithParent(OFTableFeaturesFailedErrorMsgVer14 parentMessage) {
    ...
    public OFTableFeaturesFailedErrorMsg.Builder setData(OFErrorCauseData data) {
        ...
        public OFTableFeaturesFailedErrorMsg build() {
                ...
                //
                return new OFTableFeaturesFailedErrorMsgVer14(
                    xid,
                    code,
                    data
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFTableFeaturesFailedErrorMsg> {
        ...
        public OFTableFeaturesFailedErrorMsg readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFTableFeaturesFailedCode code = OFTableFeaturesFailedCodeSerializerVer14.readFrom(bb);
            OFErrorCauseData data = OFErrorCauseData.read(bb, length - (bb.readerIndex() - start), OFVersion.OF_14);

            OFTableFeaturesFailedErrorMsgVer14 tableFeaturesFailedErrorMsgVer14 = new OFTableFeaturesFailedErrorMsgVer14(
                    xid,
                      code,
                      data
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", tableFeaturesFailedErrorMsgVer14);
            return tableFeaturesFailedErrorMsgVer14;
        }
    }
    ...
    final static OFTableFeaturesFailedErrorMsgVer14Funnel FUNNEL = new OFTableFeaturesFailedErrorMsgVer14Funnel();
    static class OFTableFeaturesFailedErrorMsgVer14Funnel implements Funnel<OFTableFeaturesFailedErrorMsgVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFTableFeaturesFailedErrorMsgVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
            ...
            OFTableFeaturesFailedCodeSerializerVer14.putTo(message.code, sink);
    ...
    static class Writer implements OFMessageWriter<OFTableFeaturesFailedErrorMsgVer14> {
        @Override
        public void write(ChannelBuffer bb, OFTableFeaturesFailedErrorMsgVer14 message) {
            ...
            OFTableFeaturesFailedCodeSerializerVer14.writeTo(bb, message.code);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFTableFeaturesFailedErrorMsgVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFTableFeaturesFailedErrorMsgVer14 other = (OFTableFeaturesFailedErrorMsgVer14) obj;
