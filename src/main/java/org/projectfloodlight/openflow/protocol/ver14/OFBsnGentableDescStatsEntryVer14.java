...
class OFBsnGentableDescStatsEntryVer14 implements OFBsnGentableDescStatsEntry {
...
//
    ...
    static class BuilderWithParent implements OFBsnGentableDescStatsEntry.Builder {
        ...
        BuilderWithParent(OFBsnGentableDescStatsEntryVer14 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFBsnGentableDescStatsEntry build() {
                ...
                //
                return new OFBsnGentableDescStatsEntryVer14(
                    tableId,
                    name,
                    bucketsSize,
                    maxEntries
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableDescStatsEntry> {
        ...
        public OFBsnGentableDescStatsEntry readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnGentableDescStatsEntryVer14 bsnGentableDescStatsEntryVer14 = new OFBsnGentableDescStatsEntryVer14(
                    tableId,
                      name,
                      bucketsSize,
                      maxEntries
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableDescStatsEntryVer14);
            return bsnGentableDescStatsEntryVer14;
        }
    }
    ...
    final static OFBsnGentableDescStatsEntryVer14Funnel FUNNEL = new OFBsnGentableDescStatsEntryVer14Funnel();
    static class OFBsnGentableDescStatsEntryVer14Funnel implements Funnel<OFBsnGentableDescStatsEntryVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableDescStatsEntryVer14 message, PrimitiveSink sink) {
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableDescStatsEntryVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnGentableDescStatsEntryVer14 message) {
            // fixed value property length = 48
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableDescStatsEntryVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableDescStatsEntryVer14 other = (OFBsnGentableDescStatsEntryVer14) obj;
