...
class OFBsnGentableClearReplyVer14 implements OFBsnGentableClearReply {
...
//
    ...
    public OFBsnGentableClearReply.Builder setErrorCount(long errorCount) {
        ...
        public OFBsnGentableClearReply build() {
                ...
                //
                return new OFBsnGentableClearReplyVer14(
                    xid,
                    tableId,
                    deletedCount,
                    errorCount
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableClearReply> {
        ...
        public OFBsnGentableClearReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnGentableClearReplyVer14 bsnGentableClearReplyVer14 = new OFBsnGentableClearReplyVer14(
                    xid,
                      tableId,
                      deletedCount,
                      errorCount
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableClearReplyVer14);
    ...
    final static OFBsnGentableClearReplyVer14Funnel FUNNEL = new OFBsnGentableClearReplyVer14Funnel();
    static class OFBsnGentableClearReplyVer14Funnel implements Funnel<OFBsnGentableClearReplyVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableClearReplyVer14> {
        @Override
