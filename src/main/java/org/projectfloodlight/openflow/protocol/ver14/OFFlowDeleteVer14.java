...
class OFFlowDeleteVer14 implements OFFlowDelete {
    private static final Logger logger = LoggerFactory.getLogger(OFFlowDeleteVer14.class);
    // version: 1.4
...
//
    ...
    final static OFFlowDeleteVer14 DEFAULT = new OFFlowDeleteVer14(
    ...
    OFFlowDeleteVer14(long xid, U64 cookie, U64 cookieMask, TableId tableId, int idleTimeout, int hardTimeout, int priority, OFBufferId bufferId, OFPort outPort, OFGroup outGroup, Set<OFFlowModFlags> flags, int importance, Match match, List<OFInstruction> instructions) {
        if(cookie == null) {
            throw new NullPointerException("OFFlowDeleteVer14: property cookie cannot be null");
        }
        if(cookieMask == null) {
            throw new NullPointerException("OFFlowDeleteVer14: property cookieMask cannot be null");
        }
        if(tableId == null) {
            throw new NullPointerException("OFFlowDeleteVer14: property tableId cannot be null");
        }
        if(bufferId == null) {
            throw new NullPointerException("OFFlowDeleteVer14: property bufferId cannot be null");
        }
        if(outPort == null) {
            throw new NullPointerException("OFFlowDeleteVer14: property outPort cannot be null");
        }
        if(outGroup == null) {
            throw new NullPointerException("OFFlowDeleteVer14: property outGroup cannot be null");
        }
        if(flags == null) {
            throw new NullPointerException("OFFlowDeleteVer14: property flags cannot be null");
        }
        if(match == null) {
            throw new NullPointerException("OFFlowDeleteVer14: property match cannot be null");
        }
        if(instructions == null) {
            throw new NullPointerException("OFFlowDeleteVer14: property instructions cannot be null");
        }
        this.xid = xid;
        this.cookie = cookie;
    ...
    static class BuilderWithParent implements OFFlowDelete.Builder {
        final OFFlowDeleteVer14 parentMessage;
        ...
        BuilderWithParent(OFFlowDeleteVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFFlowDelete> {
        ...
        public OFFlowDelete readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFFlowDeleteVer14 flowDeleteVer14 = new OFFlowDeleteVer14(
                    xid,
                      cookie,
                      cookieMask,
                      tableId,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", flowDeleteVer14);
            return flowDeleteVer14;
        }
    }
    ...
    final static OFFlowDeleteVer14Funnel FUNNEL = new OFFlowDeleteVer14Funnel();
    static class OFFlowDeleteVer14Funnel implements Funnel<OFFlowDeleteVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFFlowDeleteVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFFlowDeleteVer14> {
        @Override
        public void write(ChannelBuffer bb, OFFlowDeleteVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFFlowDeleteVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFFlowDeleteVer14 other = (OFFlowDeleteVer14) obj;
