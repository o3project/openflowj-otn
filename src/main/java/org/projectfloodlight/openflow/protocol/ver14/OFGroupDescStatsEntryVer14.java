...
class OFGroupDescStatsEntryVer14 implements OFGroupDescStatsEntry {
...
//
    ...
    public OFVersion getVersion() {
        ...
        public OFGroupDescStatsEntry build() {
                ...
                //
                return new OFGroupDescStatsEntryVer14(
                    groupType,
                    group,
                    buckets
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFGroupDescStatsEntry> {
        ...
        public OFGroupDescStatsEntry readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", groupDescStatsEntryVer14);
    ...
    final static OFGroupDescStatsEntryVer14Funnel FUNNEL = new OFGroupDescStatsEntryVer14Funnel();
    static class OFGroupDescStatsEntryVer14Funnel implements Funnel<OFGroupDescStatsEntryVer14> {
    ...
    static class Writer implements OFMessageWriter<OFGroupDescStatsEntryVer14> {
        @Override
        public void write(ChannelBuffer bb, OFGroupDescStatsEntryVer14 message) {
