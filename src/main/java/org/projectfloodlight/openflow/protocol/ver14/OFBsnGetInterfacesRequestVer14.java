...
class OFBsnGetInterfacesRequestVer14 implements OFBsnGetInterfacesRequest {
...
//
    ...
    final static OFBsnGetInterfacesRequestVer14 DEFAULT = new OFBsnGetInterfacesRequestVer14(
        DEFAULT_XID
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGetInterfacesRequest> {
        ...
        public OFBsnGetInterfacesRequest readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnGetInterfacesRequestVer14 bsnGetInterfacesRequestVer14 = new OFBsnGetInterfacesRequestVer14(
                    xid
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGetInterfacesRequestVer14);
    ...
    final static OFBsnGetInterfacesRequestVer14Funnel FUNNEL = new OFBsnGetInterfacesRequestVer14Funnel();
    static class OFBsnGetInterfacesRequestVer14Funnel implements Funnel<OFBsnGetInterfacesRequestVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnGetInterfacesRequestVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnGetInterfacesRequestVer14 message) {
            // fixed value property version = 5
