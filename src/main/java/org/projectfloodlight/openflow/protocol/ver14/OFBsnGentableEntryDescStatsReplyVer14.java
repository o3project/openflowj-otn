...
class OFBsnGentableEntryDescStatsReplyVer14 implements OFBsnGentableEntryDescStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableEntryDescStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnGentableEntryDescStatsReplyVer14 DEFAULT = new OFBsnGentableEntryDescStatsReplyVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnGentableEntryDescStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnGentableEntryDescStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnGentableEntryDescStatsReplyVer14: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFBsnGentableEntryDescStatsReplyVer14: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFBsnGentableEntryDescStatsReply.Builder {
        final OFBsnGentableEntryDescStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableEntryDescStatsReplyVer14 parentMessage) {
    ...
    public OFBsnGentableEntryDescStatsReply.Builder setEntries(List<OFBsnGentableEntryDescStatsEntry> entries) {
        ...
        public OFBsnGentableEntryDescStatsReply build() {
                ...
                //
                return new OFBsnGentableEntryDescStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableEntryDescStatsReply> {
        ...
        public OFBsnGentableEntryDescStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            List<OFBsnGentableEntryDescStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFBsnGentableEntryDescStatsEntryVer14.READER);

            OFBsnGentableEntryDescStatsReplyVer14 bsnGentableEntryDescStatsReplyVer14 = new OFBsnGentableEntryDescStatsReplyVer14(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableEntryDescStatsReplyVer14);
            return bsnGentableEntryDescStatsReplyVer14;
        }
    }
    ...
    final static OFBsnGentableEntryDescStatsReplyVer14Funnel FUNNEL = new OFBsnGentableEntryDescStatsReplyVer14Funnel();
    static class OFBsnGentableEntryDescStatsReplyVer14Funnel implements Funnel<OFBsnGentableEntryDescStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableEntryDescStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableEntryDescStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnGentableEntryDescStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableEntryDescStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableEntryDescStatsReplyVer14 other = (OFBsnGentableEntryDescStatsReplyVer14) obj;
