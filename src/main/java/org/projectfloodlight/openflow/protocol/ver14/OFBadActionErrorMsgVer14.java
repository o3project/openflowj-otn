...
class OFBadActionErrorMsgVer14 implements OFBadActionErrorMsg {
    private static final Logger logger = LoggerFactory.getLogger(OFBadActionErrorMsgVer14.class);
    // version: 1.4
...
//
    ...
    OFBadActionErrorMsgVer14(long xid, OFBadActionCode code, OFErrorCauseData data) {
        if(code == null) {
            throw new NullPointerException("OFBadActionErrorMsgVer14: property code cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFBadActionErrorMsgVer14: property data cannot be null");
        }
        this.xid = xid;
        this.code = code;
        this.data = data;
    ...
    static class BuilderWithParent implements OFBadActionErrorMsg.Builder {
        final OFBadActionErrorMsgVer14 parentMessage;
        ...
        BuilderWithParent(OFBadActionErrorMsgVer14 parentMessage) {
    ...
    public OFBadActionErrorMsg.Builder setData(OFErrorCauseData data) {
        ...
        public OFBadActionErrorMsg build() {
                ...
                //
                return new OFBadActionErrorMsgVer14(
                    xid,
                    code,
                    data
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBadActionErrorMsg> {
        ...
        public OFBadActionErrorMsg readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBadActionCode code = OFBadActionCodeSerializerVer14.readFrom(bb);
            OFErrorCauseData data = OFErrorCauseData.read(bb, length - (bb.readerIndex() - start), OFVersion.OF_14);

            OFBadActionErrorMsgVer14 badActionErrorMsgVer14 = new OFBadActionErrorMsgVer14(
                    xid,
                      code,
                      data
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", badActionErrorMsgVer14);
            return badActionErrorMsgVer14;
        }
    }
    ...
    final static OFBadActionErrorMsgVer14Funnel FUNNEL = new OFBadActionErrorMsgVer14Funnel();
    static class OFBadActionErrorMsgVer14Funnel implements Funnel<OFBadActionErrorMsgVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBadActionErrorMsgVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
            ...
            OFBadActionCodeSerializerVer14.putTo(message.code, sink);
    ...
    static class Writer implements OFMessageWriter<OFBadActionErrorMsgVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBadActionErrorMsgVer14 message) {
            ...
            OFBadActionCodeSerializerVer14.writeTo(bb, message.code);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBadActionErrorMsgVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBadActionErrorMsgVer14 other = (OFBadActionErrorMsgVer14) obj;
