...
class OFOxmBsnTcpFlagsVer14 implements OFOxmBsnTcpFlags {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnTcpFlagsVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmBsnTcpFlagsVer14 DEFAULT = new OFOxmBsnTcpFlagsVer14(
        DEFAULT_VALUE
    );
    ...
    static class BuilderWithParent implements OFOxmBsnTcpFlags.Builder {
        final OFOxmBsnTcpFlagsVer14 parentMessage;

        // OF message fields
        private boolean valueSet;
        private U16 value;

        BuilderWithParent(OFOxmBsnTcpFlagsVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnTcpFlags> {
        ...
        public OFOxmBsnTcpFlags readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmBsnTcpFlagsVer14 oxmBsnTcpFlagsVer14 = new OFOxmBsnTcpFlagsVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnTcpFlagsVer14);
            return oxmBsnTcpFlagsVer14;
        }
    }
    ...
    final static OFOxmBsnTcpFlagsVer14Funnel FUNNEL = new OFOxmBsnTcpFlagsVer14Funnel();
    static class OFOxmBsnTcpFlagsVer14Funnel implements Funnel<OFOxmBsnTcpFlagsVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnTcpFlagsVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x32002L
            sink.putInt(0x32002);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnTcpFlagsVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmBsnTcpFlagsVer14 message) {
            // fixed value property typeLen = 0x32002L
            bb.writeInt(0x32002);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnTcpFlagsVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnTcpFlagsVer14 other = (OFOxmBsnTcpFlagsVer14) obj;
