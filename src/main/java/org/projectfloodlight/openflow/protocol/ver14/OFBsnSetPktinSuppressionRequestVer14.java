...
class OFBsnSetPktinSuppressionRequestVer14 implements OFBsnSetPktinSuppressionRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnSetPktinSuppressionRequestVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnSetPktinSuppressionRequestVer14 DEFAULT = new OFBsnSetPktinSuppressionRequestVer14(
        DEFAULT_XID, DEFAULT_ENABLED, DEFAULT_IDLE_TIMEOUT, DEFAULT_HARD_TIMEOUT, DEFAULT_PRIORITY, DEFAULT_COOKIE
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnSetPktinSuppressionRequestVer14(long xid, boolean enabled, int idleTimeout, int hardTimeout, int priority, U64 cookie) {
        if(cookie == null) {
            throw new NullPointerException("OFBsnSetPktinSuppressionRequestVer14: property cookie cannot be null");
        }
        this.xid = xid;
    ...
    static class BuilderWithParent implements OFBsnSetPktinSuppressionRequest.Builder {
        final OFBsnSetPktinSuppressionRequestVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnSetPktinSuppressionRequestVer14 parentMessage) {
    ...
    public OFBsnSetPktinSuppressionRequest.Builder setCookie(U64 cookie) {
        ...
        public OFBsnSetPktinSuppressionRequest build() {
                ...
                //
                return new OFBsnSetPktinSuppressionRequestVer14(
                    xid,
                    enabled,
                    idleTimeout,
                    hardTimeout,
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnSetPktinSuppressionRequest> {
        ...
        public OFBsnSetPktinSuppressionRequest readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnSetPktinSuppressionRequestVer14 bsnSetPktinSuppressionRequestVer14 = new OFBsnSetPktinSuppressionRequestVer14(
                    xid,
                      enabled,
                      idleTimeout,
                      hardTimeout,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnSetPktinSuppressionRequestVer14);
            return bsnSetPktinSuppressionRequestVer14;
        }
    }
    ...
    final static OFBsnSetPktinSuppressionRequestVer14Funnel FUNNEL = new OFBsnSetPktinSuppressionRequestVer14Funnel();
    static class OFBsnSetPktinSuppressionRequestVer14Funnel implements Funnel<OFBsnSetPktinSuppressionRequestVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnSetPktinSuppressionRequestVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnSetPktinSuppressionRequestVer14 message) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnSetPktinSuppressionRequestVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnSetPktinSuppressionRequestVer14 other = (OFBsnSetPktinSuppressionRequestVer14) obj;
