...
class OFBsnVrfCounterStatsReplyVer14 implements OFBsnVrfCounterStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnVrfCounterStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnVrfCounterStatsReplyVer14 DEFAULT = new OFBsnVrfCounterStatsReplyVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnVrfCounterStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnVrfCounterStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnVrfCounterStatsReplyVer14: property flags cannot be null");
        }
        if(entries == null) {
    ...
    static class BuilderWithParent implements OFBsnVrfCounterStatsReply.Builder {
        final OFBsnVrfCounterStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnVrfCounterStatsReplyVer14 parentMessage) {
    ...
    public OFBsnVrfCounterStatsReply.Builder setEntries(List<OFBsnVrfCounterStatsEntry> entries) {
        ...
        public OFBsnVrfCounterStatsReply build() {
                ...
                //
                return new OFBsnVrfCounterStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnVrfCounterStatsReply> {
        ...
        public OFBsnVrfCounterStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            List<OFBsnVrfCounterStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFBsnVrfCounterStatsEntryVer14.READER);

            OFBsnVrfCounterStatsReplyVer14 bsnVrfCounterStatsReplyVer14 = new OFBsnVrfCounterStatsReplyVer14(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnVrfCounterStatsReplyVer14);
            return bsnVrfCounterStatsReplyVer14;
        }
    }
    ...
    final static OFBsnVrfCounterStatsReplyVer14Funnel FUNNEL = new OFBsnVrfCounterStatsReplyVer14Funnel();
    static class OFBsnVrfCounterStatsReplyVer14Funnel implements Funnel<OFBsnVrfCounterStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnVrfCounterStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnVrfCounterStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnVrfCounterStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnVrfCounterStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnVrfCounterStatsReplyVer14 other = (OFBsnVrfCounterStatsReplyVer14) obj;
