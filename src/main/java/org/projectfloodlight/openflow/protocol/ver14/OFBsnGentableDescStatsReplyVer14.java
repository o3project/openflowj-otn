...
class OFBsnGentableDescStatsReplyVer14 implements OFBsnGentableDescStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableDescStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnGentableDescStatsReplyVer14 DEFAULT = new OFBsnGentableDescStatsReplyVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnGentableDescStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnGentableDescStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnGentableDescStatsReplyVer14: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFBsnGentableDescStatsReplyVer14: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFBsnGentableDescStatsReply.Builder {
        final OFBsnGentableDescStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableDescStatsReplyVer14 parentMessage) {
    ...
    public OFBsnGentableDescStatsReply.Builder setEntries(List<OFBsnGentableDescStatsEntry> entries) {
        ...
        public OFBsnGentableDescStatsReply build() {
                ...
                //
                return new OFBsnGentableDescStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableDescStatsReply> {
        ...
        public OFBsnGentableDescStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            List<OFBsnGentableDescStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFBsnGentableDescStatsEntryVer14.READER);

            OFBsnGentableDescStatsReplyVer14 bsnGentableDescStatsReplyVer14 = new OFBsnGentableDescStatsReplyVer14(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableDescStatsReplyVer14);
            return bsnGentableDescStatsReplyVer14;
        }
    }
    ...
    final static OFBsnGentableDescStatsReplyVer14Funnel FUNNEL = new OFBsnGentableDescStatsReplyVer14Funnel();
    static class OFBsnGentableDescStatsReplyVer14Funnel implements Funnel<OFBsnGentableDescStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableDescStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableDescStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnGentableDescStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableDescStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableDescStatsReplyVer14 other = (OFBsnGentableDescStatsReplyVer14) obj;
