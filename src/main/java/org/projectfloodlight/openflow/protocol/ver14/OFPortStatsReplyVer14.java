...
class OFPortStatsReplyVer14 implements OFPortStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFPortStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFPortStatsReplyVer14 DEFAULT = new OFPortStatsReplyVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFPortStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, List<OFPortStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFPortStatsReplyVer14: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFPortStatsReplyVer14: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFPortStatsReply.Builder {
        final OFPortStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFPortStatsReplyVer14 parentMessage) {
    ...
    public OFPortStatsReply.Builder setEntries(List<OFPortStatsEntry> entries) {
        ...
        public OFPortStatsReply build() {
                ...
                //
                return new OFPortStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFPortStatsReply> {
        ...
        public OFPortStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            // pad: 4 bytes
            bb.skipBytes(4);
            List<OFPortStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFPortStatsEntryVer14.READER);

            OFPortStatsReplyVer14 portStatsReplyVer14 = new OFPortStatsReplyVer14(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", portStatsReplyVer14);
            return portStatsReplyVer14;
        }
    }
    ...
    final static OFPortStatsReplyVer14Funnel FUNNEL = new OFPortStatsReplyVer14Funnel();
    static class OFPortStatsReplyVer14Funnel implements Funnel<OFPortStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFPortStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFPortStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFPortStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFPortStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFPortStatsReplyVer14 other = (OFPortStatsReplyVer14) obj;
