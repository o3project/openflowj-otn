...
class OFPortDescStatsReplyVer14 implements OFPortDescStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFPortDescStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFPortDescStatsReplyVer14 DEFAULT = new OFPortDescStatsReplyVer14(
    ...
    static class BuilderWithParent implements OFPortDescStatsReply.Builder {
        final OFPortDescStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFPortDescStatsReplyVer14 parentMessage) {
    ...
    public OFPortDescStatsReply.Builder setEntries(List<OFPortDesc> entries) {
        ...
        public OFPortDescStatsReply build() {
                ...
                //
                return new OFPortDescStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFPortDescStatsReply> {
        ...
        public OFPortDescStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            // pad: 4 bytes
            bb.skipBytes(4);
            List<OFPortDesc> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFPortDescVer14.READER);

            OFPortDescStatsReplyVer14 portDescStatsReplyVer14 = new OFPortDescStatsReplyVer14(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", portDescStatsReplyVer14);
            return portDescStatsReplyVer14;
        }
    }
    ...
    final static OFPortDescStatsReplyVer14Funnel FUNNEL = new OFPortDescStatsReplyVer14Funnel();
    static class OFPortDescStatsReplyVer14Funnel implements Funnel<OFPortDescStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFPortDescStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFPortDescStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFPortDescStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFPortDescStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFPortDescStatsReplyVer14 other = (OFPortDescStatsReplyVer14) obj;
