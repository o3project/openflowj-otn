...
class OFBsnSetLacpReplyVer14 implements OFBsnSetLacpReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnSetLacpReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnSetLacpReplyVer14 DEFAULT = new OFBsnSetLacpReplyVer14(
        DEFAULT_XID, DEFAULT_STATUS, DEFAULT_PORT_NO
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnSetLacpReplyVer14(long xid, long status, OFPort portNo) {
        if(portNo == null) {
    ...
    static class BuilderWithParent implements OFBsnSetLacpReply.Builder {
        final OFBsnSetLacpReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnSetLacpReplyVer14 parentMessage) {
    ...
    public OFBsnSetLacpReply.Builder setPortNo(OFPort portNo) {
        ...
        public OFBsnSetLacpReply build() {
                ...
                //
                return new OFBsnSetLacpReplyVer14(
                    xid,
                    status,
                    portNo
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnSetLacpReply> {
        ...
        public OFBsnSetLacpReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnSetLacpReplyVer14 bsnSetLacpReplyVer14 = new OFBsnSetLacpReplyVer14(
                    xid,
                      status,
                      portNo
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnSetLacpReplyVer14);
    ...
    final static OFBsnSetLacpReplyVer14Funnel FUNNEL = new OFBsnSetLacpReplyVer14Funnel();
    static class OFBsnSetLacpReplyVer14Funnel implements Funnel<OFBsnSetLacpReplyVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnSetLacpReplyVer14> {
        @Override
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnSetLacpReplyVer14(");
