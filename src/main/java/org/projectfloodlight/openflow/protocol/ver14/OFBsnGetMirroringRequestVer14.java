...
class OFBsnGetMirroringRequestVer14 implements OFBsnGetMirroringRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGetMirroringRequestVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnGetMirroringRequestVer14 DEFAULT = new OFBsnGetMirroringRequestVer14(
        DEFAULT_XID, DEFAULT_REPORT_MIRROR_PORTS
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnGetMirroringRequestVer14(long xid, short reportMirrorPorts) {
        this.xid = xid;
    ...
    static class BuilderWithParent implements OFBsnGetMirroringRequest.Builder {
        final OFBsnGetMirroringRequestVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnGetMirroringRequestVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGetMirroringRequest> {
        ...
        public OFBsnGetMirroringRequest readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnGetMirroringRequestVer14 bsnGetMirroringRequestVer14 = new OFBsnGetMirroringRequestVer14(
                    xid,
                      reportMirrorPorts
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGetMirroringRequestVer14);
            return bsnGetMirroringRequestVer14;
        }
    }
    ...
    final static OFBsnGetMirroringRequestVer14Funnel FUNNEL = new OFBsnGetMirroringRequestVer14Funnel();
    static class OFBsnGetMirroringRequestVer14Funnel implements Funnel<OFBsnGetMirroringRequestVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGetMirroringRequestVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnGetMirroringRequestVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnGetMirroringRequestVer14 message) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGetMirroringRequestVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGetMirroringRequestVer14 other = (OFBsnGetMirroringRequestVer14) obj;
