...
abstract class OFTableFeaturePropExperimenterVer14 {
    // version: 1.4
    final static byte WIRE_VERSION = 5;
    final static int MINIMUM_LENGTH = 12;


    public final static OFTableFeaturePropExperimenterVer14.Reader READER = new Reader();
    ...
    static class Reader implements OFMessageReader<OFTableFeaturePropExperimenter> {
        ...
        public OFTableFeaturePropExperimenter readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            switch(experimenter) {
               default:
                   throw new OFParseError("Unknown value for discriminator experimenter of class OFTableFeaturePropExperimenterVer14: " + experimenter);
            }
        }
    }
}
