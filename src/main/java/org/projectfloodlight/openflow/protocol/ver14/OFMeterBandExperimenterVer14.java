...
class OFMeterBandExperimenterVer14 implements OFMeterBandExperimenter {
...
//
    ...
    final static OFMeterBandExperimenterVer14 DEFAULT = new OFMeterBandExperimenterVer14(
        DEFAULT_RATE, DEFAULT_BURST_SIZE, DEFAULT_EXPERIMENTER
    );

    // package private constructor - used by readers, builders, and factory
    OFMeterBandExperimenterVer14(long rate, long burstSize, long experimenter) {
        this.rate = rate;
    ...
    static class BuilderWithParent implements OFMeterBandExperimenter.Builder {
        ...
        BuilderWithParent(OFMeterBandExperimenterVer14 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFMeterBandExperimenter build() {
                ...
                //
                return new OFMeterBandExperimenterVer14(
                    rate,
                    burstSize,
                    experimenter
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFMeterBandExperimenter> {
        ...
        public OFMeterBandExperimenter readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFMeterBandExperimenterVer14 meterBandExperimenterVer14 = new OFMeterBandExperimenterVer14(
                    rate,
                      burstSize,
                      experimenter
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", meterBandExperimenterVer14);
            return meterBandExperimenterVer14;
        }
    }
    ...
    final static OFMeterBandExperimenterVer14Funnel FUNNEL = new OFMeterBandExperimenterVer14Funnel();
    static class OFMeterBandExperimenterVer14Funnel implements Funnel<OFMeterBandExperimenterVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFMeterBandExperimenterVer14 message, PrimitiveSink sink) {
            // fixed value property type = 0xffff
    ...
    static class Writer implements OFMessageWriter<OFMeterBandExperimenterVer14> {
        @Override
        public void write(ChannelBuffer bb, OFMeterBandExperimenterVer14 message) {
            // fixed value property type = 0xffff
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFMeterBandExperimenterVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFMeterBandExperimenterVer14 other = (OFMeterBandExperimenterVer14) obj;
