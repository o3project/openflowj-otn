...
public class OFTableFeaturesFailedCodeSerializerVer14 {
    ...
    public static OFTableFeaturesFailedCode ofWireValue(short val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFTableFeaturesFailedCode in version 1.4: " + val);
        }
    }
    ...
    public static short toWireValue(OFTableFeaturesFailedCode e) {
        switch(e) {
            ...
            case EPERM:
                return EPERM_VAL;
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFTableFeaturesFailedCode in version 1.4: " + e);
        }
    }
