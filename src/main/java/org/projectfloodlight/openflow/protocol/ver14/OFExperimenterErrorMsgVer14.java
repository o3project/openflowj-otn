...
class OFExperimenterErrorMsgVer14 implements OFExperimenterErrorMsg {
    private static final Logger logger = LoggerFactory.getLogger(OFExperimenterErrorMsgVer14.class);
    // version: 1.4
...
//
    ...
    final static OFExperimenterErrorMsgVer14 DEFAULT = new OFExperimenterErrorMsgVer14(
        DEFAULT_XID, DEFAULT_SUBTYPE, DEFAULT_EXPERIMENTER, DEFAULT_DATA
    );

    // package private constructor - used by readers, builders, and factory
    OFExperimenterErrorMsgVer14(long xid, int subtype, long experimenter, OFErrorCauseData data) {
        if(data == null) {
            throw new NullPointerException("OFExperimenterErrorMsgVer14: property data cannot be null");
        }
        this.xid = xid;
    ...
    static class BuilderWithParent implements OFExperimenterErrorMsg.Builder {
        final OFExperimenterErrorMsgVer14 parentMessage;
        ...
        BuilderWithParent(OFExperimenterErrorMsgVer14 parentMessage) {
    ...
    public OFExperimenterErrorMsg.Builder setData(OFErrorCauseData data) {
        ...
        public OFExperimenterErrorMsg build() {
                ...
                //
                return new OFExperimenterErrorMsgVer14(
                    xid,
                    subtype,
                    experimenter,
                    data
...
//
    ...
    static class Reader implements OFMessageReader<OFExperimenterErrorMsg> {
        ...
        public OFExperimenterErrorMsg readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFExperimenterErrorMsgVer14 experimenterErrorMsgVer14 = new OFExperimenterErrorMsgVer14(
                    xid,
                      subtype,
                      experimenter,
                      data
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", experimenterErrorMsgVer14);
            return experimenterErrorMsgVer14;
        }
    }
    ...
    final static OFExperimenterErrorMsgVer14Funnel FUNNEL = new OFExperimenterErrorMsgVer14Funnel();
    static class OFExperimenterErrorMsgVer14Funnel implements Funnel<OFExperimenterErrorMsgVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFExperimenterErrorMsgVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFExperimenterErrorMsgVer14> {
        @Override
        public void write(ChannelBuffer bb, OFExperimenterErrorMsgVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFExperimenterErrorMsgVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFExperimenterErrorMsgVer14 other = (OFExperimenterErrorMsgVer14) obj;
