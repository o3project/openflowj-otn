...
class OFTableFeaturesStatsReplyVer14 implements OFTableFeaturesStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFTableFeaturesStatsReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFTableFeaturesStatsReplyVer14 DEFAULT = new OFTableFeaturesStatsReplyVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFTableFeaturesStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, List<OFTableFeatures> entries) {
        if(flags == null) {
            throw new NullPointerException("OFTableFeaturesStatsReplyVer14: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFTableFeaturesStatsReplyVer14: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFTableFeaturesStatsReply.Builder {
        final OFTableFeaturesStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFTableFeaturesStatsReplyVer14 parentMessage) {
    ...
    public OFTableFeaturesStatsReply.Builder setEntries(List<OFTableFeatures> entries) {
        ...
        public OFTableFeaturesStatsReply build() {
                ...
                //
                return new OFTableFeaturesStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFTableFeaturesStatsReply> {
        ...
        public OFTableFeaturesStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", tableFeaturesStatsReplyVer14);
            return tableFeaturesStatsReplyVer14;
        }
    }
    ...
    final static OFTableFeaturesStatsReplyVer14Funnel FUNNEL = new OFTableFeaturesStatsReplyVer14Funnel();
    static class OFTableFeaturesStatsReplyVer14Funnel implements Funnel<OFTableFeaturesStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFTableFeaturesStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFTableFeaturesStatsReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFTableFeaturesStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFTableFeaturesStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFTableFeaturesStatsReplyVer14 other = (OFTableFeaturesStatsReplyVer14) obj;
