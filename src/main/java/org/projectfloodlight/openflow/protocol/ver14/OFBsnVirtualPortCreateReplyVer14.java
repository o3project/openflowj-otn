...
class OFBsnVirtualPortCreateReplyVer14 implements OFBsnVirtualPortCreateReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnVirtualPortCreateReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnVirtualPortCreateReplyVer14 DEFAULT = new OFBsnVirtualPortCreateReplyVer14(
        DEFAULT_XID, DEFAULT_STATUS, DEFAULT_VPORT_NO
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnVirtualPortCreateReplyVer14(long xid, long status, long vportNo) {
        this.xid = xid;
        this.status = status;
    ...
    static class BuilderWithParent implements OFBsnVirtualPortCreateReply.Builder {
        final OFBsnVirtualPortCreateReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnVirtualPortCreateReplyVer14 parentMessage) {
    ...
    public OFBsnVirtualPortCreateReply.Builder setVportNo(long vportNo) {
        ...
        public OFBsnVirtualPortCreateReply build() {
                ...
                //
                return new OFBsnVirtualPortCreateReplyVer14(
                    xid,
                    status,
                    vportNo
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnVirtualPortCreateReply> {
        ...
        public OFBsnVirtualPortCreateReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnVirtualPortCreateReplyVer14 bsnVirtualPortCreateReplyVer14 = new OFBsnVirtualPortCreateReplyVer14(
                    xid,
                      status,
                      vportNo
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnVirtualPortCreateReplyVer14);
            return bsnVirtualPortCreateReplyVer14;
        }
    }
    ...
    final static OFBsnVirtualPortCreateReplyVer14Funnel FUNNEL = new OFBsnVirtualPortCreateReplyVer14Funnel();
    static class OFBsnVirtualPortCreateReplyVer14Funnel implements Funnel<OFBsnVirtualPortCreateReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnVirtualPortCreateReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnVirtualPortCreateReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnVirtualPortCreateReplyVer14 message) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnVirtualPortCreateReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnVirtualPortCreateReplyVer14 other = (OFBsnVirtualPortCreateReplyVer14) obj;
