...
class OFBsnGentableEntryDescStatsRequestVer14 implements OFBsnGentableEntryDescStatsRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGentableEntryDescStatsRequestVer14.class);
    // version: 1.4
...
//
    ...
    OFBsnGentableEntryDescStatsRequestVer14(long xid, Set<OFStatsRequestFlags> flags, GenTableId tableId, U128 checksum, U128 checksumMask) {
        if(flags == null) {
            throw new NullPointerException("OFBsnGentableEntryDescStatsRequestVer14: property flags cannot be null");
        }
        if(tableId == null) {
            throw new NullPointerException("OFBsnGentableEntryDescStatsRequestVer14: property tableId cannot be null");
        }
        if(checksum == null) {
            throw new NullPointerException("OFBsnGentableEntryDescStatsRequestVer14: property checksum cannot be null");
        }
    ...
    static class BuilderWithParent implements OFBsnGentableEntryDescStatsRequest.Builder {
        final OFBsnGentableEntryDescStatsRequestVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnGentableEntryDescStatsRequestVer14 parentMessage) {
    ...
    public OFBsnGentableEntryDescStatsRequest.Builder setChecksumMask(U128 checksumMask) {
        ...
        public OFBsnGentableEntryDescStatsRequest build() {
                ...
                //
                return new OFBsnGentableEntryDescStatsRequestVer14(
                    xid,
                    flags,
                    tableId,
                    checksum,
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGentableEntryDescStatsRequest> {
        ...
        public OFBsnGentableEntryDescStatsRequest readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnGentableEntryDescStatsRequestVer14 bsnGentableEntryDescStatsRequestVer14 = new OFBsnGentableEntryDescStatsRequestVer14(
                    xid,
                      flags,
                      tableId,
                      checksum,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGentableEntryDescStatsRequestVer14);
            return bsnGentableEntryDescStatsRequestVer14;
        }
    }
    ...
    final static OFBsnGentableEntryDescStatsRequestVer14Funnel FUNNEL = new OFBsnGentableEntryDescStatsRequestVer14Funnel();
    static class OFBsnGentableEntryDescStatsRequestVer14Funnel implements Funnel<OFBsnGentableEntryDescStatsRequestVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGentableEntryDescStatsRequestVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnGentableEntryDescStatsRequestVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnGentableEntryDescStatsRequestVer14 message) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGentableEntryDescStatsRequestVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGentableEntryDescStatsRequestVer14 other = (OFBsnGentableEntryDescStatsRequestVer14) obj;
