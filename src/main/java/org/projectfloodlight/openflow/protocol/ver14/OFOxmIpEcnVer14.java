...
class OFOxmIpEcnVer14 implements OFOxmIpEcn {
...
//
    ...
    final static OFOxmIpEcnVer14 DEFAULT = new OFOxmIpEcnVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpEcn> {
        ...
        public OFOxmIpEcn readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmIpEcnVer14 oxmIpEcnVer14 = new OFOxmIpEcnVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpEcnVer14);
    ...
    final static OFOxmIpEcnVer14Funnel FUNNEL = new OFOxmIpEcnVer14Funnel();
    static class OFOxmIpEcnVer14Funnel implements Funnel<OFOxmIpEcnVer14> {
    ...
    static class Writer implements OFMessageWriter<OFOxmIpEcnVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmIpEcnVer14 message) {
            // fixed value property typeLen = 0x80001201L
