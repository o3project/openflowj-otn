...
class OFBsnPduTxReplyVer14 implements OFBsnPduTxReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnPduTxReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnPduTxReplyVer14 DEFAULT = new OFBsnPduTxReplyVer14(
        DEFAULT_XID, DEFAULT_STATUS, DEFAULT_PORT_NO, DEFAULT_SLOT_NUM
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnPduTxReplyVer14(long xid, long status, OFPort portNo, short slotNum) {
        if(portNo == null) {
            throw new NullPointerException("OFBsnPduTxReplyVer14: property portNo cannot be null");
        }
        this.xid = xid;
        this.status = status;
        this.portNo = portNo;
    ...
    static class BuilderWithParent implements OFBsnPduTxReply.Builder {
        final OFBsnPduTxReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnPduTxReplyVer14 parentMessage) {
    ...
    public OFBsnPduTxReply.Builder setSlotNum(short slotNum) {
        ...
        public OFBsnPduTxReply build() {
                ...
                //
                return new OFBsnPduTxReplyVer14(
                    xid,
                    status,
                    portNo,
                    slotNum
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnPduTxReply> {
        ...
        public OFBsnPduTxReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnPduTxReplyVer14 bsnPduTxReplyVer14 = new OFBsnPduTxReplyVer14(
                    xid,
                      status,
                      portNo,
                      slotNum
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnPduTxReplyVer14);
            return bsnPduTxReplyVer14;
        }
    }
    ...
    final static OFBsnPduTxReplyVer14Funnel FUNNEL = new OFBsnPduTxReplyVer14Funnel();
    static class OFBsnPduTxReplyVer14Funnel implements Funnel<OFBsnPduTxReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnPduTxReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnPduTxReplyVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnPduTxReplyVer14 message) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnPduTxReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnPduTxReplyVer14 other = (OFBsnPduTxReplyVer14) obj;
