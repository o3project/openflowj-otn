...
class OFBsnPduTxRequestVer14 implements OFBsnPduTxRequest {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnPduTxRequestVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnPduTxRequestVer14 DEFAULT = new OFBsnPduTxRequestVer14(
        DEFAULT_XID, DEFAULT_TX_INTERVAL_MS, DEFAULT_PORT_NO, DEFAULT_SLOT_NUM, DEFAULT_DATA
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnPduTxRequestVer14(long xid, long txIntervalMs, OFPort portNo, short slotNum, byte[] data) {
        if(portNo == null) {
            throw new NullPointerException("OFBsnPduTxRequestVer14: property portNo cannot be null");
        }
        if(data == null) {
    ...
    static class BuilderWithParent implements OFBsnPduTxRequest.Builder {
        final OFBsnPduTxRequestVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnPduTxRequestVer14 parentMessage) {
    ...
    public OFBsnPduTxRequest.Builder setData(byte[] data) {
        ...
        public OFBsnPduTxRequest build() {
                ...
                //
                return new OFBsnPduTxRequestVer14(
                    xid,
                    txIntervalMs,
                    portNo,
                    slotNum,
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnPduTxRequest> {
        ...
        public OFBsnPduTxRequest readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnPduTxRequestVer14 bsnPduTxRequestVer14 = new OFBsnPduTxRequestVer14(
                    xid,
                      txIntervalMs,
                      portNo,
                      slotNum,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnPduTxRequestVer14);
            return bsnPduTxRequestVer14;
        }
    }
    ...
    final static OFBsnPduTxRequestVer14Funnel FUNNEL = new OFBsnPduTxRequestVer14Funnel();
    static class OFBsnPduTxRequestVer14Funnel implements Funnel<OFBsnPduTxRequestVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnPduTxRequestVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnPduTxRequestVer14> {
        @Override
        public void write(ChannelBuffer bb, OFBsnPduTxRequestVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnPduTxRequestVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnPduTxRequestVer14 other = (OFBsnPduTxRequestVer14) obj;
