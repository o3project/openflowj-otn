...
//
    ...
    OFTableStatsReplyVer13(long xid, Set<OFStatsReplyFlags> flags, List<OFTableStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFTableStatsReplyVer13: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFTableStatsReplyVer13: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
