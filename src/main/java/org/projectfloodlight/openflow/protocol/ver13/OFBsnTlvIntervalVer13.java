...
class OFBsnTlvIntervalVer13 implements OFBsnTlvInterval {
...
//
    ...
    final static OFBsnTlvIntervalVer13 DEFAULT = new OFBsnTlvIntervalVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvInterval> {
        ...
        public OFBsnTlvInterval readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnTlvIntervalVer13 bsnTlvIntervalVer13 = new OFBsnTlvIntervalVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvIntervalVer13);
    ...
    final static OFBsnTlvIntervalVer13Funnel FUNNEL = new OFBsnTlvIntervalVer13Funnel();
    static class OFBsnTlvIntervalVer13Funnel implements Funnel<OFBsnTlvIntervalVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvIntervalVer13> {
        @Override
        public void write(ChannelBuffer bb, OFBsnTlvIntervalVer13 message) {
            // fixed value property type = 0x3a
