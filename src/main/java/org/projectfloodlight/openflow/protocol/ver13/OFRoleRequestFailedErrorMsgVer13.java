...
//
    ...
    OFRoleRequestFailedErrorMsgVer13(long xid, OFRoleRequestFailedCode code, OFErrorCauseData data) {
        if(code == null) {
            throw new NullPointerException("OFRoleRequestFailedErrorMsgVer13: property code cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFRoleRequestFailedErrorMsgVer13: property data cannot be null");
        }
        this.xid = xid;
        this.code = code;
        this.data = data;
