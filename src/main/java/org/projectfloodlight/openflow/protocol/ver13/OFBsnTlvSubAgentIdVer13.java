...
class OFBsnTlvSubAgentIdVer13 implements OFBsnTlvSubAgentId {
...
//
    ...
    final static OFBsnTlvSubAgentIdVer13 DEFAULT = new OFBsnTlvSubAgentIdVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvSubAgentId> {
        ...
        public OFBsnTlvSubAgentId readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnTlvSubAgentIdVer13 bsnTlvSubAgentIdVer13 = new OFBsnTlvSubAgentIdVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvSubAgentIdVer13);
    ...
    final static OFBsnTlvSubAgentIdVer13Funnel FUNNEL = new OFBsnTlvSubAgentIdVer13Funnel();
    static class OFBsnTlvSubAgentIdVer13Funnel implements Funnel<OFBsnTlvSubAgentIdVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvSubAgentIdVer13> {
        @Override
        public void write(ChannelBuffer bb, OFBsnTlvSubAgentIdVer13 message) {
            // fixed value property type = 0x26
