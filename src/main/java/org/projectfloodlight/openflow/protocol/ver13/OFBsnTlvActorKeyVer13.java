...
class OFBsnTlvActorKeyVer13 implements OFBsnTlvActorKey {
...
//
    ...
    final static OFBsnTlvActorKeyVer13 DEFAULT = new OFBsnTlvActorKeyVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvActorKey> {
        ...
        public OFBsnTlvActorKey readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnTlvActorKeyVer13 bsnTlvActorKeyVer13 = new OFBsnTlvActorKeyVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvActorKeyVer13);
    ...
    final static OFBsnTlvActorKeyVer13Funnel FUNNEL = new OFBsnTlvActorKeyVer13Funnel();
    static class OFBsnTlvActorKeyVer13Funnel implements Funnel<OFBsnTlvActorKeyVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvActorKeyVer13> {
        @Override
        public void write(ChannelBuffer bb, OFBsnTlvActorKeyVer13 message) {
            // fixed value property type = 0x2c
