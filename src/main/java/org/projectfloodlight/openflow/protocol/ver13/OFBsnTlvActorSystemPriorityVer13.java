...
class OFBsnTlvActorSystemPriorityVer13 implements OFBsnTlvActorSystemPriority {
...
//
    ...
    final static OFBsnTlvActorSystemPriorityVer13 DEFAULT = new OFBsnTlvActorSystemPriorityVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvActorSystemPriority> {
        ...
        public OFBsnTlvActorSystemPriority readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnTlvActorSystemPriorityVer13 bsnTlvActorSystemPriorityVer13 = new OFBsnTlvActorSystemPriorityVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvActorSystemPriorityVer13);
    ...
    final static OFBsnTlvActorSystemPriorityVer13Funnel FUNNEL = new OFBsnTlvActorSystemPriorityVer13Funnel();
    static class OFBsnTlvActorSystemPriorityVer13Funnel implements Funnel<OFBsnTlvActorSystemPriorityVer13> {
