...
//
    ...
    OFGroupAddVer13(long xid, OFGroupType groupType, OFGroup group, List<OFBucket> buckets) {
        ...
        if(group == null) {
            throw new NullPointerException("OFGroupAddVer13: property group cannot be null");
        }
        if(buckets == null) {
            throw new NullPointerException("OFGroupAddVer13: property buckets cannot be null");
        }
        this.xid = xid;
