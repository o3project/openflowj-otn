...
class OFBsnTlvInternalMacVer13 implements OFBsnTlvInternalMac {
...
//
    ...
    final static OFBsnTlvInternalMacVer13 DEFAULT = new OFBsnTlvInternalMacVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvInternalMac> {
        ...
        public OFBsnTlvInternalMac readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnTlvInternalMacVer13 bsnTlvInternalMacVer13 = new OFBsnTlvInternalMacVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvInternalMacVer13);
    ...
    final static OFBsnTlvInternalMacVer13Funnel FUNNEL = new OFBsnTlvInternalMacVer13Funnel();
    static class OFBsnTlvInternalMacVer13Funnel implements Funnel<OFBsnTlvInternalMacVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvInternalMacVer13> {
        @Override
        public void write(ChannelBuffer bb, OFBsnTlvInternalMacVer13 message) {
            // fixed value property type = 0x1b
