...
//
    ...
    OFOxmBsnL3DstClassIdMaskedVer13(ClassId value, ClassId mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnL3DstClassIdMaskedVer13: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmBsnL3DstClassIdMaskedVer13: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
