...
class OFBsnTlvExternalMacVer13 implements OFBsnTlvExternalMac {
...
//
    ...
    final static OFBsnTlvExternalMacVer13 DEFAULT = new OFBsnTlvExternalMacVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvExternalMac> {
        ...
        public OFBsnTlvExternalMac readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnTlvExternalMacVer13 bsnTlvExternalMacVer13 = new OFBsnTlvExternalMacVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvExternalMacVer13);
    ...
    final static OFBsnTlvExternalMacVer13Funnel FUNNEL = new OFBsnTlvExternalMacVer13Funnel();
    static class OFBsnTlvExternalMacVer13Funnel implements Funnel<OFBsnTlvExternalMacVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvExternalMacVer13> {
        @Override
        public void write(ChannelBuffer bb, OFBsnTlvExternalMacVer13 message) {
            // fixed value property type = 0x18
