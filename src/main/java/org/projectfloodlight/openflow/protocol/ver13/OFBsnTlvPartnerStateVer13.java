...
class OFBsnTlvPartnerStateVer13 implements OFBsnTlvPartnerState {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnTlvPartnerStateVer13.class);
    // version: 1.3
...
//
    ...
    final static OFBsnTlvPartnerStateVer13 DEFAULT = new OFBsnTlvPartnerStateVer13(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnTlvPartnerStateVer13(Set<OFBsnLacpState> value) {
        if(value == null) {
            throw new NullPointerException("OFBsnTlvPartnerStateVer13: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFBsnTlvPartnerState.Builder {
        final OFBsnTlvPartnerStateVer13 parentMessage;

        // OF message fields
        private boolean valueSet;
        private Set<OFBsnLacpState> value;

        BuilderWithParent(OFBsnTlvPartnerStateVer13 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvPartnerState> {
        ...
        public OFBsnTlvPartnerState readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnTlvPartnerStateVer13 bsnTlvPartnerStateVer13 = new OFBsnTlvPartnerStateVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvPartnerStateVer13);
            return bsnTlvPartnerStateVer13;
        }
    }
    ...
    final static OFBsnTlvPartnerStateVer13Funnel FUNNEL = new OFBsnTlvPartnerStateVer13Funnel();
    static class OFBsnTlvPartnerStateVer13Funnel implements Funnel<OFBsnTlvPartnerStateVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnTlvPartnerStateVer13 message, PrimitiveSink sink) {
            // fixed value property type = 0x36
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvPartnerStateVer13> {
        @Override
        public void write(ChannelBuffer bb, OFBsnTlvPartnerStateVer13 message) {
            // fixed value property type = 0x36
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnTlvPartnerStateVer13(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnTlvPartnerStateVer13 other = (OFBsnTlvPartnerStateVer13) obj;
