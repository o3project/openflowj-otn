...
class OFBsnTlvHeaderSizeVer13 implements OFBsnTlvHeaderSize {
...
//
    ...
    final static OFBsnTlvHeaderSizeVer13 DEFAULT = new OFBsnTlvHeaderSizeVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvHeaderSize> {
        ...
        public OFBsnTlvHeaderSize readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnTlvHeaderSizeVer13 bsnTlvHeaderSizeVer13 = new OFBsnTlvHeaderSizeVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvHeaderSizeVer13);
    ...
    final static OFBsnTlvHeaderSizeVer13Funnel FUNNEL = new OFBsnTlvHeaderSizeVer13Funnel();
    static class OFBsnTlvHeaderSizeVer13Funnel implements Funnel<OFBsnTlvHeaderSizeVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvHeaderSizeVer13> {
        @Override
