...
class OFBsnTlvUdpDstVer13 implements OFBsnTlvUdpDst {
...
//
    ...
    final static OFBsnTlvUdpDstVer13 DEFAULT = new OFBsnTlvUdpDstVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvUdpDst> {
        ...
        public OFBsnTlvUdpDst readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFBsnTlvUdpDstVer13 bsnTlvUdpDstVer13 = new OFBsnTlvUdpDstVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvUdpDstVer13);
    ...
    final static OFBsnTlvUdpDstVer13Funnel FUNNEL = new OFBsnTlvUdpDstVer13Funnel();
    static class OFBsnTlvUdpDstVer13Funnel implements Funnel<OFBsnTlvUdpDstVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvUdpDstVer13> {
        @Override
        public void write(ChannelBuffer bb, OFBsnTlvUdpDstVer13 message) {
            // fixed value property type = 0x25
