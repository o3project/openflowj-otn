...
class OFOxmMplsBosMaskedVer13 implements OFOxmMplsBosMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmMplsBosMaskedVer13.class);
    // version: 1.3
...
//
    ...
    final static OFOxmMplsBosMaskedVer13 DEFAULT = new OFOxmMplsBosMaskedVer13(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmMplsBosMaskedVer13(OFBooleanValue value, OFBooleanValue mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmMplsBosMaskedVer13: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmMplsBosMaskedVer13: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    static class BuilderWithParent implements OFOxmMplsBosMasked.Builder {
        final OFOxmMplsBosMaskedVer13 parentMessage;
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmMplsBosMasked> {
        ...
        public OFOxmMplsBosMasked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmMplsBosMaskedVer13 oxmMplsBosMaskedVer13 = new OFOxmMplsBosMaskedVer13(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmMplsBosMaskedVer13);
            return oxmMplsBosMaskedVer13;
        }
    }
    ...
    final static OFOxmMplsBosMaskedVer13Funnel FUNNEL = new OFOxmMplsBosMaskedVer13Funnel();
    static class OFOxmMplsBosMaskedVer13Funnel implements Funnel<OFOxmMplsBosMaskedVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmMplsBosMaskedVer13 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80004902L
    ...
    static class Writer implements OFMessageWriter<OFOxmMplsBosMaskedVer13> {
        @Override
        public void write(ChannelBuffer bb, OFOxmMplsBosMaskedVer13 message) {
            // fixed value property typeLen = 0x80004902L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmMplsBosMaskedVer13(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmMplsBosMaskedVer13 other = (OFOxmMplsBosMaskedVer13) obj;
