...
//
    ...
    OFOxmInPortMaskedVer13(OFPort value, OFPort mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmInPortMaskedVer13: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmInPortMaskedVer13: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
