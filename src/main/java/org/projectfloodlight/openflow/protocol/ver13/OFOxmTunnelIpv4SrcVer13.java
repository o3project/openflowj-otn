...
class OFOxmTunnelIpv4SrcVer13 implements OFOxmTunnelIpv4Src {
...
//
    ...
    final static OFOxmTunnelIpv4SrcVer13 DEFAULT = new OFOxmTunnelIpv4SrcVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmTunnelIpv4Src> {
        ...
        public OFOxmTunnelIpv4Src readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmTunnelIpv4SrcVer13 oxmTunnelIpv4SrcVer13 = new OFOxmTunnelIpv4SrcVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmTunnelIpv4SrcVer13);
    ...
    final static OFOxmTunnelIpv4SrcVer13Funnel FUNNEL = new OFOxmTunnelIpv4SrcVer13Funnel();
    static class OFOxmTunnelIpv4SrcVer13Funnel implements Funnel<OFOxmTunnelIpv4SrcVer13> {
    ...
    static class Writer implements OFMessageWriter<OFOxmTunnelIpv4SrcVer13> {
        @Override
        public void write(ChannelBuffer bb, OFOxmTunnelIpv4SrcVer13 message) {
            // fixed value property typeLen = 0x13e04L
            bb.writeInt(0x13e04);
