...
//
    ...
    OFTableFeaturesFailedErrorMsgVer13(long xid, OFTableFeaturesFailedCode code, OFErrorCauseData data) {
        if(code == null) {
            throw new NullPointerException("OFTableFeaturesFailedErrorMsgVer13: property code cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFTableFeaturesFailedErrorMsgVer13: property data cannot be null");
        }
        this.xid = xid;
        this.code = code;
        this.data = data;
