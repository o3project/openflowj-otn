...
//
    ...
    OFOxmMetadataMaskedVer13(OFMetadata value, OFMetadata mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmMetadataMaskedVer13: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmMetadataMaskedVer13: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
