...
class OFOxmBsnL2CacheHitVer13 implements OFOxmBsnL2CacheHit {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnL2CacheHitVer13.class);
    // version: 1.3
...
//
    ...
    final static OFOxmBsnL2CacheHitVer13 DEFAULT = new OFOxmBsnL2CacheHitVer13(
        DEFAULT_VALUE
    );
    ...
    static class BuilderWithParent implements OFOxmBsnL2CacheHit.Builder {
        final OFOxmBsnL2CacheHitVer13 parentMessage;

        // OF message fields
        private boolean valueSet;
        private OFBooleanValue value;

        BuilderWithParent(OFOxmBsnL2CacheHitVer13 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnL2CacheHit> {
        ...
        public OFOxmBsnL2CacheHit readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmBsnL2CacheHitVer13 oxmBsnL2CacheHitVer13 = new OFOxmBsnL2CacheHitVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnL2CacheHitVer13);
            return oxmBsnL2CacheHitVer13;
        }
    }
    ...
    final static OFOxmBsnL2CacheHitVer13Funnel FUNNEL = new OFOxmBsnL2CacheHitVer13Funnel();
    static class OFOxmBsnL2CacheHitVer13Funnel implements Funnel<OFOxmBsnL2CacheHitVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnL2CacheHitVer13 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x32401L
            sink.putInt(0x32401);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnL2CacheHitVer13> {
        @Override
        public void write(ChannelBuffer bb, OFOxmBsnL2CacheHitVer13 message) {
            // fixed value property typeLen = 0x32401L
            bb.writeInt(0x32401);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnL2CacheHitVer13(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnL2CacheHitVer13 other = (OFOxmBsnL2CacheHitVer13) obj;
