...
//
    ...
    OFTableModFailedErrorMsgVer13(long xid, OFTableModFailedCode code, OFErrorCauseData data) {
        if(code == null) {
            throw new NullPointerException("OFTableModFailedErrorMsgVer13: property code cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFTableModFailedErrorMsgVer13: property data cannot be null");
        }
        this.xid = xid;
        this.code = code;
        this.data = data;
