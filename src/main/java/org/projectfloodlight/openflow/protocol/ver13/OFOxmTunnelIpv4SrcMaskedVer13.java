...
class OFOxmTunnelIpv4SrcMaskedVer13 implements OFOxmTunnelIpv4SrcMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmTunnelIpv4SrcMaskedVer13.class);
    // version: 1.3
...
//
    ...
    final static OFOxmTunnelIpv4SrcMaskedVer13 DEFAULT = new OFOxmTunnelIpv4SrcMaskedVer13(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmTunnelIpv4SrcMaskedVer13(IPv4Address value, IPv4Address mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmTunnelIpv4SrcMaskedVer13: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmTunnelIpv4SrcMaskedVer13: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    static class BuilderWithParent implements OFOxmTunnelIpv4SrcMasked.Builder {
        final OFOxmTunnelIpv4SrcMaskedVer13 parentMessage;
        ...
        BuilderWithParent(OFOxmTunnelIpv4SrcMaskedVer13 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmTunnelIpv4SrcMasked> {
        ...
        public OFOxmTunnelIpv4SrcMasked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmTunnelIpv4SrcMaskedVer13 oxmTunnelIpv4SrcMaskedVer13 = new OFOxmTunnelIpv4SrcMaskedVer13(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmTunnelIpv4SrcMaskedVer13);
    ...
    final static OFOxmTunnelIpv4SrcMaskedVer13Funnel FUNNEL = new OFOxmTunnelIpv4SrcMaskedVer13Funnel();
    static class OFOxmTunnelIpv4SrcMaskedVer13Funnel implements Funnel<OFOxmTunnelIpv4SrcMaskedVer13> {
    ...
    static class Writer implements OFMessageWriter<OFOxmTunnelIpv4SrcMaskedVer13> {
        @Override
        public void write(ChannelBuffer bb, OFOxmTunnelIpv4SrcMaskedVer13 message) {
            // fixed value property typeLen = 0x13f08L
            bb.writeInt(0x13f08);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmTunnelIpv4SrcMaskedVer13(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmTunnelIpv4SrcMaskedVer13 other = (OFOxmTunnelIpv4SrcMaskedVer13) obj;
