...
//
    ...
    OFBsnPduRxRequestVer13(long xid, long timeoutMs, OFPort portNo, short slotNum, byte[] data) {
        if(portNo == null) {
            throw new NullPointerException("OFBsnPduRxRequestVer13: property portNo cannot be null");
        }
        if(data == null) {
            throw new NullPointerException("OFBsnPduRxRequestVer13: property data cannot be null");
        }
        this.xid = xid;
