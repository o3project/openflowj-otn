...
//
    ...
    OFBucketVer13(int weight, OFPort watchPort, OFGroup watchGroup, List<OFAction> actions) {
        if(watchPort == null) {
            throw new NullPointerException("OFBucketVer13: property watchPort cannot be null");
        }
        if(watchGroup == null) {
            throw new NullPointerException("OFBucketVer13: property watchGroup cannot be null");
        }
        if(actions == null) {
            throw new NullPointerException("OFBucketVer13: property actions cannot be null");
        }
        this.weight = weight;
