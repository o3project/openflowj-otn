...
class OFOxmBsnL2CacheHitMaskedVer13 implements OFOxmBsnL2CacheHitMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnL2CacheHitMaskedVer13.class);
    // version: 1.3
...
//
    ...
    final static OFOxmBsnL2CacheHitMaskedVer13 DEFAULT = new OFOxmBsnL2CacheHitMaskedVer13(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnL2CacheHitMaskedVer13(OFBooleanValue value, OFBooleanValue mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnL2CacheHitMaskedVer13: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmBsnL2CacheHitMaskedVer13: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<OFBooleanValue> getCanonical() {
        if (OFBooleanValue.NO_MASK.equals(mask)) {
            return new OFOxmBsnL2CacheHitVer13(value);
    ...
    static class BuilderWithParent implements OFOxmBsnL2CacheHitMasked.Builder {
        final OFOxmBsnL2CacheHitMaskedVer13 parentMessage;
        ...
        BuilderWithParent(OFOxmBsnL2CacheHitMaskedVer13 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnL2CacheHitMasked> {
        ...
        public OFOxmBsnL2CacheHitMasked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmBsnL2CacheHitMaskedVer13 oxmBsnL2CacheHitMaskedVer13 = new OFOxmBsnL2CacheHitMaskedVer13(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnL2CacheHitMaskedVer13);
            return oxmBsnL2CacheHitMaskedVer13;
        }
    }
    ...
    final static OFOxmBsnL2CacheHitMaskedVer13Funnel FUNNEL = new OFOxmBsnL2CacheHitMaskedVer13Funnel();
    static class OFOxmBsnL2CacheHitMaskedVer13Funnel implements Funnel<OFOxmBsnL2CacheHitMaskedVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnL2CacheHitMaskedVer13 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x32502L
            sink.putInt(0x32502);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnL2CacheHitMaskedVer13> {
        @Override
        public void write(ChannelBuffer bb, OFOxmBsnL2CacheHitMaskedVer13 message) {
            // fixed value property typeLen = 0x32502L
            bb.writeInt(0x32502);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnL2CacheHitMaskedVer13(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnL2CacheHitMaskedVer13 other = (OFOxmBsnL2CacheHitMaskedVer13) obj;
