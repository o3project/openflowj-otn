...
class OFOxmTunnelIpv4DstMaskedVer12 implements OFOxmTunnelIpv4DstMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmTunnelIpv4DstMaskedVer12.class);
    // version: 1.2
...
//
    ...
    final static OFOxmTunnelIpv4DstMaskedVer12 DEFAULT = new OFOxmTunnelIpv4DstMaskedVer12(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmTunnelIpv4DstMaskedVer12(IPv4Address value, IPv4Address mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmTunnelIpv4DstMaskedVer12: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmTunnelIpv4DstMaskedVer12: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<IPv4Address> getCanonical() {
        if (IPv4Address.NO_MASK.equals(mask)) {
            return new OFOxmTunnelIpv4DstVer12(value);
    ...
    static class BuilderWithParent implements OFOxmTunnelIpv4DstMasked.Builder {
        final OFOxmTunnelIpv4DstMaskedVer12 parentMessage;
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmTunnelIpv4DstMasked> {
        ...
        public OFOxmTunnelIpv4DstMasked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmTunnelIpv4DstMaskedVer12 oxmTunnelIpv4DstMaskedVer12 = new OFOxmTunnelIpv4DstMaskedVer12(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmTunnelIpv4DstMaskedVer12);
            return oxmTunnelIpv4DstMaskedVer12;
        }
    }
    ...
    final static OFOxmTunnelIpv4DstMaskedVer12Funnel FUNNEL = new OFOxmTunnelIpv4DstMaskedVer12Funnel();
    static class OFOxmTunnelIpv4DstMaskedVer12Funnel implements Funnel<OFOxmTunnelIpv4DstMaskedVer12> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmTunnelIpv4DstMaskedVer12 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x14108L
            sink.putInt(0x14108);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmTunnelIpv4DstMaskedVer12(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmTunnelIpv4DstMaskedVer12 other = (OFOxmTunnelIpv4DstMaskedVer12) obj;
