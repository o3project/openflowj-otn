...
//
    ...
    OFPortStatsReplyVer12(long xid, Set<OFStatsReplyFlags> flags, List<OFPortStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFPortStatsReplyVer12: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFPortStatsReplyVer12: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
