...
//
    ...
    OFOxmIpv6SrcMaskedVer12(IPv6Address value, IPv6Address mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpv6SrcMaskedVer12: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmIpv6SrcMaskedVer12: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
