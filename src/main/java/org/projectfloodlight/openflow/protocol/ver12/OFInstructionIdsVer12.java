...
public class OFInstructionIdsVer12 implements OFInstructionIds {
    ...
    public OFInstructionIdBsnAutoNegotiation bsnAutoNegotiation() {
        throw new UnsupportedOperationException("OFInstructionIdBsnAutoNegotiation not supported in version 1.2");
    }
    ...
    public OFInstructionIdBsnSpanDestination bsnSpanDestination() {
        throw new UnsupportedOperationException("OFInstructionIdBsnSpanDestination not supported in version 1.2");
    }
