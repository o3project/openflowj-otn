...
//
    ...
    OFOxmBsnVrfMaskedVer12(VRF value, VRF mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnVrfMaskedVer12: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmBsnVrfMaskedVer12: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
