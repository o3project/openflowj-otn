...
//
    ...
    OFOxmIcmpv6TypeMaskedVer12(U8 value, U8 mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmIcmpv6TypeMaskedVer12: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmIcmpv6TypeMaskedVer12: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
